...
locations.push({id:'library',name:'Little Leaf Library',subtitle:'Borrow books and discover stories.',level:1,photo:art+'rewards/kindergarten/02-table-close.png',npc:'Librarian Coco',movie:null});
locations.push({id:'shop',name:'Sunny Shop',subtitle:'Fill a little basket together.',level:1,photo:art+'rewards/restaurant/04-counter.png',npc:'Shopkeeper Momo',movie:null});
episodes.push({id:'library-book',location:'library',title:'My First Library Card',level:1,reward:35,skill:'confidence',story:'Help {cat} borrow a book for bedtime.',ending:'A library card and a story to share.',nodes:[q('lib-hello','Welcome to the library.','Hello!',['Good night, soup.','I am a ticket.'],'Coco waves to {cat}.'),q('lib-name','What is your cat’s name?','My cat’s name is {cat}.',['My cat is a spoon.','Two bags, please.'],'Make a library card.'),q('lib-book','Would you like a picture book?','Yes, a picture book, please.',['A window seat, please.','I am a door.'],'Choose a story for {cat}.'),q('lib-borrow','You can borrow this book.','Thank you. I will take care of it.',['Here is your soup.','I have one fever.'],'Hold the book gently.'),q('lib-return','Please return it tomorrow.','Okay. See you tomorrow.',['Two spoons, please.','My bag is hungry.'],'Your first library visit is complete.')]});
episodes.push({id:'shop-basket',location:'shop',title:'A Little Shopping Trip',level:1,reward:32,skill:'kindness',story:'Buy a snack and a toy for {cat}.',ending:'A little basket of lovely things.',nodes:[q('shop-hello','Can I help you?','Yes, I need pet food.',['Yes, I am a table.','At Gate Two.'],'Look at the food shelf.'),q('shop-toy','What toy would your cat like?','A ball, please.',['A passport, please.','I have a fever.'],'Pick a toy to play with.'),q('shop-price','It costs five coins.','Here are five coins.',['Here is a red block.','I am five bags.'],'Practice paying politely.'),q('shop-bag','Would you like a bag?','Yes, a bag, please.',['Good night, window.','The airport is tasty.'],'Carry your things home.')]});
const photos={library:['kindergarten/01-school-exterior','kindergarten/02-table-close','kindergarten/05-playground'],shop:['restaurant/01-street','restaurant/04-counter','restaurant/05-patio'],
...
const translations={"school-hello": "좋은 아침이에요!", "school-name": "반려동물의 이름은 무엇인가요?", "school-age": "반려동물은 몇 살인가요?", "school-seat": "누구와 함께 앉고 싶나요?", "school-block": "빨간 블록을 건네줄 수 있나요?", "school-tidy": "정리하는 것을 도와줄 수 있나요?", "school-bye": "내일 만나요!", "cafe-table": "몇 명이 앉을 테이블이 필요한가요?", "cafe-pet": "반려동물도 함께 들어오나요?", "cafe-food": "반려동물은 무엇을 먹고 싶어 하나요?", "cafe-water": "반려동물에게 물을 좀 줄까요?", "cafe-serve": "주문한 음식 나왔습니다.", "cafe-check": "모두 괜찮으신가요?", "cafe-bill": "계산서를 드릴까요?", "clinic-name": "반려동물의 이름은 무엇인가요?", "clinic-problem": "반려동물이 어디가 아픈가요?", "clinic-fever": "반려동물에게 열이 있나요?", "clinic-food": "반려동물이 오늘 밥을 먹었나요?", "clinic-exam": "반려동물을 진찰해도 될까요?", "clinic-rest": "반려동물은 조용히 쉬어야 해요.", "clinic-bye": "반려동물의 상태가 나빠지면 다시 오세요.", "air-passport": "여권을 보여주시겠어요?", "air-cat-name": "반려동물의 이름은 무엇인가요?", "air-cat-age": "반려동물은 몇 살인가요?", "air-together": "함께 앉으시겠어요, 따로 앉으시겠어요?", "air-seat": "창가 좌석과 통로 좌석 중 어디에 앉고 싶나요?", "air-bag": "가방이 몇 개 있나요?", "air-gate": "비행기는 2번 탑승구에서 출발해요.", "air-board": "탑승할 준비가 되었나요?", "hotel-booking": "예약하셨나요?", "hotel-name": "어떤 이름으로 예약하셨나요?", "hotel-pet": "반려동물도 함께 묵나요?", "hotel-room": "정원이 보이는 방과 조용한 방 중 어떤 방을 원하시나요?", "hotel-blanket": "반려동물에게 담요가 필요한가요?", "hotel-key": "여기 열쇠입니다. 2번 방이에요.", "hotel-night": "편안한 밤 보내세요!", "show-intro": "반려동물을 소개해 줄 수 있나요?", "show-age": "반려동물은 지금 몇 살인가요?", "show-favorite": "반려동물은 무엇을 하는 것을 좋아하나요?", "show-care": "반려동물을 어떻게 돌보나요?", "show-stress": "반려동물이 속상해할 때 무엇을 하나요?", "show-thanks": "정말 멋진 이야기였어요.", "shift-welcome": "안녕하세요. 두 명이 앉을 자리가 있나요?", "shift-order": "닭고기 주세요.", "shift-water": "네, 물 주세요.", "shift-food": "저희 음식이 준비되었나요?", "shift-extra": "숟가락 하나 더 주시겠어요?", "shift-pay": "계산서 주시겠어요?", "slime-water": "무엇이 필요한가요?", "slime-shield": "준비되었나요?", "slime-help": "저를 도와줄 수 있나요?", "slime-together": "함께 갈까요?", "slime-home": "어디로 가고 있나요?"};
Object.assign(translations,{'lib-hello':'도서관에 오신 것을 환영해요.','lib-name':'반려동물의 이름은 무엇인가요?','lib-book':'그림책을 보고 싶나요?','lib-borrow':'이 책을 빌릴 수 있어요.','lib-return':'내일 돌려주세요.','shop-hello':'도와드릴까요?','shop-toy':'반려동물은 어떤 장난감을 좋아할까요?','shop-price':'동전 다섯 개입니다.','shop-bag':'봉투가 필요한가요?'});
return {goods,locations,episodes,photos,translations};
});
