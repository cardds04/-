...
`)+`
`+m);let M=_+g+o,b=_+m+a,A=Cd(i,i.VERTEX_SHADER,M),E=Cd(i,i.FRAGMENT_SHADER,b);i.attachShader(x,A),i.attachShader(x,E),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function C(P){if(s.debug.checkShaderErrors){let O=i.getProgramInfoLog(x)||"",z=i.getShaderInfoLog(A)||"",G=i.getShaderInfoLog(E)||"",B=O.trim(),F=z.trim(),k=G.trim(),ue=!0,se=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(ue=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,A,E);else{let me=Id(i,A,"vertex"),Me=Id(i,E,"fragment");Je("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
}`,Fx=[new R(1,0,0),new R(-1,0,0),new R(0,1,0),new R(0,-1,0),new R(0,0,1),new R(0,0,-1)],Ox=[new R(0,-1,0),new R(0,-1,0),new R(0,0,1),new R(0,0,-1),new R(0,-1,0),new R(0,-1,0)],Bd=new it,po=new R,$l=new R;function Bx(s,e,t){let n=new tr,i=new $e,r=new $e,o=new Lt,a=new ma,c=new ga,l={},u=t.maxTextureSize,h={[Bn]:hn,[hn]:Bn,[en]:en},d=new bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:Nx,fragmentShader:Ux}),f=d.clone();f.defines.HORIZONTAL_PASS=1;let p=new Dt;p.setAttribute("position",new Wt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new mt(p,d),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ro;let m=this.type;this.render=function(E,C,v){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||E.length===0)return;this.type===ar&&(Ve("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ro);let w=s.getRenderTarget(),H=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),O=s.state;O.setBlending(ii),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);let z=m!==this.type;z&&C.traverse(function(G){G.material&&(Array.isArray(G.material)?G.material.forEach(B=>B.needsUpdate=!0):G.material.needsUpdate=!0)});for(let G=0,B=E.length;G<B;G++){let F=E[G],k=F.shadow;if(k===void 0){Ve("WebGLShadowMap:",F,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;i.copy(k.mapSize);let ue=k.getFrameExtents();i.multiply(ue),r.copy(k.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(r.x=Math.floor(u/ue.x),i.x=r.x*ue.x,k.mapSize.x=r.x),i.y>u&&(r.y=Math.floor(u/ue.y),i.y=r.y*ue.y,k.mapSize.y=r.y));let se=s.state.buffers.depth.getReversed();if(k.camera._reversedDepth=se,k.map===null||z===!0){if(k.map!==null&&(k.map.depthTexture!==null&&(k.map.depthTexture.dispose(),k.map.depthTexture=null),k.map.dispose()),this.type===cr){if(F.isPointLight){Ve("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}k.map=new Mn(i.x,i.y,{format:_s,type:ri,minFilter:kt,magFilter:kt,generateMipmaps:!1}),k.map.texture.name=F.name+".shadowMap",k.map.depthTexture=new zi(i.x,i.y,Sn),k.map.depthTexture.name=F.name+".shadowMapDepth",k.map.depthTexture.format=Yn,k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=zt,k.map.depthTexture.magFilter=zt}else F.isPointLight?(k.map=new Mc(i.x),k.map.depthTexture=new da(i.x,Gn)):(k.map=new Mn(i.x,i.y),k.map.depthTexture=new zi(i.x,i.y,Gn)),k.map.depthTexture.name=F.name+".shadowMap",k.map.depthTexture.format=Yn,this.type===ro?(k.map.depthTexture.compareFunction=se?xc:gc,k.map.depthTexture.minFilter=kt,k.map.depthTexture.magFilter=kt):(k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=zt,k.map.depthTexture.magFilter=zt);k.camera.updateProjectionMatrix()}let me=k.map.isWebGLCubeRenderTarget?6:1;for(let Me=0;Me<me;Me++){if(k.map.isWebGLCubeRenderTarget)s.setRenderTarget(k.map,Me),s.clear();else{Me===0&&(s.setRenderTarget(k.map),s.clear());let Z=k.getViewport(Me);o.set(r.x*Z.x,r.y*Z.y,r.x*Z.z,r.y*Z.w),O.viewport(o)}if(F.isPointLight){let Z=k.camera,Fe=k.matrix,ut=F.distance||Z.far;ut!==Z.far&&(Z.far=ut,Z.updateProjectionMatrix()),po.setFromMatrixPosition(F.matrixWorld),Z.position.copy(po),$l.copy(Z.position),$l.add(Fx[Me]),Z.up.copy(Ox[Me]),Z.lookAt($l),Z.updateMatrixWorld(),Fe.makeTranslation(-po.x,-po.y,-po.z),Bd.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),k._frustum.setFromProjectionMatrix(Bd,Z.coordinateSystem,Z.reversedDepth)}else k.updateMatrices(F);n=k.getFrustum(),b(C,v,k.camera,F,this.type)}k.isPointLightShadow!==!0&&this.type===cr&&_(k,v),k.needsUpdate=!1}m=this.type,g.needsUpdate=!1,s.setRenderTarget(w,H,P)};function _(E,C){let v=e.update(x);d.defines.VSM_SAMPLES!==E.blurSamples&&(d.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new Mn(i.x,i.y,{format:_s,type:ri})),d.uniforms.shadow_pass.value=E.map.depthTexture,d.uniforms.resolution.value=E.mapSize,d.uniforms.radius.value=E.radius,s.setRenderTarget(E.mapPass),s.clear(),s.renderBufferDirect(C,null,v,d,x,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,s.setRenderTarget(E.map),s.clear(),s.renderBufferDirect(C,null,v,f,x,null)}function M(E,C,v,w){let H=null,P=v.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(P!==void 0)H=P;else if(H=v.isPointLight===!0?c:a,s.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let O=H.uuid,z=C.uuid,G=l[O];G===void 0&&(G={},l[O]=G);let B=G[z];B===void 0&&(B=H.clone(),G[z]=B,C.addEventListener("dispose",A)),H=B}if(H.visible=C.visible,H.wireframe=C.wireframe,w===cr?H.side=C.shadowSide!==null?C.shadowSide:C.side:H.side=C.shadowSide!==null?C.shadowSide:h[C.side],H.alphaMap=C.alphaMap,H.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,H.map=C.map,H.clipShadows=C.clipShadows,H.clippingPlanes=C.clippingPlanes,H.clipIntersection=C.clipIntersection,H.displacementMap=C.displacementMap,H.displacementScale=C.displacementScale,H.displacementBias=C.displacementBias,H.wireframeLinewidth=C.wireframeLinewidth,H.linewidth=C.linewidth,v.isPointLight===!0&&H.isMeshDistanceMaterial===!0){let O=s.properties.get(H);O.light=v}return H}function b(E,C,v,w,H){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&H===cr)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,E.matrixWorld);let z=e.update(E),G=E.material;if(Array.isArray(G)){let B=z.groups;for(let F=0,k=B.length;F<k;F++){let ue=B[F],se=G[ue.materialIndex];if(se&&se.visible){let me=M(E,se,w,H);E.onBeforeShadow(s,E,C,v,z,me,ue),s.renderBufferDirect(v,null,z,me,E,ue),E.onAfterShadow(s,E,C,v,z,me,ue)}}}else if(G.visible){let B=M(E,G,w,H);E.onBeforeShadow(s,E,C,v,z,B,null),s.renderBufferDirect(v,null,z,B,E,null),E.onAfterShadow(s,E,C,v,z,B,null)}}let O=E.children;for(let z=0,G=O.length;z<G;z++)b(O[z],C,v,w,H)}function A(E){E.target.removeEventListener("dispose",A);for(let v in l){let w=l[v],H=E.target.uuid;H in w&&(w[H].dispose(),delete w[H])}}}function zx(s,e){function t(){let D=!1,pe=new Lt,ce=null,we=new Lt(0,0,0,0);return{setMask:function(re){ce!==re&&!D&&(s.colorMask(re,re,re,re),ce=re)},setLocked:function(re){D=re},setClear:function(re,K,Ce,ke,rt){rt===!0&&(re*=ke,K*=ke,Ce*=ke),pe.set(re,K,Ce,ke),we.equals(pe)===!1&&(s.clearColor(re,K,Ce,ke),we.copy(pe))},reset:function(){D=!1,ce=null,we.set(-1,0,0,0)}}}function n(){let D=!1,pe=!1,ce=null,we=null,re=null;return{setReversed:function(K){if(pe!==K){let Ce=e.get("EXT_clip_control");K?Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.ZERO_TO_ONE_EXT):Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.NEGATIVE_ONE_TO_ONE_EXT),pe=K;let ke=re;re=null,this.setClear(ke)}},getReversed:function(){return pe},setTest:function(K){K?de(s.DEPTH_TEST):fe(s.DEPTH_TEST)},setMask:function(K){ce!==K&&!D&&(s.depthMask(K),ce=K)},setFunc:function(K){if(pe&&(K=ud[K]),we!==K){switch(K){case Qo:s.depthFunc(s.NEVER);break;case ea:s.depthFunc(s.ALWAYS);break;case ta:s.depthFunc(s.LESS);break;case os:s.depthFunc(s.LEQUAL);break;case na:s.depthFunc(s.EQUAL);break;case ia:s.depthFunc(s.GEQUAL);break;case sa:s.depthFunc(s.GREATER);break;case ra:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}we=K}},setLocked:function(K){D=K},setClear:function(K){re!==K&&(re=K,pe&&(K=1-K),s.clearDepth(K))},reset:function(){D=!1,ce=null,we=null,re=null,pe=!1}}}function i(){let D=!1,pe=null,ce=null,we=null,re=null,K=null,Ce=null,ke=null,rt=null;return{setTest:function(Qe){D||(Qe?de(s.STENCIL_TEST):fe(s.STENCIL_TEST))},setMask:function(Qe){pe!==Qe&&!D&&(s.stencilMask(Qe),pe=Qe)},setFunc:function(Qe,tn,W){(ce!==Qe||we!==tn||re!==W)&&(s.stencilFunc(Qe,tn,W),ce=Qe,we=tn,re=W)},setOp:function(Qe,tn,W){(K!==Qe||Ce!==tn||ke!==W)&&(s.stencilOp(Qe,tn,W),K=Qe,Ce=tn,ke=W)},setLocked:function(Qe){D=Qe},setClear:function(Qe){rt!==Qe&&(s.clearStencil(Qe),rt=Qe)},reset:function(){D=!1,pe=null,ce=null,we=null,re=null,K=null,Ce=null,ke=null,rt=null}}}let r=new t,o=new n,a=new i,c=new WeakMap,l=new WeakMap,u={},h={},d=new WeakMap,f=[],p=null,x=!1,g=null,m=null,_=null,M=null,b=null,A=null,E=null,C=new Be(0,0,0),v=0,w=!1,H=null,P=null,O=null,z=null,G=null,B=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),F=!1,k=0,ue=s.getParameter(s.VERSION);ue.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(ue)[1]),F=k>=1):ue.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(ue)[1]),F=k>=2);let se=null,me={},Me=s.getParameter(s.SCISSOR_BOX),Z=s.getParameter(s.VIEWPORT),Fe=new Lt().fromArray(Me),ut=new Lt().fromArray(Z);function We(D,pe,ce,we){let re=new Uint8Array(4),K=s.createTexture();s.bindTexture(D,K),s.texParameteri(D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(D,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Ce=0;Ce<ce;Ce++)D===s.TEXTURE_3D||D===s.TEXTURE_2D_ARRAY?s.texImage3D(pe,0,s.RGBA,1,1,we,0,s.RGBA,s.UNSIGNED_BYTE,re):s.texImage2D(pe+Ce,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,re);return K}let $={};$[s.TEXTURE_2D]=We(s.TEXTURE_2D,s.TEXTURE_2D,1),$[s.TEXTURE_CUBE_MAP]=We(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[s.TEXTURE_2D_ARRAY]=We(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),$[s.TEXTURE_3D]=We(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),de(s.DEPTH_TEST),o.setFunc(os),Ze(!1),gt(gl),de(s.CULL_FACE),Ee(ii);function de(D){u[D]!==!0&&(s.enable(D),u[D]=!0)}function fe(D){u[D]!==!1&&(s.disable(D),u[D]=!1)}function Te(D,pe){return h[D]!==pe?(s.bindFramebuffer(D,pe),h[D]=pe,D===s.DRAW_FRAMEBUFFER&&(h[s.FRAMEBUFFER]=pe),D===s.FRAMEBUFFER&&(h[s.DRAW_FRAMEBUFFER]=pe),!0):!1}function Ge(D,pe){let ce=f,we=!1;if(D){ce=d.get(pe),ce===void 0&&(ce=[],d.set(pe,ce));let re=D.textures;if(ce.length!==re.length||ce[0]!==s.COLOR_ATTACHMENT0){for(let K=0,Ce=re.length;K<Ce;K++)ce[K]=s.COLOR_ATTACHMENT0+K;ce.length=re.length,we=!0}}else ce[0]!==s.BACK&&(ce[0]=s.BACK,we=!0);we&&s.drawBuffers(ce)}function Ye(D){return p!==D?(s.useProgram(D),p=D,!0):!1}let Pt={[Ni]:s.FUNC_ADD,[Iu]:s.FUNC_SUBTRACT,[Pu]:s.FUNC_REVERSE_SUBTRACT};Pt[Lu]=s.MIN,Pt[Du]=s.MAX;let st={[Nu]:s.ZERO,[Uu]:s.ONE,[Fu]:s.SRC_COLOR,[$o]:s.SRC_ALPHA,[Gu]:s.SRC_ALPHA_SATURATE,[ku]:s.DST_COLOR,[Bu]:s.DST_ALPHA,[Ou]:s.ONE_MINUS_SRC_COLOR,[jo]:s.ONE_MINUS_SRC_ALPHA,[Vu]:s.ONE_MINUS_DST_COLOR,[zu]:s.ONE_MINUS_DST_ALPHA,[Hu]:s.CONSTANT_COLOR,[Wu]:s.ONE_MINUS_CONSTANT_COLOR,[Xu]:s.CONSTANT_ALPHA,[qu]:s.ONE_MINUS_CONSTANT_ALPHA};function Ee(D,pe,ce,we,re,K,Ce,ke,rt,Qe){if(D===ii){x===!0&&(fe(s.BLEND),x=!1);return}if(x===!1&&(de(s.BLEND),x=!0),D!==Ru){if(D!==g||Qe!==w){if((m!==Ni||b!==Ni)&&(s.blendEquation(s.FUNC_ADD),m=Ni,b=Ni),Qe)switch(D){case rs:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case xl:s.blendFunc(s.ONE,s.ONE);break;case _l:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case yl:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:Je("WebGLState: Invalid blending: ",D);break}else switch(D){case rs:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case xl:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case _l:Je("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case yl:Je("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Je("WebGLState: Invalid blending: ",D);break}_=null,M=null,A=null,E=null,C.set(0,0,0),v=0,g=D,w=Qe}return}re=re||pe,K=K||ce,Ce=Ce||we,(pe!==m||re!==b)&&(s.blendEquationSeparate(Pt[pe],Pt[re]),m=pe,b=re),(ce!==_||we!==M||K!==A||Ce!==E)&&(s.blendFuncSeparate(st[ce],st[we],st[K],st[Ce]),_=ce,M=we,A=K,E=Ce),(ke.equals(C)===!1||rt!==v)&&(s.blendColor(ke.r,ke.g,ke.b,rt),C.copy(ke),v=rt),g=D,w=!1}function bt(D,pe){D.side===en?fe(s.CULL_FACE):de(s.CULL_FACE);let ce=D.side===hn;pe&&(ce=!ce),Ze(ce),D.blending===rs&&D.transparent===!1?Ee(ii):Ee(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),r.setMask(D.colorWrite);let we=D.stencilWrite;a.setTest(we),we&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),yt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?de(s.SAMPLE_ALPHA_TO_COVERAGE):fe(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ze(D){H!==D&&(D?s.frontFace(s.CW):s.frontFace(s.CCW),H=D)}function gt(D){D!==Eu?(de(s.CULL_FACE),D!==P&&(D===gl?s.cullFace(s.BACK):D===Cu?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):fe(s.CULL_FACE),P=D}function L(D){D!==O&&(F&&s.lineWidth(D),O=D)}function yt(D,pe,ce){D?(de(s.POLYGON_OFFSET_FILL),(z!==pe||G!==ce)&&(z=pe,G=ce,o.getReversed()&&(pe=-pe),s.polygonOffset(pe,ce))):fe(s.POLYGON_OFFSET_FILL)}function tt(D){D?de(s.SCISSOR_TEST):fe(s.SCISSOR_TEST)}function nt(D){D===void 0&&(D=s.TEXTURE0+B-1),se!==D&&(s.activeTexture(D),se=D)}function De(D,pe,ce){ce===void 0&&(se===null?ce=s.TEXTURE0+B-1:ce=se);let we=me[ce];we===void 0&&(we={type:void 0,texture:void 0},me[ce]=we),(we.type!==D||we.texture!==pe)&&(se!==ce&&(s.activeTexture(ce),se=ce),s.bindTexture(D,pe||$[D]),we.type=D,we.texture=pe)}function T(){let D=me[se];D!==void 0&&D.type!==void 0&&(s.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function y(){try{s.compressedTexImage2D(...arguments)}catch(D){Je("WebGLState:",D)}}function N(){try{s.compressedTexImage3D(...arguments)}catch(D){Je("WebGLState:",D)}}function J(){try{s.texSubImage2D(...arguments)}catch(D){Je("WebGLState:",D)}}function te(){try{s.texSubImage3D(...arguments)}catch(D){Je("WebGLState:",D)}}function j(){try{s.compressedTexSubImage2D(...arguments)}catch(D){Je("WebGLState:",D)}}function Se(){try{s.compressedTexSubImage3D(...arguments)}catch(D){Je("WebGLState:",D)}}function le(){try{s.texStorage2D(...arguments)}catch(D){Je("WebGLState:",D)}}function Ne(){try{s.texStorage3D(...arguments)}catch(D){Je("WebGLState:",D)}}function ze(){try{s.texImage2D(...arguments)}catch(D){Je("WebGLState:",D)}}function ae(){try{s.texImage3D(...arguments)}catch(D){Je("WebGLState:",D)}}function he(D){Fe.equals(D)===!1&&(s.scissor(D.x,D.y,D.z,D.w),Fe.copy(D))}function Ie(D){ut.equals(D)===!1&&(s.viewport(D.x,D.y,D.z,D.w),ut.copy(D))}function Pe(D,pe){let ce=l.get(pe);ce===void 0&&(ce=new WeakMap,l.set(pe,ce));let we=ce.get(D);we===void 0&&(we=s.getUniformBlockIndex(pe,D.name),ce.set(D,we))}function _e(D,pe){let we=l.get(pe).get(D);c.get(pe)!==we&&(s.uniformBlockBinding(pe,we,D.__bindingPointIndex),c.set(pe,we))}function Ke(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),o.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),u={},se=null,me={},h={},d=new WeakMap,f=[],p=null,x=!1,g=null,m=null,_=null,M=null,b=null,A=null,E=null,C=new Be(0,0,0),v=0,w=!1,H=null,P=null,O=null,z=null,G=null,Fe.set(0,0,s.canvas.width,s.canvas.height),ut.set(0,0,s.canvas.width,s.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:de,disable:fe,bindFramebuffer:Te,drawBuffers:Ge,useProgram:Ye,setBlending:Ee,setMaterial:bt,setFlipSided:Ze,setCullFace:gt,setLineWidth:L,setPolygonOffset:yt,setScissorTest:tt,activeTexture:nt,bindTexture:De,unbindTexture:T,compressedTexImage2D:y,compressedTexImage3D:N,texImage2D:ze,texImage3D:ae,updateUBOMapping:Pe,uniformBlockBinding:_e,texStorage2D:le,texStorage3D:Ne,texSubImage2D:J,texSubImage3D:te,compressedTexSubImage2D:j,compressedTexSubImage3D:Se,scissor:he,viewport:Ie,reset:Ke}}function kx(s,e,t,n,i,r,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new $e,u=new WeakMap,h,d=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function p(T,y){return f?new OffscreenCanvas(T,y):Ys("canvas")}function x(T,y,N){let J=1,te=De(T);if((te.width>N||te.height>N)&&(J=N/Math.max(te.width,te.height)),J<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let j=Math.floor(J*te.width),Se=Math.floor(J*te.height);h===void 0&&(h=p(j,Se));let le=y?p(j,Se):h;return le.width=j,le.height=Se,le.getContext("2d").drawImage(T,0,0,j,Se),Ve("WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+j+"x"+Se+")."),le}else return"data"in T&&Ve("WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),T;return T}function g(T){return T.generateMipmaps}function m(T){s.generateMipmap(T)}function _(T){return T.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?s.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function M(T,y,N,J,te=!1){if(T!==null){if(s[T]!==void 0)return s[T];Ve("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let j=y;if(y===s.RED&&(N===s.FLOAT&&(j=s.R32F),N===s.HALF_FLOAT&&(j=s.R16F),N===s.UNSIGNED_BYTE&&(j=s.R8)),y===s.RED_INTEGER&&(N===s.UNSIGNED_BYTE&&(j=s.R8UI),N===s.UNSIGNED_SHORT&&(j=s.R16UI),N===s.UNSIGNED_INT&&(j=s.R32UI),N===s.BYTE&&(j=s.R8I),N===s.SHORT&&(j=s.R16I),N===s.INT&&(j=s.R32I)),y===s.RG&&(N===s.FLOAT&&(j=s.RG32F),N===s.HALF_FLOAT&&(j=s.RG16F),N===s.UNSIGNED_BYTE&&(j=s.RG8)),y===s.RG_INTEGER&&(N===s.UNSIGNED_BYTE&&(j=s.RG8UI),N===s.UNSIGNED_SHORT&&(j=s.RG16UI),N===s.UNSIGNED_INT&&(j=s.RG32UI),N===s.BYTE&&(j=s.RG8I),N===s.SHORT&&(j=s.RG16I),N===s.INT&&(j=s.RG32I)),y===s.RGB_INTEGER&&(N===s.UNSIGNED_BYTE&&(j=s.RGB8UI),N===s.UNSIGNED_SHORT&&(j=s.RGB16UI),N===s.UNSIGNED_INT&&(j=s.RGB32UI),N===s.BYTE&&(j=s.RGB8I),N===s.SHORT&&(j=s.RGB16I),N===s.INT&&(j=s.RGB32I)),y===s.RGBA_INTEGER&&(N===s.UNSIGNED_BYTE&&(j=s.RGBA8UI),N===s.UNSIGNED_SHORT&&(j=s.RGBA16UI),N===s.UNSIGNED_INT&&(j=s.RGBA32UI),N===s.BYTE&&(j=s.RGBA8I),N===s.SHORT&&(j=s.RGBA16I),N===s.INT&&(j=s.RGBA32I)),y===s.RGB&&(N===s.UNSIGNED_INT_5_9_9_9_REV&&(j=s.RGB9_E5),N===s.UNSIGNED_INT_10F_11F_11F_REV&&(j=s.R11F_G11F_B10F)),y===s.RGBA){let Se=te?Pr:pt.getTransfer(J);N===s.FLOAT&&(j=s.RGBA32F),N===s.HALF_FLOAT&&(j=s.RGBA16F),N===s.UNSIGNED_BYTE&&(j=Se===St?s.SRGB8_ALPHA8:s.RGBA8),N===s.UNSIGNED_SHORT_4_4_4_4&&(j=s.RGBA4),N===s.UNSIGNED_SHORT_5_5_5_1&&(j=s.RGB5_A1)}return(j===s.R16F||j===s.R32F||j===s.RG16F||j===s.RG32F||j===s.RGBA16F||j===s.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function b(T,y){let N;return T?y===null||y===Gn||y===ur?N=s.DEPTH24_STENCIL8:y===Sn?N=s.DEPTH32F_STENCIL8:y===hr&&(N=s.DEPTH24_STENCIL8,Ve("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===Gn||y===ur?N=s.DEPTH_COMPONENT24:y===Sn?N=s.DEPTH_COMPONENT32F:y===hr&&(N=s.DEPTH_COMPONENT16),N}function A(T,y){return g(T)===!0||T.isFramebufferTexture&&T.minFilter!==zt&&T.minFilter!==kt?Math.log2(Math.max(y.width,y.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?y.mipmaps.length:1}function E(T){let y=T.target;y.removeEventListener("dispose",E),v(y),y.isVideoTexture&&u.delete(y)}function C(T){let y=T.target;y.removeEventListener("dispose",C),H(y)}function v(T){let y=n.get(T);if(y.__webglInit===void 0)return;let N=T.source,J=d.get(N);if(J){let te=J[y.__cacheKey];te.usedTimes--,te.usedTimes===0&&w(T),Object.keys(J).length===0&&d.delete(N)}n.remove(T)}function w(T){let y=n.get(T);s.deleteTexture(y.__webglTexture);let N=T.source,J=d.get(N);delete J[y.__cacheKey],o.memory.textures--}function H(T){let y=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(y.__webglFramebuffer[J]))for(let te=0;te<y.__webglFramebuffer[J].length;te++)s.deleteFramebuffer(y.__webglFramebuffer[J][te]);else s.deleteFramebuffer(y.__webglFramebuffer[J]);y.__webglDepthbuffer&&s.deleteRenderbuffer(y.__webglDepthbuffer[J])}else{if(Array.isArray(y.__webglFramebuffer))for(let J=0;J<y.__webglFramebuffer.length;J++)s.deleteFramebuffer(y.__webglFramebuffer[J]);else s.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&s.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&s.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let J=0;J<y.__webglColorRenderbuffer.length;J++)y.__webglColorRenderbuffer[J]&&s.deleteRenderbuffer(y.__webglColorRenderbuffer[J]);y.__webglDepthRenderbuffer&&s.deleteRenderbuffer(y.__webglDepthRenderbuffer)}let N=T.textures;for(let J=0,te=N.length;J<te;J++){let j=n.get(N[J]);j.__webglTexture&&(s.deleteTexture(j.__webglTexture),o.memory.textures--),n.remove(N[J])}n.remove(T)}let P=0;function O(){P=0}function z(){let T=P;return T>=i.maxTextures&&Ve("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),P+=1,T}function G(T){let y=[];return y.push(T.wrapS),y.push(T.wrapT),y.push(T.wrapR||0),y.push(T.magFilter),y.push(T.minFilter),y.push(T.anisotropy),y.push(T.internalFormat),y.push(T.format),y.push(T.type),y.push(T.generateMipmaps),y.push(T.premultiplyAlpha),y.push(T.flipY),y.push(T.unpackAlignment),y.push(T.colorSpace),y.join()}function B(T,y){let N=n.get(T);if(T.isVideoTexture&&tt(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&N.__version!==T.version){let J=T.image;if(J===null)Ve("WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)Ve("WebGLRenderer: Texture marked for update but image is incomplete");else{$(N,T,y);return}}else T.isExternalTexture&&(N.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,N.__webglTexture,s.TEXTURE0+y)}function F(T,y){let N=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&N.__version!==T.version){$(N,T,y);return}else T.isExternalTexture&&(N.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(s.TEXTURE_2D_ARRAY,N.__webglTexture,s.TEXTURE0+y)}function k(T,y){let N=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&N.__version!==T.version){$(N,T,y);return}t.bindTexture(s.TEXTURE_3D,N.__webglTexture,s.TEXTURE0+y)}function ue(T,y){let N=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&N.__version!==T.version){de(N,T,y);return}t.bindTexture(s.TEXTURE_CUBE_MAP,N.__webglTexture,s.TEXTURE0+y)}let se={[Ui]:s.REPEAT,[En]:s.CLAMP_TO_EDGE,[Xs]:s.MIRRORED_REPEAT},me={[zt]:s.NEAREST,[Ra]:s.NEAREST_MIPMAP_NEAREST,[xs]:s.NEAREST_MIPMAP_LINEAR,[kt]:s.LINEAR,[lr]:s.LINEAR_MIPMAP_NEAREST,[Vn]:s.LINEAR_MIPMAP_LINEAR},Me={[td]:s.NEVER,[od]:s.ALWAYS,[nd]:s.LESS,[gc]:s.LEQUAL,[id]:s.EQUAL,[xc]:s.GEQUAL,[sd]:s.GREATER,[rd]:s.NOTEQUAL};function Z(T,y){if(y.type===Sn&&e.has("OES_texture_float_linear")===!1&&(y.magFilter===kt||y.magFilter===lr||y.magFilter===xs||y.magFilter===Vn||y.minFilter===kt||y.minFilter===lr||y.minFilter===xs||y.minFilter===Vn)&&Ve("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(T,s.TEXTURE_WRAP_S,se[y.wrapS]),s.texParameteri(T,s.TEXTURE_WRAP_T,se[y.wrapT]),(T===s.TEXTURE_3D||T===s.TEXTURE_2D_ARRAY)&&s.texParameteri(T,s.TEXTURE_WRAP_R,se[y.wrapR]),s.texParameteri(T,s.TEXTURE_MAG_FILTER,me[y.magFilter]),s.texParameteri(T,s.TEXTURE_MIN_FILTER,me[y.minFilter]),y.compareFunction&&(s.texParameteri(T,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(T,s.TEXTURE_COMPARE_FUNC,Me[y.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===zt||y.minFilter!==xs&&y.minFilter!==Vn||y.type===Sn&&e.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){let N=e.get("EXT_texture_filter_anisotropic");s.texParameterf(T,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,i.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function Fe(T,y){let N=!1;T.__webglInit===void 0&&(T.__webglInit=!0,y.addEventListener("dispose",E));let J=y.source,te=d.get(J);te===void 0&&(te={},d.set(J,te));let j=G(y);if(j!==T.__cacheKey){te[j]===void 0&&(te[j]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,N=!0),te[j].usedTimes++;let Se=te[T.__cacheKey];Se!==void 0&&(te[T.__cacheKey].usedTimes--,Se.usedTimes===0&&w(y)),T.__cacheKey=j,T.__webglTexture=te[j].texture}return N}function ut(T,y,N){return Math.floor(Math.floor(T/N)/y)}function We(T,y,N,J){let j=T.updateRanges;if(j.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,y.width,y.height,N,J,y.data);else{j.sort((ae,he)=>ae.start-he.start);let Se=0;for(let ae=1;ae<j.length;ae++){let he=j[Se],Ie=j[ae],Pe=he.start+he.count,_e=ut(Ie.start,y.width,4),Ke=ut(he.start,y.width,4);Ie.start<=Pe+1&&_e===Ke&&ut(Ie.start+Ie.count-1,y.width,4)===_e?he.count=Math.max(he.count,Ie.start+Ie.count-he.start):(++Se,j[Se]=Ie)}j.length=Se+1;let le=s.getParameter(s.UNPACK_ROW_LENGTH),Ne=s.getParameter(s.UNPACK_SKIP_PIXELS),ze=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,y.width);for(let ae=0,he=j.length;ae<he;ae++){let Ie=j[ae],Pe=Math.floor(Ie.start/4),_e=Math.ceil(Ie.count/4),Ke=Pe%y.width,D=Math.floor(Pe/y.width),pe=_e,ce=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Ke),s.pixelStorei(s.UNPACK_SKIP_ROWS,D),t.texSubImage2D(s.TEXTURE_2D,0,Ke,D,pe,ce,N,J,y.data)}T.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,le),s.pixelStorei(s.UNPACK_SKIP_PIXELS,Ne),s.pixelStorei(s.UNPACK_SKIP_ROWS,ze)}}function $(T,y,N){let J=s.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(J=s.TEXTURE_2D_ARRAY),y.isData3DTexture&&(J=s.TEXTURE_3D);let te=Fe(T,y),j=y.source;t.bindTexture(J,T.__webglTexture,s.TEXTURE0+N);let Se=n.get(j);if(j.version!==Se.__version||te===!0){t.activeTexture(s.TEXTURE0+N);let le=pt.getPrimaries(pt.workingColorSpace),Ne=y.colorSpace===Si?null:pt.getPrimaries(y.colorSpace),ze=y.colorSpace===Si||le===Ne?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,y.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,y.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ze);let ae=x(y.image,!1,i.maxTextureSize);ae=nt(y,ae);let he=r.convert(y.format,y.colorSpace),Ie=r.convert(y.type),Pe=M(y.internalFormat,he,Ie,y.colorSpace,y.isVideoTexture);Z(J,y);let _e,Ke=y.mipmaps,D=y.isVideoTexture!==!0,pe=Se.__version===void 0||te===!0,ce=j.dataReady,we=A(y,ae);if(y.isDepthTexture)Pe=b(y.format===Wi,y.type),pe&&(D?t.texStorage2D(s.TEXTURE_2D,1,Pe,ae.width,ae.height):t.texImage2D(s.TEXTURE_2D,0,Pe,ae.width,ae.height,0,he,Ie,null));else if(y.isDataTexture)if(Ke.length>0){D&&pe&&t.texStorage2D(s.TEXTURE_2D,we,Pe,Ke[0].width,Ke[0].height);for(let re=0,K=Ke.length;re<K;re++)_e=Ke[re],D?ce&&t.texSubImage2D(s.TEXTURE_2D,re,0,0,_e.width,_e.height,he,Ie,_e.data):t.texImage2D(s.TEXTURE_2D,re,Pe,_e.width,_e.height,0,he,Ie,_e.data);y.generateMipmaps=!1}else D?(pe&&t.texStorage2D(s.TEXTURE_2D,we,Pe,ae.width,ae.height),ce&&We(y,ae,he,Ie)):t.texImage2D(s.TEXTURE_2D,0,Pe,ae.width,ae.height,0,he,Ie,ae.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){D&&pe&&t.texStorage3D(s.TEXTURE_2D_ARRAY,we,Pe,Ke[0].width,Ke[0].height,ae.depth);for(let re=0,K=Ke.length;re<K;re++)if(_e=Ke[re],y.format!==wn)if(he!==null)if(D){if(ce)if(y.layerUpdates.size>0){let Ce=Xl(_e.width,_e.height,y.format,y.type);for(let ke of y.layerUpdates){let rt=_e.data.subarray(ke*Ce/_e.data.BYTES_PER_ELEMENT,(ke+1)*Ce/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,re,0,0,ke,_e.width,_e.height,1,he,rt)}y.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,re,0,0,0,_e.width,_e.height,ae.depth,he,_e.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,re,Pe,_e.width,_e.height,ae.depth,0,_e.data,0,0);else Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?ce&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,re,0,0,0,_e.width,_e.height,ae.depth,he,Ie,_e.data):t.texImage3D(s.TEXTURE_2D_ARRAY,re,Pe,_e.width,_e.height,ae.depth,0,he,Ie,_e.data)}else{D&&pe&&t.texStorage2D(s.TEXTURE_2D,we,Pe,Ke[0].width,Ke[0].height);for(let re=0,K=Ke.length;re<K;re++)_e=Ke[re],y.format!==wn?he!==null?D?ce&&t.compressedTexSubImage2D(s.TEXTURE_2D,re,0,0,_e.width,_e.height,he,_e.data):t.compressedTexImage2D(s.TEXTURE_2D,re,Pe,_e.width,_e.height,0,_e.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?ce&&t.texSubImage2D(s.TEXTURE_2D,re,0,0,_e.width,_e.height,he,Ie,_e.data):t.texImage2D(s.TEXTURE_2D,re,Pe,_e.width,_e.height,0,he,Ie,_e.data)}else if(y.isDataArrayTexture)if(D){if(pe&&t.texStorage3D(s.TEXTURE_2D_ARRAY,we,Pe,ae.width,ae.height,ae.depth),ce)if(y.layerUpdates.size>0){let re=Xl(ae.width,ae.height,y.format,y.type);for(let K of y.layerUpdates){let Ce=ae.data.subarray(K*re/ae.data.BYTES_PER_ELEMENT,(K+1)*re/ae.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,K,ae.width,ae.height,1,he,Ie,Ce)}y.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ae.width,ae.height,ae.depth,he,Ie,ae.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,Pe,ae.width,ae.height,ae.depth,0,he,Ie,ae.data);else if(y.isData3DTexture)D?(pe&&t.texStorage3D(s.TEXTURE_3D,we,Pe,ae.width,ae.height,ae.depth),ce&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ae.width,ae.height,ae.depth,he,Ie,ae.data)):t.texImage3D(s.TEXTURE_3D,0,Pe,ae.width,ae.height,ae.depth,0,he,Ie,ae.data);else if(y.isFramebufferTexture){if(pe)if(D)t.texStorage2D(s.TEXTURE_2D,we,Pe,ae.width,ae.height);else{let re=ae.width,K=ae.height;for(let Ce=0;Ce<we;Ce++)t.texImage2D(s.TEXTURE_2D,Ce,Pe,re,K,0,he,Ie,null),re>>=1,K>>=1}}else if(Ke.length>0){if(D&&pe){let re=De(Ke[0]);t.texStorage2D(s.TEXTURE_2D,we,Pe,re.width,re.height)}for(let re=0,K=Ke.length;re<K;re++)_e=Ke[re],D?ce&&t.texSubImage2D(s.TEXTURE_2D,re,0,0,he,Ie,_e):t.texImage2D(s.TEXTURE_2D,re,Pe,he,Ie,_e);y.generateMipmaps=!1}else if(D){if(pe){let re=De(ae);t.texStorage2D(s.TEXTURE_2D,we,Pe,re.width,re.height)}ce&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,he,Ie,ae)}else t.texImage2D(s.TEXTURE_2D,0,Pe,he,Ie,ae);g(y)&&m(J),Se.__version=j.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function de(T,y,N){if(y.image.length!==6)return;let J=Fe(T,y),te=y.source;t.bindTexture(s.TEXTURE_CUBE_MAP,T.__webglTexture,s.TEXTURE0+N);let j=n.get(te);if(te.version!==j.__version||J===!0){t.activeTexture(s.TEXTURE0+N);let Se=pt.getPrimaries(pt.workingColorSpace),le=y.colorSpace===Si?null:pt.getPrimaries(y.colorSpace),Ne=y.colorSpace===Si||Se===le?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,y.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,y.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);let ze=y.isCompressedTexture||y.image[0].isCompressedTexture,ae=y.image[0]&&y.image[0].isDataTexture,he=[];for(let K=0;K<6;K++)!ze&&!ae?he[K]=x(y.image[K],!0,i.maxCubemapSize):he[K]=ae?y.image[K].image:y.image[K],he[K]=nt(y,he[K]);let Ie=he[0],Pe=r.convert(y.format,y.colorSpace),_e=r.convert(y.type),Ke=M(y.internalFormat,Pe,_e,y.colorSpace),D=y.isVideoTexture!==!0,pe=j.__version===void 0||J===!0,ce=te.dataReady,we=A(y,Ie);Z(s.TEXTURE_CUBE_MAP,y);let re;if(ze){D&&pe&&t.texStorage2D(s.TEXTURE_CUBE_MAP,we,Ke,Ie.width,Ie.height);for(let K=0;K<6;K++){re=he[K].mipmaps;for(let Ce=0;Ce<re.length;Ce++){let ke=re[Ce];y.format!==wn?Pe!==null?D?ce&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce,0,0,ke.width,ke.height,Pe,ke.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce,Ke,ke.width,ke.height,0,ke.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?ce&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce,0,0,ke.width,ke.height,Pe,_e,ke.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce,Ke,ke.width,ke.height,0,Pe,_e,ke.data)}}}else{if(re=y.mipmaps,D&&pe){re.length>0&&we++;let K=De(he[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,we,Ke,K.width,K.height)}for(let K=0;K<6;K++)if(ae){D?ce&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,he[K].width,he[K].height,Pe,_e,he[K].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ke,he[K].width,he[K].height,0,Pe,_e,he[K].data);for(let Ce=0;Ce<re.length;Ce++){let rt=re[Ce].image[K].image;D?ce&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce+1,0,0,rt.width,rt.height,Pe,_e,rt.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce+1,Ke,rt.width,rt.height,0,Pe,_e,rt.data)}}else{D?ce&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Pe,_e,he[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ke,Pe,_e,he[K]);for(let Ce=0;Ce<re.length;Ce++){let ke=re[Ce];D?ce&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce+1,0,0,Pe,_e,ke.image[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Ce+1,Ke,Pe,_e,ke.image[K])}}}g(y)&&m(s.TEXTURE_CUBE_MAP),j.__version=te.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function fe(T,y,N,J,te,j){let Se=r.convert(N.format,N.colorSpace),le=r.convert(N.type),Ne=M(N.internalFormat,Se,le,N.colorSpace),ze=n.get(y),ae=n.get(N);if(ae.__renderTarget=y,!ze.__hasExternalTextures){let he=Math.max(1,y.width>>j),Ie=Math.max(1,y.height>>j);te===s.TEXTURE_3D||te===s.TEXTURE_2D_ARRAY?t.texImage3D(te,j,Ne,he,Ie,y.depth,0,Se,le,null):t.texImage2D(te,j,Ne,he,Ie,0,Se,le,null)}t.bindFramebuffer(s.FRAMEBUFFER,T),yt(y)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,J,te,ae.__webglTexture,0,L(y)):(te===s.TEXTURE_2D||te>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,J,te,ae.__webglTexture,j),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Te(T,y,N){if(s.bindRenderbuffer(s.RENDERBUFFER,T),y.depthBuffer){let J=y.depthTexture,te=J&&J.isDepthTexture?J.type:null,j=b(y.stencilBuffer,te),Se=y.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;yt(y)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,L(y),j,y.width,y.height):N?s.renderbufferStorageMultisample(s.RENDERBUFFER,L(y),j,y.width,y.height):s.renderbufferStorage(s.RENDERBUFFER,j,y.width,y.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Se,s.RENDERBUFFER,T)}else{let J=y.textures;for(let te=0;te<J.length;te++){let j=J[te],Se=r.convert(j.format,j.colorSpace),le=r.convert(j.type),Ne=M(j.internalFormat,Se,le,j.colorSpace);yt(y)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,L(y),Ne,y.width,y.height):N?s.renderbufferStorageMultisample(s.RENDERBUFFER,L(y),Ne,y.width,y.height):s.renderbufferStorage(s.RENDERBUFFER,Ne,y.width,y.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Ge(T,y,N){let J=y.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(s.FRAMEBUFFER,T),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let te=n.get(y.depthTexture);if(te.__renderTarget=y,(!te.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),J){if(te.__webglInit===void 0&&(te.__webglInit=!0,y.depthTexture.addEventListener("dispose",E)),te.__webglTexture===void 0){te.__webglTexture=s.createTexture(),t.bindTexture(s.TEXTURE_CUBE_MAP,te.__webglTexture),Z(s.TEXTURE_CUBE_MAP,y.depthTexture);let ze=r.convert(y.depthTexture.format),ae=r.convert(y.depthTexture.type),he;y.depthTexture.format===Yn?he=s.DEPTH_COMPONENT24:y.depthTexture.format===Wi&&(he=s.DEPTH24_STENCIL8);for(let Ie=0;Ie<6;Ie++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ie,0,he,y.width,y.height,0,ze,ae,null)}}else B(y.depthTexture,0);let j=te.__webglTexture,Se=L(y),le=J?s.TEXTURE_CUBE_MAP_POSITIVE_X+N:s.TEXTURE_2D,Ne=y.depthTexture.format===Wi?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(y.depthTexture.format===Yn)yt(y)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Ne,le,j,0,Se):s.framebufferTexture2D(s.FRAMEBUFFER,Ne,le,j,0);else if(y.depthTexture.format===Wi)yt(y)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Ne,le,j,0,Se):s.framebufferTexture2D(s.FRAMEBUFFER,Ne,le,j,0);else throw new Error("Unknown depthTexture format")}function Ye(T){let y=n.get(T),N=T.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==T.depthTexture){let J=T.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),J){let te=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,J.removeEventListener("dispose",te)};J.addEventListener("dispose",te),y.__depthDisposeCallback=te}y.__boundDepthTexture=J}if(T.depthTexture&&!y.__autoAllocateDepthBuffer)if(N)for(let J=0;J<6;J++)Ge(y.__webglFramebuffer[J],T,J);else{let J=T.texture.mipmaps;J&&J.length>0?Ge(y.__webglFramebuffer[0],T,0):Ge(y.__webglFramebuffer,T,0)}else if(N){y.__webglDepthbuffer=[];for(let J=0;J<6;J++)if(t.bindFramebuffer(s.FRAMEBUFFER,y.__webglFramebuffer[J]),y.__webglDepthbuffer[J]===void 0)y.__webglDepthbuffer[J]=s.createRenderbuffer(),Te(y.__webglDepthbuffer[J],T,!1);else{let te=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,j=y.__webglDepthbuffer[J];s.bindRenderbuffer(s.RENDERBUFFER,j),s.framebufferRenderbuffer(s.FRAMEBUFFER,te,s.RENDERBUFFER,j)}}else{let J=T.texture.mipmaps;if(J&&J.length>0?t.bindFramebuffer(s.FRAMEBUFFER,y.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=s.createRenderbuffer(),Te(y.__webglDepthbuffer,T,!1);else{let te=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,j=y.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,j),s.framebufferRenderbuffer(s.FRAMEBUFFER,te,s.RENDERBUFFER,j)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function Pt(T,y,N){let J=n.get(T);y!==void 0&&fe(J.__webglFramebuffer,T,T.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),N!==void 0&&Ye(T)}function st(T){let y=T.texture,N=n.get(T),J=n.get(y);T.addEventListener("dispose",C);let te=T.textures,j=T.isWebGLCubeRenderTarget===!0,Se=te.length>1;if(Se||(J.__webglTexture===void 0&&(J.__webglTexture=s.createTexture()),J.__version=y.version,o.memory.textures++),j){N.__webglFramebuffer=[];for(let le=0;le<6;le++)if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer[le]=[];for(let Ne=0;Ne<y.mipmaps.length;Ne++)N.__webglFramebuffer[le][Ne]=s.createFramebuffer()}else N.__webglFramebuffer[le]=s.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer=[];for(let le=0;le<y.mipmaps.length;le++)N.__webglFramebuffer[le]=s.createFramebuffer()}else N.__webglFramebuffer=s.createFramebuffer();if(Se)for(let le=0,Ne=te.length;le<Ne;le++){let ze=n.get(te[le]);ze.__webglTexture===void 0&&(ze.__webglTexture=s.createTexture(),o.memory.textures++)}if(T.samples>0&&yt(T)===!1){N.__webglMultisampledFramebuffer=s.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let le=0;le<te.length;le++){let Ne=te[le];N.__webglColorRenderbuffer[le]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,N.__webglColorRenderbuffer[le]);let ze=r.convert(Ne.format,Ne.colorSpace),ae=r.convert(Ne.type),he=M(Ne.internalFormat,ze,ae,Ne.colorSpace,T.isXRRenderTarget===!0),Ie=L(T);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ie,he,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+le,s.RENDERBUFFER,N.__webglColorRenderbuffer[le])}s.bindRenderbuffer(s.RENDERBUFFER,null),T.depthBuffer&&(N.__webglDepthRenderbuffer=s.createRenderbuffer(),Te(N.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(j){t.bindTexture(s.TEXTURE_CUBE_MAP,J.__webglTexture),Z(s.TEXTURE_CUBE_MAP,y);for(let le=0;le<6;le++)if(y.mipmaps&&y.mipmaps.length>0)for(let Ne=0;Ne<y.mipmaps.length;Ne++)fe(N.__webglFramebuffer[le][Ne],T,y,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ne);else fe(N.__webglFramebuffer[le],T,y,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);g(y)&&m(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Se){for(let le=0,Ne=te.length;le<Ne;le++){let ze=te[le],ae=n.get(ze),he=s.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(he=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(he,ae.__webglTexture),Z(he,ze),fe(N.__webglFramebuffer,T,ze,s.COLOR_ATTACHMENT0+le,he,0),g(ze)&&m(he)}t.unbindTexture()}else{let le=s.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(le=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(le,J.__webglTexture),Z(le,y),y.mipmaps&&y.mipmaps.length>0)for(let Ne=0;Ne<y.mipmaps.length;Ne++)fe(N.__webglFramebuffer[Ne],T,y,s.COLOR_ATTACHMENT0,le,Ne);else fe(N.__webglFramebuffer,T,y,s.COLOR_ATTACHMENT0,le,0);g(y)&&m(le),t.unbindTexture()}T.depthBuffer&&Ye(T)}function Ee(T){let y=T.textures;for(let N=0,J=y.length;N<J;N++){let te=y[N];if(g(te)){let j=_(T),Se=n.get(te).__webglTexture;t.bindTexture(j,Se),m(j),t.unbindTexture()}}}let bt=[],Ze=[];function gt(T){if(T.samples>0){if(yt(T)===!1){let y=T.textures,N=T.width,J=T.height,te=s.COLOR_BUFFER_BIT,j=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Se=n.get(T),le=y.length>1;if(le)for(let ze=0;ze<y.length;ze++)t.bindFramebuffer(s.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ze,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,Se.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+ze,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,Se.__webglMultisampledFramebuffer);let Ne=T.texture.mipmaps;Ne&&Ne.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Se.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Se.__webglFramebuffer);for(let ze=0;ze<y.length;ze++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(te|=s.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(te|=s.STENCIL_BUFFER_BIT)),le){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Se.__webglColorRenderbuffer[ze]);let ae=n.get(y[ze]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,ae,0)}s.blitFramebuffer(0,0,N,J,0,0,N,J,te,s.NEAREST),c===!0&&(bt.length=0,Ze.length=0,bt.push(s.COLOR_ATTACHMENT0+ze),T.depthBuffer&&T.resolveDepthBuffer===!1&&(bt.push(j),Ze.push(j),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Ze)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,bt))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),le)for(let ze=0;ze<y.length;ze++){t.bindFramebuffer(s.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ze,s.RENDERBUFFER,Se.__webglColorRenderbuffer[ze]);let ae=n.get(y[ze]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,Se.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+ze,s.TEXTURE_2D,ae,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Se.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){let y=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[y])}}}function L(T){return Math.min(i.maxSamples,T.samples)}function yt(T){let y=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function tt(T){let y=o.render.frame;u.get(T)!==y&&(u.set(T,y),T.update())}function nt(T,y){let N=T.colorSpace,J=T.format,te=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||N!==Qt&&N!==Si&&(pt.getTransfer(N)===St?(J!==wn||te!==gn)&&Ve("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Je("WebGLTextures: Unsupported texture color space:",N)),y}function De(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=z,this.resetTextureUnits=O,this.setTexture2D=B,this.setTexture2DArray=F,this.setTexture3D=k,this.setTextureCube=ue,this.rebindTextures=Pt,this.setupRenderTarget=st,this.updateRenderTargetMipmap=Ee,this.updateMultisampleRenderTarget=gt,this.setupDepthRenderbuffer=Ye,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=yt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Vx(s,e){function t(n,i=Si){let r,o=pt.getTransfer(i);if(n===gn)return s.UNSIGNED_BYTE;if(n===Pa)return s.UNSIGNED_SHORT_4_4_4_4;if(n===La)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Il)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Pl)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===Cl)return s.BYTE;if(n===Rl)return s.SHORT;if(n===hr)return s.UNSIGNED_SHORT;if(n===Ia)return s.INT;if(n===Gn)return s.UNSIGNED_INT;if(n===Sn)return s.FLOAT;if(n===ri)return s.HALF_FLOAT;if(n===Ll)return s.ALPHA;if(n===Dl)return s.RGB;if(n===wn)return s.RGBA;if(n===Yn)return s.DEPTH_COMPONENT;if(n===Wi)return s.DEPTH_STENCIL;if(n===Da)return s.RED;if(n===Na)return s.RED_INTEGER;if(n===_s)return s.RG;if(n===Ua)return s.RG_INTEGER;if(n===Fa)return s.RGBA_INTEGER;if(n===ao||n===co||n===lo||n===ho)if(o===St)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ao)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===co)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===lo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ho)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ao)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===co)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===lo)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ho)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Oa||n===Ba||n===za||n===ka)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Oa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ba)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===za)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ka)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Va||n===Ga||n===Ha||n===Wa||n===Xa||n===qa||n===Ya)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Va||n===Ga)return o===St?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Ha)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Wa)return r.COMPRESSED_R11_EAC;if(n===Xa)return r.COMPRESSED_SIGNED_R11_EAC;if(n===qa)return r.COMPRESSED_RG11_EAC;if(n===Ya)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Za||n===Ka||n===Ja||n===$a||n===ja||n===Qa||n===ec||n===tc||n===nc||n===ic||n===sc||n===rc||n===oc||n===ac)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Za)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ka)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ja)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===$a)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ja)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Qa)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ec)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===tc)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===nc)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ic)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===sc)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===rc)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===oc)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ac)return o===St?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===cc||n===lc||n===hc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===cc)return o===St?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===lc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===hc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===uc||n===dc||n===fc||n===pc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===uc)return r.COMPRESSED_RED_RGTC1_EXT;if(n===dc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===fc)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===pc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ur?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}var Gx=`
void main() {
...
}`,rh=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Xr(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new bn({vertexShader:Gx,fragmentShader:Hx,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new mt(new Zr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},oh=class extends Zn{constructor(e,t){super();let n=this,i=null,r=1,o=null,a="local-floor",c=1,l=null,u=null,h=null,d=null,f=null,p=null,x=typeof XRWebGLBinding<"u",g=new rh,m={},_=t.getContextAttributes(),M=null,b=null,A=[],E=[],C=new $e,v=null,w=new Nt;w.viewport=new Lt;let H=new Nt;H.viewport=new Lt;let P=[w,H],O=new wa,z=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let de=A[$];return de===void 0&&(de=new $s,A[$]=de),de.getTargetRaySpace()},this.getControllerGrip=function($){let de=A[$];return de===void 0&&(de=new $s,A[$]=de),de.getGripSpace()},this.getHand=function($){let de=A[$];return de===void 0&&(de=new $s,A[$]=de),de.getHandSpace()};function B($){let de=E.indexOf($.inputSource);if(de===-1)return;let fe=A[de];fe!==void 0&&(fe.update($.inputSource,$.frame,l||o),fe.dispatchEvent({type:$.type,data:$.inputSource}))}function F(){i.removeEventListener("select",B),i.removeEventListener("selectstart",B),i.removeEventListener("selectend",B),i.removeEventListener("squeeze",B),i.removeEventListener("squeezestart",B),i.removeEventListener("squeezeend",B),i.removeEventListener("end",F),i.removeEventListener("inputsourceschange",k);for(let $=0;$<A.length;$++){let de=E[$];de!==null&&(E[$]=null,A[$].disconnect(de))}z=null,G=null,g.reset();for(let $ in m)delete m[$];e.setRenderTarget(M),f=null,d=null,h=null,i=null,b=null,We.stop(),n.isPresenting=!1,e.setPixelRatio(v),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){r=$,n.isPresenting===!0&&Ve("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){a=$,n.isPresenting===!0&&Ve("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function($){l=$},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return h===null&&x&&(h=new XRWebGLBinding(i,t)),h},this.getFrame=function(){return p},this.getSession=function(){return i},this.setSession=async function($){if(i=$,i!==null){if(M=e.getRenderTarget(),i.addEventListener("select",B),i.addEventListener("selectstart",B),i.addEventListener("selectend",B),i.addEventListener("squeeze",B),i.addEventListener("squeezestart",B),i.addEventListener("squeezeend",B),i.addEventListener("end",F),i.addEventListener("inputsourceschange",k),_.xrCompatible!==!0&&await t.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(C),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let fe=null,Te=null,Ge=null;_.depth&&(Ge=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,fe=_.stencil?Wi:Yn,Te=_.stencil?ur:Gn);let Ye={colorFormat:t.RGBA8,depthFormat:Ge,scaleFactor:r};h=this.getBinding(),d=h.createProjectionLayer(Ye),i.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),b=new Mn(d.textureWidth,d.textureHeight,{format:wn,type:gn,depthTexture:new zi(d.textureWidth,d.textureHeight,Te,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let fe={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(i,t,fe),i.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),b=new Mn(f.framebufferWidth,f.framebufferHeight,{format:wn,type:gn,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await i.requestReferenceSpace(a),We.setContext(i),We.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function k($){for(let de=0;de<$.removed.length;de++){let fe=$.removed[de],Te=E.indexOf(fe);Te>=0&&(E[Te]=null,A[Te].disconnect(fe))}for(let de=0;de<$.added.length;de++){let fe=$.added[de],Te=E.indexOf(fe);if(Te===-1){for(let Ye=0;Ye<A.length;Ye++)if(Ye>=E.length){E.push(fe),Te=Ye;break}else if(E[Ye]===null){E[Ye]=fe,Te=Ye;break}if(Te===-1)break}let Ge=A[Te];Ge&&Ge.connect(fe)}}let ue=new R,se=new R;function me($,de,fe){ue.setFromMatrixPosition(de.matrixWorld),se.setFromMatrixPosition(fe.matrixWorld);let Te=ue.distanceTo(se),Ge=de.projectionMatrix.elements,Ye=fe.projectionMatrix.elements,Pt=Ge[14]/(Ge[10]-1),st=Ge[14]/(Ge[10]+1),Ee=(Ge[9]+1)/Ge[5],bt=(Ge[9]-1)/Ge[5],Ze=(Ge[8]-1)/Ge[0],gt=(Ye[8]+1)/Ye[0],L=Pt*Ze,yt=Pt*gt,tt=Te/(-Ze+gt),nt=tt*-Ze;if(de.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(nt),$.translateZ(tt),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Ge[10]===-1)$.projectionMatrix.copy(de.projectionMatrix),$.projectionMatrixInverse.copy(de.projectionMatrixInverse);else{let De=Pt+tt,T=st+tt,y=L-nt,N=yt+(Te-nt),J=Ee*st/T*De,te=bt*st/T*De;$.projectionMatrix.makePerspective(y,N,J,te,De,T),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function Me($,de){de===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(de.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(i===null)return;let de=$.near,fe=$.far;g.texture!==null&&(g.depthNear>0&&(de=g.depthNear),g.depthFar>0&&(fe=g.depthFar)),O.near=H.near=w.near=de,O.far=H.far=w.far=fe,(z!==O.near||G!==O.far)&&(i.updateRenderState({depthNear:O.near,depthFar:O.far}),z=O.near,G=O.far),O.layers.mask=$.layers.mask|6,w.layers.mask=O.layers.mask&-5,H.layers.mask=O.layers.mask&-3;let Te=$.parent,Ge=O.cameras;Me(O,Te);for(let Ye=0;Ye<Ge.length;Ye++)Me(Ge[Ye],Te);Ge.length===2?me(O,w,H):O.projectionMatrix.copy(w.projectionMatrix),Z($,O,Te)};function Z($,de,fe){fe===null?$.matrix.copy(de.matrixWorld):($.matrix.copy(fe.matrixWorld),$.matrix.invert(),$.matrix.multiply(de.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(de.projectionMatrix),$.projectionMatrixInverse.copy(de.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=ls*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return O},this.getFoveation=function(){if(!(d===null&&f===null))return c},this.setFoveation=function($){c=$,d!==null&&(d.fixedFoveation=$),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=$)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(O)},this.getCameraTexture=function($){return m[$]};let Fe=null;function ut($,de){if(u=de.getViewerPose(l||o),p=de,u!==null){let fe=u.views;f!==null&&(e.setRenderTargetFramebuffer(b,f.framebuffer),e.setRenderTarget(b));let Te=!1;fe.length!==O.cameras.length&&(O.cameras.length=0,Te=!0);for(let st=0;st<fe.length;st++){let Ee=fe[st],bt=null;if(f!==null)bt=f.getViewport(Ee);else{let gt=h.getViewSubImage(d,Ee);bt=gt.viewport,st===0&&(e.setRenderTargetTextures(b,gt.colorTexture,gt.depthStencilTexture),e.setRenderTarget(b))}let Ze=P[st];Ze===void 0&&(Ze=new Nt,Ze.layers.enable(st),Ze.viewport=new Lt,P[st]=Ze),Ze.matrix.fromArray(Ee.transform.matrix),Ze.matrix.decompose(Ze.position,Ze.quaternion,Ze.scale),Ze.projectionMatrix.fromArray(Ee.projectionMatrix),Ze.projectionMatrixInverse.copy(Ze.projectionMatrix).invert(),Ze.viewport.set(bt.x,bt.y,bt.width,bt.height),st===0&&(O.matrix.copy(Ze.matrix),O.matrix.decompose(O.position,O.quaternion,O.scale)),Te===!0&&O.cameras.push(Ze)}let Ge=i.enabledFeatures;if(Ge&&Ge.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&x){h=n.getBinding();let st=h.getDepthInformation(fe[0]);st&&st.isValid&&st.texture&&g.init(st,i.renderState)}if(Ge&&Ge.includes("camera-access")&&x){e.state.unbindTexture(),h=n.getBinding();for(let st=0;st<fe.length;st++){let Ee=fe[st].camera;if(Ee){let bt=m[Ee];bt||(bt=new Xr,m[Ee]=bt);let Ze=h.getCameraImage(Ee);bt.sourceTexture=Ze}}}}for(let fe=0;fe<A.length;fe++){let Te=E[fe],Ge=A[fe];Te!==null&&Ge!==void 0&&Ge.update(Te,de,l||o)}Fe&&Fe($,de),de.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:de}),p=null}let We=new zd;We.setAnimationLoop(ut),this.setAnimationLoop=function($){Fe=$},this.dispose=function(){}}},Ms=new zn,Wx=new it;function Xx(s,e){function t(g,m){g.matrixAutoUpdate===!0&&g.updateMatrix(),m.value.copy(g.matrix)}function n(g,m){m.color.getRGB(g.fogColor.value,Vl(s)),m.isFog?(g.fogNear.value=m.near,g.fogFar.value=m.far):m.isFogExp2&&(g.fogDensity.value=m.density)}function i(g,m,_,M,b){m.isMeshBasicMaterial?r(g,m):m.isMeshLambertMaterial?(r(g,m),m.envMap&&(g.envMapIntensity.value=m.envMapIntensity)):m.isMeshToonMaterial?(r(g,m),h(g,m)):m.isMeshPhongMaterial?(r(g,m),u(g,m),m.envMap&&(g.envMapIntensity.value=m.envMapIntensity)):m.isMeshStandardMaterial?(r(g,m),d(g,m),m.isMeshPhysicalMaterial&&f(g,m,b)):m.isMeshMatcapMaterial?(r(g,m),p(g,m)):m.isMeshDepthMaterial?r(g,m):m.isMeshDistanceMaterial?(r(g,m),x(g,m)):m.isMeshNormalMaterial?r(g,m):m.isLineBasicMaterial?(o(g,m),m.isLineDashedMaterial&&a(g,m)):m.isPointsMaterial?c(g,m,_,M):m.isSpriteMaterial?l(g,m):m.isShadowMaterial?(g.color.value.copy(m.color),g.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function r(g,m){g.opacity.value=m.opacity,m.color&&g.diffuse.value.copy(m.color),m.emissive&&g.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(g.map.value=m.map,t(m.map,g.mapTransform)),m.alphaMap&&(g.alphaMap.value=m.alphaMap,t(m.alphaMap,g.alphaMapTransform)),m.bumpMap&&(g.bumpMap.value=m.bumpMap,t(m.bumpMap,g.bumpMapTransform),g.bumpScale.value=m.bumpScale,m.side===hn&&(g.bumpScale.value*=-1)),m.normalMap&&(g.normalMap.value=m.normalMap,t(m.normalMap,g.normalMapTransform),g.normalScale.value.copy(m.normalScale),m.side===hn&&g.normalScale.value.negate()),m.displacementMap&&(g.displacementMap.value=m.displacementMap,t(m.displacementMap,g.displacementMapTransform),g.displacementScale.value=m.displacementScale,g.displacementBias.value=m.displacementBias),m.emissiveMap&&(g.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,g.emissiveMapTransform)),m.specularMap&&(g.specularMap.value=m.specularMap,t(m.specularMap,g.specularMapTransform)),m.alphaTest>0&&(g.alphaTest.value=m.alphaTest);let _=e.get(m),M=_.envMap,b=_.envMapRotation;M&&(g.envMap.value=M,Ms.copy(b),Ms.x*=-1,Ms.y*=-1,Ms.z*=-1,M.isCubeTexture&&M.isRenderTargetTexture===!1&&(Ms.y*=-1,Ms.z*=-1),g.envMapRotation.value.setFromMatrix4(Wx.makeRotationFromEuler(Ms)),g.flipEnvMap.value=M.isCubeTexture&&M.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=m.reflectivity,g.ior.value=m.ior,g.refractionRatio.value=m.refractionRatio),m.lightMap&&(g.lightMap.value=m.lightMap,g.lightMapIntensity.value=m.lightMapIntensity,t(m.lightMap,g.lightMapTransform)),m.aoMap&&(g.aoMap.value=m.aoMap,g.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,g.aoMapTransform))}function o(g,m){g.diffuse.value.copy(m.color),g.opacity.value=m.opacity,m.map&&(g.map.value=m.map,t(m.map,g.mapTransform))}function a(g,m){g.dashSize.value=m.dashSize,g.totalSize.value=m.dashSize+m.gapSize,g.scale.value=m.scale}function c(g,m,_,M){g.diffuse.value.copy(m.color),g.opacity.value=m.opacity,g.size.value=m.size*_,g.scale.value=M*.5,m.map&&(g.map.value=m.map,t(m.map,g.uvTransform)),m.alphaMap&&(g.alphaMap.value=m.alphaMap,t(m.alphaMap,g.alphaMapTransform)),m.alphaTest>0&&(g.alphaTest.value=m.alphaTest)}function l(g,m){g.diffuse.value.copy(m.color),g.opacity.value=m.opacity,g.rotation.value=m.rotation,m.map&&(g.map.value=m.map,t(m.map,g.mapTransform)),m.alphaMap&&(g.alphaMap.value=m.alphaMap,t(m.alphaMap,g.alphaMapTransform)),m.alphaTest>0&&(g.alphaTest.value=m.alphaTest)}function u(g,m){g.specular.value.copy(m.specular),g.shininess.value=Math.max(m.shininess,1e-4)}function h(g,m){m.gradientMap&&(g.gradientMap.value=m.gradientMap)}function d(g,m){g.metalness.value=m.metalness,m.metalnessMap&&(g.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,g.metalnessMapTransform)),g.roughness.value=m.roughness,m.roughnessMap&&(g.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,g.roughnessMapTransform)),m.envMap&&(g.envMapIntensity.value=m.envMapIntensity)}function f(g,m,_){g.ior.value=m.ior,m.sheen>0&&(g.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),g.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(g.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,g.sheenColorMapTransform)),m.sheenRoughnessMap&&(g.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,g.sheenRoughnessMapTransform))),m.clearcoat>0&&(g.clearcoat.value=m.clearcoat,g.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(g.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,g.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(g.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===hn&&g.clearcoatNormalScale.value.negate())),m.dispersion>0&&(g.dispersion.value=m.dispersion),m.iridescence>0&&(g.iridescence.value=m.iridescence,g.iridescenceIOR.value=m.iridescenceIOR,g.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(g.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,g.iridescenceMapTransform)),m.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),m.transmission>0&&(g.transmission.value=m.transmission,g.transmissionSamplerMap.value=_.texture,g.transmissionSamplerSize.value.set(_.width,_.height),m.transmissionMap&&(g.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,g.transmissionMapTransform)),g.thickness.value=m.thickness,m.thicknessMap&&(g.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=m.attenuationDistance,g.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(g.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(g.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=m.specularIntensity,g.specularColor.value.copy(m.specularColor),m.specularColorMap&&(g.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,g.specularColorMapTransform)),m.specularIntensityMap&&(g.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,g.specularIntensityMapTransform))}function p(g,m){m.matcap&&(g.matcap.value=m.matcap)}function x(g,m){let _=e.get(m).light;g.referencePosition.value.setFromMatrixPosition(_.matrixWorld),g.nearDistance.value=_.shadow.camera.near,g.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function qx(s,e,t,n){let i={},r={},o=[],a=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function c(_,M){let b=M.program;n.uniformBlockBinding(_,b)}function l(_,M){let b=i[_.id];b===void 0&&(p(_),b=u(_),i[_.id]=b,_.addEventListener("dispose",g));let A=M.program;n.updateUBOMapping(_,A);let E=e.render.frame;r[_.id]!==E&&(d(_),r[_.id]=E)}function u(_){let M=h();_.__bindingPointIndex=M;let b=s.createBuffer(),A=_.__size,E=_.usage;return s.bindBuffer(s.UNIFORM_BUFFER,b),s.bufferData(s.UNIFORM_BUFFER,A,E),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,M,b),b}function h(){for(let _=0;_<a;_++)if(o.indexOf(_)===-1)return o.push(_),_;return Je("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(_){let M=i[_.id],b=_.uniforms,A=_.__cache;s.bindBuffer(s.UNIFORM_BUFFER,M);for(let E=0,C=b.length;E<C;E++){let v=Array.isArray(b[E])?b[E]:[b[E]];for(let w=0,H=v.length;w<H;w++){let P=v[w];if(f(P,E,w,A)===!0){let O=P.__offset,z=Array.isArray(P.value)?P.value:[P.value],G=0;for(let B=0;B<z.length;B++){let F=z[B],k=x(F);typeof F=="number"||typeof F=="boolean"?(P.__data[0]=F,s.bufferSubData(s.UNIFORM_BUFFER,O+G,P.__data)):F.isMatrix3?(P.__data[0]=F.elements[0],P.__data[1]=F.elements[1],P.__data[2]=F.elements[2],P.__data[3]=0,P.__data[4]=F.elements[3],P.__data[5]=F.elements[4],P.__data[6]=F.elements[5],P.__data[7]=0,P.__data[8]=F.elements[6],P.__data[9]=F.elements[7],P.__data[10]=F.elements[8],P.__data[11]=0):(F.toArray(P.__data,G),G+=k.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,O,P.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function f(_,M,b,A){let E=_.value,C=M+"_"+b;if(A[C]===void 0)return typeof E=="number"||typeof E=="boolean"?A[C]=E:A[C]=E.clone(),!0;{let v=A[C];if(typeof E=="number"||typeof E=="boolean"){if(v!==E)return A[C]=E,!0}else if(v.equals(E)===!1)return v.copy(E),!0}return!1}function p(_){let M=_.uniforms,b=0,A=16;for(let C=0,v=M.length;C<v;C++){let w=Array.isArray(M[C])?M[C]:[M[C]];for(let H=0,P=w.length;H<P;H++){let O=w[H],z=Array.isArray(O.value)?O.value:[O.value];for(let G=0,B=z.length;G<B;G++){let F=z[G],k=x(F),ue=b%A,se=ue%k.boundary,me=ue+se;b+=se,me!==0&&A-me<k.storage&&(b+=A-me),O.__data=new Float32Array(k.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=b,b+=k.storage}}}let E=b%A;return E>0&&(b+=A-E),_.__size=b,_.__cache={},this}function x(_){let M={boundary:0,storage:0};return typeof _=="number"||typeof _=="boolean"?(M.boundary=4,M.storage=4):_.isVector2?(M.boundary=8,M.storage=8):_.isVector3||_.isColor?(M.boundary=16,M.storage=12):_.isVector4?(M.boundary=16,M.storage=16):_.isMatrix3?(M.boundary=48,M.storage=48):_.isMatrix4?(M.boundary=64,M.storage=64):_.isTexture?Ve("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ve("WebGLRenderer: Unsupported uniform value type.",_),M}function g(_){let M=_.target;M.removeEventListener("dispose",g);let b=o.indexOf(M.__bindingPointIndex);o.splice(b,1),s.deleteBuffer(i[M.id]),delete i[M.id],delete r[M.id]}function m(){for(let _ in i)s.deleteBuffer(i[_]);o=[],i={},r={}}return{bind:c,update:l,dispose:m}}var Yx=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),oi=null;function Zx(){return oi===null&&(oi=new er(Yx,16,16,_s,ri),oi.name="DFG_LUT",oi.minFilter=kt,oi.magFilter=kt,oi.wrapS=En,oi.wrapT=En,oi.generateMipmaps=!1,oi.needsUpdate=!0),oi}var wi=class{constructor(e={}){let{canvas:t=cd(),context:n=null,depth:i=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:d=!1,outputBufferType:f=gn}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=o;let x=f,g=new Set([Fa,Ua,Na]),m=new Set([gn,Gn,hr,ur,Pa,La]),_=new Uint32Array(4),M=new Int32Array(4),b=null,A=null,E=[],C=[],v=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=kn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let w=this,H=!1;this._outputColorSpace=Ut;let P=0,O=0,z=null,G=-1,B=null,F=new Lt,k=new Lt,ue=null,se=new Be(0),me=0,Me=t.width,Z=t.height,Fe=1,ut=null,We=null,$=new Lt(0,0,Me,Z),de=new Lt(0,0,Me,Z),fe=!1,Te=new tr,Ge=!1,Ye=!1,Pt=new it,st=new R,Ee=new Lt,bt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ze=!1;function gt(){return z===null?Fe:1}let L=n;function yt(S,U){return t.getContext(S,U)}try{let S={alpha:!0,depth:i,stencil:r,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"183"}`),t.addEventListener("webglcontextlost",Ce,!1),t.addEventListener("webglcontextrestored",ke,!1),t.addEventListener("webglcontextcreationerror",rt,!1),L===null){let U="webgl2";if(L=yt(U,S),L===null)throw yt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw Je("WebGLRenderer: "+S.message),S}let tt,nt,De,T,y,N,J,te,j,Se,le,Ne,ze,ae,he,Ie,Pe,_e,Ke,D,pe,ce,we;function re(){tt=new n0(L),tt.init(),pe=new Vx(L,tt),nt=new Zg(L,tt,e,pe),De=new zx(L,tt),nt.reversedDepthBuffer&&d&&De.buffers.depth.setReversed(!0),T=new r0(L),y=new Tx,N=new kx(L,tt,De,y,nt,pe,T),J=new t0(w),te=new hp(L),ce=new qg(L,te),j=new i0(L,te,T,ce),Se=new a0(L,j,te,ce,T),_e=new o0(L,nt,N),he=new Kg(y),le=new wx(w,J,tt,nt,ce,he),Ne=new Xx(w,y),ze=new Ex,ae=new Dx(tt),Pe=new Xg(w,J,De,Se,p,c),Ie=new Bx(w,Se,nt),we=new qx(L,T,nt,De),Ke=new Yg(L,tt,T),D=new s0(L,tt,T),T.programs=le.programs,w.capabilities=nt,w.extensions=tt,w.properties=y,w.renderLists=ze,w.shadowMap=Ie,w.state=De,w.info=T}re(),x!==gn&&(v=new l0(x,t.width,t.height,i,r));let K=new oh(w,L);this.xr=K,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){let S=tt.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){let S=tt.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return Fe},this.setPixelRatio=function(S){S!==void 0&&(Fe=S,this.setSize(Me,Z,!1))},this.getSize=function(S){return S.set(Me,Z)},this.setSize=function(S,U,Y=!0){if(K.isPresenting){Ve("WebGLRenderer: Can't change size while VR device is presenting.");return}Me=S,Z=U,t.width=Math.floor(S*Fe),t.height=Math.floor(U*Fe),Y===!0&&(t.style.width=S+"px",t.style.height=U+"px"),v!==null&&v.setSize(t.width,t.height),this.setViewport(0,0,S,U)},this.getDrawingBufferSize=function(S){return S.set(Me*Fe,Z*Fe).floor()},this.setDrawingBufferSize=function(S,U,Y){Me=S,Z=U,Fe=Y,t.width=Math.floor(S*Y),t.height=Math.floor(U*Y),this.setViewport(0,0,S,U)},this.setEffects=function(S){if(x===gn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let U=0;U<S.length;U++)if(S[U].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}v.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(F)},this.getViewport=function(S){return S.copy($)},this.setViewport=function(S,U,Y,q){S.isVector4?$.set(S.x,S.y,S.z,S.w):$.set(S,U,Y,q),De.viewport(F.copy($).multiplyScalar(Fe).round())},this.getScissor=function(S){return S.copy(de)},this.setScissor=function(S,U,Y,q){S.isVector4?de.set(S.x,S.y,S.z,S.w):de.set(S,U,Y,q),De.scissor(k.copy(de).multiplyScalar(Fe).round())},this.getScissorTest=function(){return fe},this.setScissorTest=function(S){De.setScissorTest(fe=S)},this.setOpaqueSort=function(S){ut=S},this.setTransparentSort=function(S){We=S},this.getClearColor=function(S){return S.copy(Pe.getClearColor())},this.setClearColor=function(){Pe.setClearColor(...arguments)},this.getClearAlpha=function(){return Pe.getClearAlpha()},this.setClearAlpha=function(){Pe.setClearAlpha(...arguments)},this.clear=function(S=!0,U=!0,Y=!0){let q=0;if(S){let V=!1;if(z!==null){let xe=z.texture.format;V=g.has(xe)}if(V){let xe=z.texture.type,Re=m.has(xe),be=Pe.getClearColor(),Ue=Pe.getClearAlpha(),He=be.r,ot=be.g,lt=be.b;Re?(_[0]=He,_[1]=ot,_[2]=lt,_[3]=Ue,L.clearBufferuiv(L.COLOR,0,_)):(M[0]=He,M[1]=ot,M[2]=lt,M[3]=Ue,L.clearBufferiv(L.COLOR,0,M))}else q|=L.COLOR_BUFFER_BIT}U&&(q|=L.DEPTH_BUFFER_BIT),Y&&(q|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),q!==0&&L.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ce,!1),t.removeEventListener("webglcontextrestored",ke,!1),t.removeEventListener("webglcontextcreationerror",rt,!1),Pe.dispose(),ze.dispose(),ae.dispose(),y.dispose(),J.dispose(),Se.dispose(),ce.dispose(),we.dispose(),le.dispose(),K.dispose(),K.removeEventListener("sessionstart",I),K.removeEventListener("sessionend",X),Q.stop()};function Ce(S){S.preventDefault(),Lr("WebGLRenderer: Context Lost."),H=!0}function ke(){Lr("WebGLRenderer: Context Restored."),H=!1;let S=T.autoReset,U=Ie.enabled,Y=Ie.autoUpdate,q=Ie.needsUpdate,V=Ie.type;re(),T.autoReset=S,Ie.enabled=U,Ie.autoUpdate=Y,Ie.needsUpdate=q,Ie.type=V}function rt(S){Je("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function Qe(S){let U=S.target;U.removeEventListener("dispose",Qe),tn(U)}function tn(S){W(S),y.remove(S)}function W(S){let U=y.get(S).programs;U!==void 0&&(U.forEach(function(Y){le.releaseProgram(Y)}),S.isShaderMaterial&&le.releaseShaderCache(S))}this.renderBufferDirect=function(S,U,Y,q,V,xe){U===null&&(U=bt);let Re=V.isMesh&&V.matrixWorld.determinant()<0,be=Ct(S,U,Y,q,V);De.setMaterial(q,Re);let Ue=Y.index,He=1;if(q.wireframe===!0){if(Ue=j.getWireframeAttribute(Y),Ue===void 0)return;He=2}let ot=Y.drawRange,lt=Y.attributes.position,Xe=ot.start*He,Tt=(ot.start+ot.count)*He;xe!==null&&(Xe=Math.max(Xe,xe.start*He),Tt=Math.min(Tt,(xe.start+xe.count)*He)),Ue!==null?(Xe=Math.max(Xe,0),Tt=Math.min(Tt,Ue.count)):lt!=null&&(Xe=Math.max(Xe,0),Tt=Math.min(Tt,lt.count));let Bt=Tt-Xe;if(Bt<0||Bt===1/0)return;ce.setup(V,q,be,Y,Ue);let Ft,At=Ke;if(Ue!==null&&(Ft=te.get(Ue),At=D,At.setIndex(Ft)),V.isMesh)q.wireframe===!0?(De.setLineWidth(q.wireframeLinewidth*gt()),At.setMode(L.LINES)):At.setMode(L.TRIANGLES);else if(V.isLine){let nn=q.linewidth;nn===void 0&&(nn=1),De.setLineWidth(nn*gt()),V.isLineSegments?At.setMode(L.LINES):V.isLineLoop?At.setMode(L.LINE_LOOP):At.setMode(L.LINE_STRIP)}else V.isPoints?At.setMode(L.POINTS):V.isSprite&&At.setMode(L.TRIANGLES);if(V.isBatchedMesh)if(V._multiDrawInstances!==null)Dr("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),At.renderMultiDrawInstances(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount,V._multiDrawInstances);else if(tt.get("WEBGL_multi_draw"))At.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{let nn=V._multiDrawStarts,Oe=V._multiDrawCounts,_n=V._multiDrawCount,vt=Ue?te.get(Ue).bytesPerElement:1,Pn=y.get(q).currentProgram.getUniforms();for(let Hn=0;Hn<_n;Hn++)Pn.setValue(L,"_gl_DrawID",Hn),At.render(nn[Hn]/vt,Oe[Hn])}else if(V.isInstancedMesh)At.renderInstances(Xe,Bt,V.count);else if(Y.isInstancedBufferGeometry){let nn=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,Oe=Math.min(Y.instanceCount,nn);At.renderInstances(Xe,Bt,Oe)}else At.render(Xe,Bt)};function ee(S,U,Y){S.transparent===!0&&S.side===en&&S.forceSinglePass===!1?(S.side=hn,S.needsUpdate=!0,Ae(S,U,Y),S.side=Bn,S.needsUpdate=!0,Ae(S,U,Y),S.side=en):Ae(S,U,Y)}this.compile=function(S,U,Y=null){Y===null&&(Y=S),A=ae.get(Y),A.init(U),C.push(A),Y.traverseVisible(function(V){V.isLight&&V.layers.test(U.layers)&&(A.pushLight(V),V.castShadow&&A.pushShadow(V))}),S!==Y&&S.traverseVisible(function(V){V.isLight&&V.layers.test(U.layers)&&(A.pushLight(V),V.castShadow&&A.pushShadow(V))}),A.setupLights();let q=new Set;return S.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;let xe=V.material;if(xe)if(Array.isArray(xe))for(let Re=0;Re<xe.length;Re++){let be=xe[Re];ee(be,Y,V),q.add(be)}else ee(xe,Y,V),q.add(xe)}),A=C.pop(),q},this.compileAsync=function(S,U,Y=null){let q=this.compile(S,U,Y);return new Promise(V=>{function xe(){if(q.forEach(function(Re){y.get(Re).currentProgram.isReady()&&q.delete(Re)}),q.size===0){V(S);return}setTimeout(xe,10)}tt.get("KHR_parallel_shader_compile")!==null?xe():setTimeout(xe,10)})};let oe=null;function Le(S){oe&&oe(S)}function I(){Q.stop()}function X(){Q.start()}let Q=new zd;Q.setAnimationLoop(Le),typeof self<"u"&&Q.setContext(self),this.setAnimationLoop=function(S){oe=S,K.setAnimationLoop(S),S===null?Q.stop():Q.start()},K.addEventListener("sessionstart",I),K.addEventListener("sessionend",X),this.render=function(S,U){if(U!==void 0&&U.isCamera!==!0){Je("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(H===!0)return;let Y=K.enabled===!0&&K.isPresenting===!0,q=v!==null&&(z===null||Y)&&v.begin(w,z);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),K.enabled===!0&&K.isPresenting===!0&&(v===null||v.isCompositing()===!1)&&(K.cameraAutoUpdate===!0&&K.updateCamera(U),U=K.getCamera()),S.isScene===!0&&S.onBeforeRender(w,S,U,z),A=ae.get(S,C.length),A.init(U),C.push(A),Pt.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Te.setFromProjectionMatrix(Pt,Fn,U.reversedDepth),Ye=this.localClippingEnabled,Ge=he.init(this.clippingPlanes,Ye),b=ze.get(S,E.length),b.init(),E.push(b),K.enabled===!0&&K.isPresenting===!0){let Re=w.xr.getDepthSensingMesh();Re!==null&&ne(Re,U,-1/0,w.sortObjects)}ne(S,U,0,w.sortObjects),b.finish(),w.sortObjects===!0&&b.sort(ut,We),Ze=K.enabled===!1||K.isPresenting===!1||K.hasDepthSensing()===!1,Ze&&Pe.addToRenderList(b,S),this.info.render.frame++,Ge===!0&&he.beginShadows();let V=A.state.shadowsArray;if(Ie.render(V,S,U),Ge===!0&&he.endShadows(),this.info.autoReset===!0&&this.info.reset(),(q&&v.hasRenderPass())===!1){let Re=b.opaque,be=b.transmissive;if(A.setupLights(),U.isArrayCamera){let Ue=U.cameras;if(be.length>0)for(let He=0,ot=Ue.length;He<ot;He++){let lt=Ue[He];ye(Re,be,S,lt)}Ze&&Pe.render(S);for(let He=0,ot=Ue.length;He<ot;He++){let lt=Ue[He];ie(b,S,lt,lt.viewport)}}else be.length>0&&ye(Re,be,S,U),Ze&&Pe.render(S),ie(b,S,U)}z!==null&&O===0&&(N.updateMultisampleRenderTarget(z),N.updateRenderTargetMipmap(z)),q&&v.end(w),S.isScene===!0&&S.onAfterRender(w,S,U),ce.resetDefaultState(),G=-1,B=null,C.pop(),C.length>0?(A=C[C.length-1],Ge===!0&&he.setGlobalState(w.clippingPlanes,A.state.camera)):A=null,E.pop(),E.length>0?b=E[E.length-1]:b=null};function ne(S,U,Y,q){if(S.visible===!1)return;if(S.layers.test(U.layers)){if(S.isGroup)Y=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(U);else if(S.isLight)A.pushLight(S),S.castShadow&&A.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||Te.intersectsSprite(S)){q&&Ee.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Pt);let Re=Se.update(S),be=S.material;be.visible&&b.push(S,Re,be,Y,Ee.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||Te.intersectsObject(S))){let Re=Se.update(S),be=S.material;if(q&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ee.copy(S.boundingSphere.center)):(Re.boundingSphere===null&&Re.computeBoundingSphere(),Ee.copy(Re.boundingSphere.center)),Ee.applyMatrix4(S.matrixWorld).applyMatrix4(Pt)),Array.isArray(be)){let Ue=Re.groups;for(let He=0,ot=Ue.length;He<ot;He++){let lt=Ue[He],Xe=be[lt.materialIndex];Xe&&Xe.visible&&b.push(S,Re,Xe,Y,Ee.z,lt)}}else be.visible&&b.push(S,Re,be,Y,Ee.z,null)}}let xe=S.children;for(let Re=0,be=xe.length;Re<be;Re++)ne(xe[Re],U,Y,q)}function ie(S,U,Y,q){let{opaque:V,transmissive:xe,transparent:Re}=S;A.setupLightsView(Y),Ge===!0&&he.setGlobalState(w.clippingPlanes,Y),q&&De.viewport(F.copy(q)),V.length>0&&ge(V,U,Y),xe.length>0&&ge(xe,U,Y),Re.length>0&&ge(Re,U,Y),De.buffers.depth.setTest(!0),De.buffers.depth.setMask(!0),De.buffers.color.setMask(!0),De.setPolygonOffset(!1)}function ye(S,U,Y,q){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[q.id]===void 0){let Xe=tt.has("EXT_color_buffer_half_float")||tt.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[q.id]=new Mn(1,1,{generateMipmaps:!0,type:Xe?ri:gn,minFilter:Vn,samples:Math.max(4,nt.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:pt.workingColorSpace})}let xe=A.state.transmissionRenderTarget[q.id],Re=q.viewport||F;xe.setSize(Re.z*w.transmissionResolutionScale,Re.w*w.transmissionResolutionScale);let be=w.getRenderTarget(),Ue=w.getActiveCubeFace(),He=w.getActiveMipmapLevel();w.setRenderTarget(xe),w.getClearColor(se),me=w.getClearAlpha(),me<1&&w.setClearColor(16777215,.5),w.clear(),Ze&&Pe.render(Y);let ot=w.toneMapping;w.toneMapping=kn;let lt=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),A.setupLightsView(q),Ge===!0&&he.setGlobalState(w.clippingPlanes,q),ge(S,Y,q),N.updateMultisampleRenderTarget(xe),N.updateRenderTargetMipmap(xe),tt.has("WEBGL_multisampled_render_to_texture")===!1){let Xe=!1;for(let Tt=0,Bt=U.length;Tt<Bt;Tt++){let Ft=U[Tt],{object:At,geometry:nn,material:Oe,group:_n}=Ft;if(Oe.side===en&&At.layers.test(q.layers)){let vt=Oe.side;Oe.side=hn,Oe.needsUpdate=!0,et(At,Y,q,nn,Oe,_n),Oe.side=vt,Oe.needsUpdate=!0,Xe=!0}}Xe===!0&&(N.updateMultisampleRenderTarget(xe),N.updateRenderTargetMipmap(xe))}w.setRenderTarget(be,Ue,He),w.setClearColor(se,me),lt!==void 0&&(q.viewport=lt),w.toneMapping=ot}function ge(S,U,Y){let q=U.isScene===!0?U.overrideMaterial:null;for(let V=0,xe=S.length;V<xe;V++){let Re=S[V],{object:be,geometry:Ue,group:He}=Re,ot=Re.material;ot.allowOverride===!0&&q!==null&&(ot=q),be.layers.test(Y.layers)&&et(be,U,Y,Ue,ot,He)}}function et(S,U,Y,q,V,xe){S.onBeforeRender(w,U,Y,q,V,xe),S.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),V.onBeforeRender(w,U,Y,q,S,xe),V.transparent===!0&&V.side===en&&V.forceSinglePass===!1?(V.side=hn,V.needsUpdate=!0,w.renderBufferDirect(Y,U,q,V,S,xe),V.side=Bn,V.needsUpdate=!0,w.renderBufferDirect(Y,U,q,V,S,xe),V.side=en):w.renderBufferDirect(Y,U,q,V,S,xe),S.onAfterRender(w,U,Y,q,V,xe)}function Ae(S,U,Y){U.isScene!==!0&&(U=bt);let q=y.get(S),V=A.state.lights,xe=A.state.shadowsArray,Re=V.state.version,be=le.getParameters(S,V.state,xe,U,Y),Ue=le.getProgramCacheKey(be),He=q.programs;q.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?U.environment:null,q.fog=U.fog;let ot=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;q.envMap=J.get(S.envMap||q.environment,ot),q.envMapRotation=q.environment!==null&&S.envMap===null?U.environmentRotation:S.envMapRotation,He===void 0&&(S.addEventListener("dispose",Qe),He=new Map,q.programs=He);let lt=He.get(Ue);if(lt!==void 0){if(q.currentProgram===lt&&q.lightsStateVersion===Re)return ft(S,be),lt}else be.uniforms=le.getUniforms(S),S.onBeforeCompile(be,w),lt=le.acquireProgram(be,Ue),He.set(Ue,lt),q.uniforms=be.uniforms;let Xe=q.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Xe.clippingPlanes=he.uniform),ft(S,be),q.needsLights=$t(S),q.lightsStateVersion=Re,q.needsLights&&(Xe.ambientLightColor.value=V.state.ambient,Xe.lightProbe.value=V.state.probe,Xe.directionalLights.value=V.state.directional,Xe.directionalLightShadows.value=V.state.directionalShadow,Xe.spotLights.value=V.state.spot,Xe.spotLightShadows.value=V.state.spotShadow,Xe.rectAreaLights.value=V.state.rectArea,Xe.ltc_1.value=V.state.rectAreaLTC1,Xe.ltc_2.value=V.state.rectAreaLTC2,Xe.pointLights.value=V.state.point,Xe.pointLightShadows.value=V.state.pointShadow,Xe.hemisphereLights.value=V.state.hemi,Xe.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Xe.spotLightMatrix.value=V.state.spotLightMatrix,Xe.spotLightMap.value=V.state.spotLightMap,Xe.pointShadowMatrix.value=V.state.pointShadowMatrix),q.currentProgram=lt,q.uniformsList=null,lt}function je(S){if(S.uniformsList===null){let U=S.currentProgram.getUniforms();S.uniformsList=pr.seqWithValue(U.seq,S.uniforms)}return S.uniformsList}function ft(S,U){let Y=y.get(S);Y.outputColorSpace=U.outputColorSpace,Y.batching=U.batching,Y.batchingColor=U.batchingColor,Y.instancing=U.instancing,Y.instancingColor=U.instancingColor,Y.instancingMorph=U.instancingMorph,Y.skinning=U.skinning,Y.morphTargets=U.morphTargets,Y.morphNormals=U.morphNormals,Y.morphColors=U.morphColors,Y.morphTargetsCount=U.morphTargetsCount,Y.numClippingPlanes=U.numClippingPlanes,Y.numIntersection=U.numClipIntersection,Y.vertexAlphas=U.vertexAlphas,Y.vertexTangents=U.vertexTangents,Y.toneMapping=U.toneMapping}function Ct(S,U,Y,q,V){U.isScene!==!0&&(U=bt),N.resetTextureUnits();let xe=U.fog,Re=q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial?U.environment:null,be=z===null?w.outputColorSpace:z.isXRRenderTarget===!0?z.texture.colorSpace:Qt,Ue=q.isMeshStandardMaterial||q.isMeshLambertMaterial&&!q.envMap||q.isMeshPhongMaterial&&!q.envMap,He=J.get(q.envMap||Re,Ue),ot=q.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,lt=!!Y.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Xe=!!Y.morphAttributes.position,Tt=!!Y.morphAttributes.normal,Bt=!!Y.morphAttributes.color,Ft=kn;q.toneMapped&&(z===null||z.isXRRenderTarget===!0)&&(Ft=w.toneMapping);let At=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,nn=At!==void 0?At.length:0,Oe=y.get(q),_n=A.state.lights;if(Ge===!0&&(Ye===!0||S!==B)){let Zt=S===B&&q.id===G;he.setState(q,S,Zt)}let vt=!1;q.version===Oe.__version?(Oe.needsLights&&Oe.lightsStateVersion!==_n.state.version||Oe.outputColorSpace!==be||V.isBatchedMesh&&Oe.batching===!1||!V.isBatchedMesh&&Oe.batching===!0||V.isBatchedMesh&&Oe.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&Oe.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&Oe.instancing===!1||!V.isInstancedMesh&&Oe.instancing===!0||V.isSkinnedMesh&&Oe.skinning===!1||!V.isSkinnedMesh&&Oe.skinning===!0||V.isInstancedMesh&&Oe.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&Oe.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&Oe.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&Oe.instancingMorph===!1&&V.morphTexture!==null||Oe.envMap!==He||q.fog===!0&&Oe.fog!==xe||Oe.numClippingPlanes!==void 0&&(Oe.numClippingPlanes!==he.numPlanes||Oe.numIntersection!==he.numIntersection)||Oe.vertexAlphas!==ot||Oe.vertexTangents!==lt||Oe.morphTargets!==Xe||Oe.morphNormals!==Tt||Oe.morphColors!==Bt||Oe.toneMapping!==Ft||Oe.morphTargetsCount!==nn)&&(vt=!0):(vt=!0,Oe.__version=q.version);let Pn=Oe.currentProgram;vt===!0&&(Pn=Ae(q,U,V));let Hn=!1,Ji=!1,ws=!1,Rt=Pn.getUniforms(),jt=Oe.uniforms;if(De.useProgram(Pn.program)&&(Hn=!0,Ji=!0,ws=!0),q.id!==G&&(G=q.id,Ji=!0),Hn||B!==S){De.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),Rt.setValue(L,"projectionMatrix",S.projectionMatrix),Rt.setValue(L,"viewMatrix",S.matrixWorldInverse);let Ei=Rt.map.cameraPosition;Ei!==void 0&&Ei.setValue(L,st.setFromMatrixPosition(S.matrixWorld)),nt.logarithmicDepthBuffer&&Rt.setValue(L,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&Rt.setValue(L,"isOrthographic",S.isOrthographicCamera===!0),B!==S&&(B=S,Ji=!0,ws=!0)}if(Oe.needsLights&&(_n.state.directionalShadowMap.length>0&&Rt.setValue(L,"directionalShadowMap",_n.state.directionalShadowMap,N),_n.state.spotShadowMap.length>0&&Rt.setValue(L,"spotShadowMap",_n.state.spotShadowMap,N),_n.state.pointShadowMap.length>0&&Rt.setValue(L,"pointShadowMap",_n.state.pointShadowMap,N)),V.isSkinnedMesh){Rt.setOptional(L,V,"bindMatrix"),Rt.setOptional(L,V,"bindMatrixInverse");let Zt=V.skeleton;Zt&&(Zt.boneTexture===null&&Zt.computeBoneTexture(),Rt.setValue(L,"boneTexture",Zt.boneTexture,N))}V.isBatchedMesh&&(Rt.setOptional(L,V,"batchingTexture"),Rt.setValue(L,"batchingTexture",V._matricesTexture,N),Rt.setOptional(L,V,"batchingIdTexture"),Rt.setValue(L,"batchingIdTexture",V._indirectTexture,N),Rt.setOptional(L,V,"batchingColorTexture"),V._colorsTexture!==null&&Rt.setValue(L,"batchingColorTexture",V._colorsTexture,N));let Ai=Y.morphAttributes;if((Ai.position!==void 0||Ai.normal!==void 0||Ai.color!==void 0)&&_e.update(V,Y,Pn),(Ji||Oe.receiveShadow!==V.receiveShadow)&&(Oe.receiveShadow=V.receiveShadow,Rt.setValue(L,"receiveShadow",V.receiveShadow)),(q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial)&&q.envMap===null&&U.environment!==null&&(jt.envMapIntensity.value=U.environmentIntensity),jt.dfgLUT!==void 0&&(jt.dfgLUT.value=Zx()),Ji&&(Rt.setValue(L,"toneMappingExposure",w.toneMappingExposure),Oe.needsLights&&xn(jt,ws),xe&&q.fog===!0&&Ne.refreshFogUniforms(jt,xe),Ne.refreshMaterialUniforms(jt,q,Fe,Z,A.state.transmissionRenderTarget[S.id]),pr.upload(L,je(Oe),jt,N)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(pr.upload(L,je(Oe),jt,N),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&Rt.setValue(L,"center",V.center),Rt.setValue(L,"modelViewMatrix",V.modelViewMatrix),Rt.setValue(L,"normalMatrix",V.normalMatrix),Rt.setValue(L,"modelMatrix",V.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){let Zt=q.uniformsGroups;for(let Ei=0,Ts=Zt.length;Ei<Ts;Ei++){let Vh=Zt[Ei];we.update(Vh,Pn),we.bind(Vh,Pn)}}return Pn}function xn(S,U){S.ambientLightColor.needsUpdate=U,S.lightProbe.needsUpdate=U,S.directionalLights.needsUpdate=U,S.directionalLightShadows.needsUpdate=U,S.pointLights.needsUpdate=U,S.pointLightShadows.needsUpdate=U,S.spotLights.needsUpdate=U,S.spotLightShadows.needsUpdate=U,S.rectAreaLights.needsUpdate=U,S.hemisphereLights.needsUpdate=U}function $t(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return O},this.getRenderTarget=function(){return z},this.setRenderTargetTextures=function(S,U,Y){let q=y.get(S);q.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,q.__autoAllocateDepthBuffer===!1&&(q.__useRenderToTexture=!1),y.get(S.texture).__webglTexture=U,y.get(S.depthTexture).__webglTexture=q.__autoAllocateDepthBuffer?void 0:Y,q.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,U){let Y=y.get(S);Y.__webglFramebuffer=U,Y.__useDefaultFramebuffer=U===void 0};let un=L.createFramebuffer();this.setRenderTarget=function(S,U=0,Y=0){z=S,P=U,O=Y;let q=null,V=!1,xe=!1;if(S){let be=y.get(S);if(be.__useDefaultFramebuffer!==void 0){De.bindFramebuffer(L.FRAMEBUFFER,be.__webglFramebuffer),F.copy(S.viewport),k.copy(S.scissor),ue=S.scissorTest,De.viewport(F),De.scissor(k),De.setScissorTest(ue),G=-1;return}else if(be.__webglFramebuffer===void 0)N.setupRenderTarget(S);else if(be.__hasExternalTextures)N.rebindTextures(S,y.get(S.texture).__webglTexture,y.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){let ot=S.depthTexture;if(be.__boundDepthTexture!==ot){if(ot!==null&&y.has(ot)&&(S.width!==ot.image.width||S.height!==ot.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");N.setupDepthRenderbuffer(S)}}let Ue=S.texture;(Ue.isData3DTexture||Ue.isDataArrayTexture||Ue.isCompressedArrayTexture)&&(xe=!0);let He=y.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(He[U])?q=He[U][Y]:q=He[U],V=!0):S.samples>0&&N.useMultisampledRTT(S)===!1?q=y.get(S).__webglMultisampledFramebuffer:Array.isArray(He)?q=He[Y]:q=He,F.copy(S.viewport),k.copy(S.scissor),ue=S.scissorTest}else F.copy($).multiplyScalar(Fe).floor(),k.copy(de).multiplyScalar(Fe).floor(),ue=fe;if(Y!==0&&(q=un),De.bindFramebuffer(L.FRAMEBUFFER,q)&&De.drawBuffers(S,q),De.viewport(F),De.scissor(k),De.setScissorTest(ue),V){let be=y.get(S.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+U,be.__webglTexture,Y)}else if(xe){let be=U;for(let Ue=0;Ue<S.textures.length;Ue++){let He=y.get(S.textures[Ue]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+Ue,He.__webglTexture,Y,be)}}else if(S!==null&&Y!==0){let be=y.get(S.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,be.__webglTexture,Y)}G=-1},this.readRenderTargetPixels=function(S,U,Y,q,V,xe,Re,be=0){if(!(S&&S.isWebGLRenderTarget)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ue=y.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Re!==void 0&&(Ue=Ue[Re]),Ue){De.bindFramebuffer(L.FRAMEBUFFER,Ue);try{let He=S.textures[be],ot=He.format,lt=He.type;if(S.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+be),!nt.textureFormatReadable(ot)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!nt.textureTypeReadable(lt)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=S.width-q&&Y>=0&&Y<=S.height-V&&L.readPixels(U,Y,q,V,pe.convert(ot),pe.convert(lt),xe)}finally{let He=z!==null?y.get(z).__webglFramebuffer:null;De.bindFramebuffer(L.FRAMEBUFFER,He)}}},this.readRenderTargetPixelsAsync=async function(S,U,Y,q,V,xe,Re,be=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ue=y.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Re!==void 0&&(Ue=Ue[Re]),Ue)if(U>=0&&U<=S.width-q&&Y>=0&&Y<=S.height-V){De.bindFramebuffer(L.FRAMEBUFFER,Ue);let He=S.textures[be],ot=He.format,lt=He.type;if(S.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+be),!nt.textureFormatReadable(ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!nt.textureTypeReadable(lt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Xe=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Xe),L.bufferData(L.PIXEL_PACK_BUFFER,xe.byteLength,L.STREAM_READ),L.readPixels(U,Y,q,V,pe.convert(ot),pe.convert(lt),0);let Tt=z!==null?y.get(z).__webglFramebuffer:null;De.bindFramebuffer(L.FRAMEBUFFER,Tt);let Bt=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await hd(L,Bt,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,Xe),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,xe),L.deleteBuffer(Xe),L.deleteSync(Bt),xe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,U=null,Y=0){let q=Math.pow(2,-Y),V=Math.floor(S.image.width*q),xe=Math.floor(S.image.height*q),Re=U!==null?U.x:0,be=U!==null?U.y:0;N.setTexture2D(S,0),L.copyTexSubImage2D(L.TEXTURE_2D,Y,0,0,Re,be,V,xe),De.unbindTexture()};let Ti=L.createFramebuffer(),Tn=L.createFramebuffer();this.copyTextureToTexture=function(S,U,Y=null,q=null,V=0,xe=0){let Re,be,Ue,He,ot,lt,Xe,Tt,Bt,Ft=S.isCompressedTexture?S.mipmaps[xe]:S.image;if(Y!==null)Re=Y.max.x-Y.min.x,be=Y.max.y-Y.min.y,Ue=Y.isBox3?Y.max.z-Y.min.z:1,He=Y.min.x,ot=Y.min.y,lt=Y.isBox3?Y.min.z:0;else{let jt=Math.pow(2,-V);Re=Math.floor(Ft.width*jt),be=Math.floor(Ft.height*jt),S.isDataArrayTexture?Ue=Ft.depth:S.isData3DTexture?Ue=Math.floor(Ft.depth*jt):Ue=1,He=0,ot=0,lt=0}q!==null?(Xe=q.x,Tt=q.y,Bt=q.z):(Xe=0,Tt=0,Bt=0);let At=pe.convert(U.format),nn=pe.convert(U.type),Oe;U.isData3DTexture?(N.setTexture3D(U,0),Oe=L.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(N.setTexture2DArray(U,0),Oe=L.TEXTURE_2D_ARRAY):(N.setTexture2D(U,0),Oe=L.TEXTURE_2D),L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,U.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,U.unpackAlignment);let _n=L.getParameter(L.UNPACK_ROW_LENGTH),vt=L.getParameter(L.UNPACK_IMAGE_HEIGHT),Pn=L.getParameter(L.UNPACK_SKIP_PIXELS),Hn=L.getParameter(L.UNPACK_SKIP_ROWS),Ji=L.getParameter(L.UNPACK_SKIP_IMAGES);L.pixelStorei(L.UNPACK_ROW_LENGTH,Ft.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Ft.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,He),L.pixelStorei(L.UNPACK_SKIP_ROWS,ot),L.pixelStorei(L.UNPACK_SKIP_IMAGES,lt);let ws=S.isDataArrayTexture||S.isData3DTexture,Rt=U.isDataArrayTexture||U.isData3DTexture;if(S.isDepthTexture){let jt=y.get(S),Ai=y.get(U),Zt=y.get(jt.__renderTarget),Ei=y.get(Ai.__renderTarget);De.bindFramebuffer(L.READ_FRAMEBUFFER,Zt.__webglFramebuffer),De.bindFramebuffer(L.DRAW_FRAMEBUFFER,Ei.__webglFramebuffer);for(let Ts=0;Ts<Ue;Ts++)ws&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,y.get(S).__webglTexture,V,lt+Ts),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,y.get(U).__webglTexture,xe,Bt+Ts)),L.blitFramebuffer(He,ot,Re,be,Xe,Tt,Re,be,L.DEPTH_BUFFER_BIT,L.NEAREST);De.bindFramebuffer(L.READ_FRAMEBUFFER,null),De.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(V!==0||S.isRenderTargetTexture||y.has(S)){let jt=y.get(S),Ai=y.get(U);De.bindFramebuffer(L.READ_FRAMEBUFFER,Ti),De.bindFramebuffer(L.DRAW_FRAMEBUFFER,Tn);for(let Zt=0;Zt<Ue;Zt++)ws?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,jt.__webglTexture,V,lt+Zt):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,jt.__webglTexture,V),Rt?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Ai.__webglTexture,xe,Bt+Zt):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Ai.__webglTexture,xe),V!==0?L.blitFramebuffer(He,ot,Re,be,Xe,Tt,Re,be,L.COLOR_BUFFER_BIT,L.NEAREST):Rt?L.copyTexSubImage3D(Oe,xe,Xe,Tt,Bt+Zt,He,ot,Re,be):L.copyTexSubImage2D(Oe,xe,Xe,Tt,He,ot,Re,be);De.bindFramebuffer(L.READ_FRAMEBUFFER,null),De.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else Rt?S.isDataTexture||S.isData3DTexture?L.texSubImage3D(Oe,xe,Xe,Tt,Bt,Re,be,Ue,At,nn,Ft.data):U.isCompressedArrayTexture?L.compressedTexSubImage3D(Oe,xe,Xe,Tt,Bt,Re,be,Ue,At,Ft.data):L.texSubImage3D(Oe,xe,Xe,Tt,Bt,Re,be,Ue,At,nn,Ft):S.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,xe,Xe,Tt,Re,be,At,nn,Ft.data):S.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,xe,Xe,Tt,Ft.width,Ft.height,At,Ft.data):L.texSubImage2D(L.TEXTURE_2D,xe,Xe,Tt,Re,be,At,nn,Ft);L.pixelStorei(L.UNPACK_ROW_LENGTH,_n),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,vt),L.pixelStorei(L.UNPACK_SKIP_PIXELS,Pn),L.pixelStorei(L.UNPACK_SKIP_ROWS,Hn),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Ji),xe===0&&U.generateMipmaps&&L.generateMipmap(Oe),De.unbindTexture()},this.initRenderTarget=function(S){y.get(S).__webglFramebuffer===void 0&&N.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?N.setTextureCube(S,0):S.isData3DTexture?N.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?N.setTexture2DArray(S,0):N.setTexture2D(S,0),De.unbindTexture()},this.resetState=function(){P=0,O=0,z=null,De.reset(),ce.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=pt._getDrawingBufferColorSpace(e),t.unpackColorSpace=pt._getUnpackColorSpace()}};function wc(s,e){let t=1,n=i=>{i.preventDefault();let r=i.deltaY*(i.deltaMode===1?16:i.deltaMode===2?s.clientHeight:1);t=Math.max(.6,Math.min(1.8,t*Math.exp(Math.max(-240,Math.min(240,r))*.0018))),e.dataset.zoomDistance=t.toFixed(3)};return s.addEventListener("wheel",n,{passive:!1}),s.title="\uD720 \uC704\uB85C: \uAC00\uAE4C\uC774 \xB7 \uD720 \uC544\uB798\uB85C: \uBA40\uB9AC",e.dataset.zoomDistance="1.000",{get distance(){return t},dispose(){s.removeEventListener("wheel",n)}}}var qe=Math.SQRT2;function Tc(s,e,t=()=>!0){let n=0,i=null,r=!1,o=()=>{clearTimeout(n),n=0,i=null,r=!1,e.dataset.running="false"},a=l=>{l.button!==0||!t()||(o(),i=l.pointerId,s.setPointerCapture?.(l.pointerId),n=setTimeout(()=>{i===l.pointerId&&t()&&(r=!0,e.dataset.running="true")},350))},c=l=>{i===l.pointerId&&o()};return s.style.touchAction="none",s.setAttribute("aria-label","\uBC14\uB2E5\uC744 \uC9E7\uAC8C \uB204\uB974\uBA74 \uAC77\uAE30, \uAE38\uAC8C \uB204\uB974\uBA74 \uB2EC\uB9AC\uAE30"),s.addEventListener("pointerdown",a),window.addEventListener("pointerup",c),window.addEventListener("pointercancel",c),s.addEventListener("lostpointercapture",o),window.addEventListener("blur",o),document.addEventListener("visibilitychange",o),{get running(){return r&&t()},dispose(){o(),s.removeEventListener("pointerdown",a),window.removeEventListener("pointerup",c),window.removeEventListener("pointercancel",c),s.removeEventListener("lostpointercapture",o),window.removeEventListener("blur",o),document.removeEventListener("visibilitychange",o)}}}function Wd(s,e=1e-4){e=Math.max(e,Number.EPSILON);let t={},n=s.getIndex(),i=s.getAttribute("position"),r=n?n.count:i.count,o=0,a=Object.keys(s.attributes),c={},l={},u=[],h=["getX","getY","getZ","getW"],d=["setX","setY","setZ","setW"];for(let _=0,M=a.length;_<M;_++){let b=a[_],A=s.attributes[b];c[b]=new A.constructor(new A.array.constructor(A.count*A.itemSize),A.itemSize,A.normalized);let E=s.morphAttributes[b];E&&(l[b]||(l[b]=[]),E.forEach((C,v)=>{let w=new C.array.constructor(C.count*C.itemSize);l[b][v]=new C.constructor(w,C.itemSize,C.normalized)}))}let f=e*.5,p=Math.log10(1/e),x=Math.pow(10,p),g=f*x;for(let _=0;_<r;_++){let M=n?n.getX(_):_,b="";for(let A=0,E=a.length;A<E;A++){let C=a[A],v=s.getAttribute(C),w=v.itemSize;for(let H=0;H<w;H++)b+=`${~~(v[h[H]](M)*x+g)},`}if(b in t)u.push(t[b]);else{for(let A=0,E=a.length;A<E;A++){let C=a[A],v=s.getAttribute(C),w=s.morphAttributes[C],H=v.itemSize,P=c[C],O=l[C];for(let z=0;z<H;z++){let G=h[z],B=d[z];if(P[B](o,v[G](M)),w)for(let F=0,k=w.length;F<k;F++)O[F][B](o,w[F][G](M))}}t[b]=o,u.push(o),o++}}let m=s.clone();for(let _ in s.attributes){let M=c[_];if(m.setAttribute(_,new M.constructor(M.array.slice(0,o*M.itemSize),M.itemSize,M.normalized)),_ in l)for(let b=0;b<l[_].length;b++){let A=l[_][b];m.morphAttributes[_][b]=new A.constructor(A.array.slice(0,o*A.itemSize),A.itemSize,A.normalized)}}return m.setIndex(u),m}function ah(s,e){if(e===Ul)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),s;if(e===dr||e===uo){let t=s.getIndex();if(t===null){let o=[],a=s.getAttribute("position");if(a!==void 0){for(let c=0;c<a.count;c++)o.push(c);s.setIndex(o),t=s.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),s}let n=t.count-2,i=[];if(e===dr)for(let o=1;o<=n;o++)i.push(t.getX(0)),i.push(t.getX(o)),i.push(t.getX(o+1));else for(let o=0;o<n;o++)o%2===0?(i.push(t.getX(o)),i.push(t.getX(o+1)),i.push(t.getX(o+2))):(i.push(t.getX(o+2)),i.push(t.getX(o+1)),i.push(t.getX(o)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");let r=s.clone();return r.setIndex(i),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),s}function Xd(s){let e=new Map,t=new Map,n=s.clone();return qd(s,n,function(i,r){e.set(r,i),t.set(i,r)}),n.traverse(function(i){if(!i.isSkinnedMesh)return;let r=i,o=e.get(i),a=o.skeleton.bones;r.skeleton=o.skeleton.clone(),r.bindMatrix.copy(o.bindMatrix),r.skeleton.bones=a.map(function(c){return t.get(c)}),r.bind(r.skeleton,r.bindMatrix)}),n}function qd(s,e,t){t(s,e);for(let n=0;n<s.children.length;n++)qd(s.children[n],e.children[n],t)}var Zi=class extends ti{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new ph(t)}),this.register(function(t){return new mh(t)}),this.register(function(t){return new wh(t)}),this.register(function(t){return new Th(t)}),this.register(function(t){return new Ah(t)}),this.register(function(t){return new xh(t)}),this.register(function(t){return new _h(t)}),this.register(function(t){return new yh(t)}),this.register(function(t){return new vh(t)}),this.register(function(t){return new fh(t)}),this.register(function(t){return new Mh(t)}),this.register(function(t){return new gh(t)}),this.register(function(t){return new Sh(t)}),this.register(function(t){return new bh(t)}),this.register(function(t){return new uh(t)}),this.register(function(t){return new Ac(t,dt.EXT_MESHOPT_COMPRESSION)}),this.register(function(t){return new Ac(t,dt.KHR_MESHOPT_COMPRESSION)}),this.register(function(t){return new Eh(t)})}load(e,t,n,i){let r=this,o;if(this.resourcePath!=="")o=this.resourcePath;else if(this.path!==""){let l=bi.extractUrlBase(e);o=bi.resolveURL(l,this.path)}else o=bi.extractUrlBase(e);this.manager.itemStart(e);let a=function(l){i?i(l):console.error(l),r.manager.itemError(e),r.manager.itemEnd(e)},c=new or(this.manager);c.setPath(this.path),c.setResponseType("arraybuffer"),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(e,function(l){try{r.parse(l,o,function(u){t(u),r.manager.itemEnd(e)},a)}catch(u){a(u)}},n,a)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let r,o={},a={},c=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(c.decode(new Uint8Array(e,0,4))===$d){try{o[dt.KHR_BINARY_GLTF]=new Ch(e)}catch(h){i&&i(h);return}r=JSON.parse(o[dt.KHR_BINARY_GLTF].content)}else r=JSON.parse(c.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}let l=new Uh(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});l.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){let h=this.pluginCallbacks[u](l);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),a[h.name]=h,o[h.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){let h=r.extensionsUsed[u],d=r.extensionsRequired||[];switch(h){case dt.KHR_MATERIALS_UNLIT:o[h]=new dh;break;case dt.KHR_DRACO_MESH_COMPRESSION:o[h]=new Rh(r,this.dracoLoader);break;case dt.KHR_TEXTURE_TRANSFORM:o[h]=new Ih;break;case dt.KHR_MESH_QUANTIZATION:o[h]=new Ph;break;default:d.indexOf(h)>=0&&a[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}l.setExtensions(o),l.setPlugins(a),l.parse(n,i)}parseAsync(e,t){let n=this;return new Promise(function(i,r){n.parse(e,t,i,r)})}};function Kx(){let s={};return{get:function(e){return s[e]},add:function(e,t){s[e]=t},remove:function(e){delete s[e]},removeAll:function(){s={}}}}function Gt(s,e,t){let n=s.json.materials[e];return n.extensions&&n.extensions[t]?n.extensions[t]:null}var dt={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",KHR_MESHOPT_COMPRESSION:"KHR_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"},uh=class{constructor(e){this.parser=e,this.name=dt.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n="light:"+e,i=t.cache.get(n);if(i)return i;let r=t.json,c=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e],l,u=new Be(16777215);c.color!==void 0&&u.setRGB(c.color[0],c.color[1],c.color[2],Qt);let h=c.range!==void 0?c.range:0;switch(c.type){case"directional":l=new Cn(u),l.target.position.set(0,0,-1),l.add(l.target);break;case"point":l=new to(u),l.distance=h;break;case"spot":l=new eo(u),l.distance=h,c.spot=c.spot||{},c.spot.innerConeAngle=c.spot.innerConeAngle!==void 0?c.spot.innerConeAngle:0,c.spot.outerConeAngle=c.spot.outerConeAngle!==void 0?c.spot.outerConeAngle:Math.PI/4,l.angle=c.spot.outerConeAngle,l.penumbra=1-c.spot.innerConeAngle/c.spot.outerConeAngle,l.target.position.set(0,0,-1),l.add(l.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+c.type)}return l.position.set(0,0,0),ci(l,c),c.intensity!==void 0&&(l.intensity=c.intensity),l.name=t.createUniqueName(c.name||"light_"+e),i=Promise.resolve(l),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],a=(r.extensions&&r.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(c){return n._getNodeRef(t.cache,a,c)})}},dh=class{constructor(){this.name=dt.KHR_MATERIALS_UNLIT}getMaterialType(){return on}extendParams(e,t,n){let i=[];e.color=new Be(1,1,1),e.opacity=1;let r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){let o=r.baseColorFactor;e.color.setRGB(o[0],o[1],o[2],Qt),e.opacity=o[3]}r.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",r.baseColorTexture,Ut))}return Promise.all(i)}},fh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},ph=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&i.push(this.parser.assignTexture(t,"clearcoatMap",n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&i.push(this.parser.assignTexture(t,"clearcoatRoughnessMap",n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(i.push(this.parser.assignTexture(t,"clearcoatNormalMap",n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let r=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new $e(r,r)}return Promise.all(i)}},mh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion!==void 0?n.dispersion:0),Promise.resolve()}},gh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&i.push(this.parser.assignTexture(t,"iridescenceMap",n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&i.push(this.parser.assignTexture(t,"iridescenceThicknessMap",n.iridescenceThicknessTexture)),Promise.all(i)}},xh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_SHEEN}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];if(t.sheenColor=new Be(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let r=n.sheenColorFactor;t.sheenColor.setRGB(r[0],r[1],r[2],Qt)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&i.push(this.parser.assignTexture(t,"sheenColorMap",n.sheenColorTexture,Ut)),n.sheenRoughnessTexture!==void 0&&i.push(this.parser.assignTexture(t,"sheenRoughnessMap",n.sheenRoughnessTexture)),Promise.all(i)}},_h=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&i.push(this.parser.assignTexture(t,"transmissionMap",n.transmissionTexture)),Promise.all(i)}},yh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_VOLUME}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];t.thickness=n.thicknessFactor!==void 0?n.thicknessFactor:0,n.thicknessTexture!==void 0&&i.push(this.parser.assignTexture(t,"thicknessMap",n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let r=n.attenuationColor||[1,1,1];return t.attenuationColor=new Be().setRGB(r[0],r[1],r[2],Qt),Promise.all(i)}},vh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_IOR}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);return n===null||(t.ior=n.ior!==void 0?n.ior:1.5),Promise.resolve()}},Mh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];t.specularIntensity=n.specularFactor!==void 0?n.specularFactor:1,n.specularTexture!==void 0&&i.push(this.parser.assignTexture(t,"specularIntensityMap",n.specularTexture));let r=n.specularColorFactor||[1,1,1];return t.specularColor=new Be().setRGB(r[0],r[1],r[2],Qt),n.specularColorTexture!==void 0&&i.push(this.parser.assignTexture(t,"specularColorMap",n.specularColorTexture,Ut)),Promise.all(i)}},bh=class{constructor(e){this.parser=e,this.name=dt.EXT_MATERIALS_BUMP}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return t.bumpScale=n.bumpFactor!==void 0?n.bumpFactor:1,n.bumpTexture!==void 0&&i.push(this.parser.assignTexture(t,"bumpMap",n.bumpTexture)),Promise.all(i)}},Sh=class{constructor(e){this.parser=e,this.name=dt.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Gt(this.parser,e,this.name)!==null?pn:null}extendMaterialParams(e,t){let n=Gt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&i.push(this.parser.assignTexture(t,"anisotropyMap",n.anisotropyTexture)),Promise.all(i)}},wh=class{constructor(e){this.parser=e,this.name=dt.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;let r=i.extensions[this.name],o=t.options.ktx2Loader;if(!o){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,o)}},Th=class{constructor(e){this.parser=e,this.name=dt.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;let o=r.extensions[t],a=i.images[o.source],c=n.textureLoader;if(a.uri){let l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return n.loadTextureImage(e,o.source,c)}},Ah=class{constructor(e){this.parser=e,this.name=dt.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;let o=r.extensions[t],a=i.images[o.source],c=n.textureLoader;if(a.uri){let l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return n.loadTextureImage(e,o.source,c)}},Ac=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let i=n.extensions[this.name],r=this.parser.getDependency("buffer",i.buffer),o=this.parser.options.meshoptDecoder;if(!o||!o.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(a){let c=i.byteOffset||0,l=i.byteLength||0,u=i.count,h=i.byteStride,d=new Uint8Array(a,c,l);return o.decodeGltfBufferAsync?o.decodeGltfBufferAsync(u,h,d,i.mode,i.filter).then(function(f){return f.buffer}):o.ready.then(function(){let f=new ArrayBuffer(u*h);return o.decodeGltfBuffer(new Uint8Array(f),u,h,d,i.mode,i.filter),f})})}else return null}},Eh=class{constructor(e){this.name=dt.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let i=t.meshes[n.mesh];for(let l of i.primitives)if(l.mode!==Rn.TRIANGLES&&l.mode!==Rn.TRIANGLE_STRIP&&l.mode!==Rn.TRIANGLE_FAN&&l.mode!==void 0)return null;let o=n.extensions[this.name].attributes,a=[],c={};for(let l in o)a.push(this.parser.getDependency("accessor",o[l]).then(u=>(c[l]=u,c[l])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(l=>{let u=l.pop(),h=u.isGroup?u.children:[u],d=l[0].count,f=[];for(let p of h){let x=new it,g=new R,m=new Jt,_=new R(1,1,1),M=new us(p.geometry,p.material,d);for(let b=0;b<d;b++)c.TRANSLATION&&g.fromBufferAttribute(c.TRANSLATION,b),c.ROTATION&&m.fromBufferAttribute(c.ROTATION,b),c.SCALE&&_.fromBufferAttribute(c.SCALE,b),M.setMatrixAt(b,x.compose(g,m,_));for(let b in c)if(b==="_COLOR_0"){let A=c[b];M.instanceColor=new Bi(A.array,A.itemSize,A.normalized)}else b!=="TRANSLATION"&&b!=="ROTATION"&&b!=="SCALE"&&p.geometry.setAttribute(b,c[b]);It.prototype.copy.call(M,p),this.parser.assignFinalMaterial(M),f.push(M)}return u.isGroup?(u.clear(),u.add(...f),u):f[0]}))}},$d="glTF",go=12,Yd={JSON:1313821514,BIN:5130562},Ch=class{constructor(e){this.name=dt.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,go),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==$d)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");let i=this.header.length-go,r=new DataView(e,go),o=0;for(;o<i;){let a=r.getUint32(o,!0);o+=4;let c=r.getUint32(o,!0);if(o+=4,c===Yd.JSON){let l=new Uint8Array(e,go+o,a);this.content=n.decode(l)}else if(c===Yd.BIN){let l=go+o;this.body=e.slice(l,l+a)}o+=a}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}},Rh=class{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=dt.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,i=this.dracoLoader,r=e.extensions[this.name].bufferView,o=e.extensions[this.name].attributes,a={},c={},l={};for(let u in o){let h=Dh[u]||u.toLowerCase();a[h]=o[u]}for(let u in e.attributes){let h=Dh[u]||u.toLowerCase();if(o[u]!==void 0){let d=n.accessors[e.attributes[u]],f=gr[d.componentType];l[h]=f.name,c[h]=d.normalized===!0}}return t.getDependency("bufferView",r).then(function(u){return new Promise(function(h,d){i.decodeDracoFile(u,function(f){for(let p in f.attributes){let x=f.attributes[p],g=c[p];g!==void 0&&(x.normalized=g)}h(f)},a,l,Qt,d)})})}},Ih=class{constructor(){this.name=dt.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}},Ph=class{constructor(){this.name=dt.KHR_MESH_QUANTIZATION}},Ec=class extends $n{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,r=e*i*3+i;for(let o=0;o!==i;o++)t[o]=n[r+o];return t}interpolate_(e,t,n,i){let r=this.resultBuffer,o=this.sampleValues,a=this.valueSize,c=a*2,l=a*3,u=i-t,h=(n-t)/u,d=h*h,f=d*h,p=e*l,x=p-l,g=-2*f+3*d,m=f-d,_=1-g,M=m-d+h;for(let b=0;b!==a;b++){let A=o[x+b+a],E=o[x+b+c]*u,C=o[p+b+a],v=o[p+b]*u;r[b]=_*A+M*E+g*C+m*v}return r}},Jx=new Jt,Lh=class extends Ec{interpolate_(e,t,n,i){let r=super.interpolate_(e,t,n,i);return Jx.fromArray(r).normalize().toArray(r),r}},Rn={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},gr={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Zd={9728:zt,9729:kt,9984:Ra,9985:lr,9986:xs,9987:Vn},Kd={33071:En,33648:Xs,10497:Ui},ch={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Dh={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Yi={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},$x={CUBICSPLINE:void 0,LINEAR:cs,STEP:as},lh={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function jx(s){return s.DefaultMaterial===void 0&&(s.DefaultMaterial=new Ot({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:Bn})),s.DefaultMaterial}function Ss(s,e,t){for(let n in t.extensions)s[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function ci(s,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(s.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function Qx(s,e,t){let n=!1,i=!1,r=!1;for(let l=0,u=e.length;l<u;l++){let h=e[l];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(i=!0),h.COLOR_0!==void 0&&(r=!0),n&&i&&r)break}if(!n&&!i&&!r)return Promise.resolve(s);let o=[],a=[],c=[];for(let l=0,u=e.length;l<u;l++){let h=e[l];if(n){let d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):s.attributes.position;o.push(d)}if(i){let d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):s.attributes.normal;a.push(d)}if(r){let d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):s.attributes.color;c.push(d)}}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c)]).then(function(l){let u=l[0],h=l[1],d=l[2];return n&&(s.morphAttributes.position=u),i&&(s.morphAttributes.normal=h),r&&(s.morphAttributes.color=d),s.morphTargetsRelative=!0,s})}function e_(s,e){if(s.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)s.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){let t=e.extras.targetNames;if(s.morphTargetInfluences.length===t.length){s.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)s.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function t_(s){let e,t=s.extensions&&s.extensions[dt.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+hh(t.attributes):e=s.indices+":"+hh(s.attributes)+":"+s.mode,s.targets!==void 0)for(let n=0,i=s.targets.length;n<i;n++)e+=":"+hh(s.targets[n]);return e}function hh(s){let e="",t=Object.keys(s).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+s[t[n]]+";";return e}function Nh(s){switch(s){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function n_(s){return s.search(/\.jpe?g($|\?)/i)>0||s.search(/^data\:image\/jpeg/)===0?"image/jpeg":s.search(/\.webp($|\?)/i)>0||s.search(/^data\:image\/webp/)===0?"image/webp":s.search(/\.ktx2($|\?)/i)>0||s.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}var i_=new it,Uh=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Kx,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=-1,r=!1,o=-1;if(typeof navigator<"u"&&typeof navigator.userAgent<"u"){let a=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(a)===!0;let c=a.match(/Version\/(\d+)/);i=n&&c?parseInt(c[1],10):-1,r=a.indexOf("Firefox")>-1,o=r?a.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&i<17||r&&o<98?this.textureLoader=new $r(this.options.manager):this.textureLoader=new no(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new or(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,i=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(o){return o._markDefs&&o._markDefs()}),Promise.all(this._invokeAll(function(o){return o.beforeRoot&&o.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(o){let a={scene:o[0][i.scene||0],scenes:o[0],animations:o[1],cameras:o[2],asset:i.asset,parser:n,userData:{}};return Ss(r,a,i),ci(a,i),Promise.all(n._invokeAll(function(c){return c.afterRoot&&c.afterRoot(a)})).then(function(){for(let c of a.scenes)c.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,r=t.length;i<r;i++){let o=t[i].joints;for(let a=0,c=o.length;a<c;a++)e[o[a]].isBone=!0}for(let i=0,r=e.length;i<r;i++){let o=e[i];o.mesh!==void 0&&(this._addNodeRef(this.meshCache,o.mesh),o.skin!==void 0&&(n[o.mesh].isSkinnedMesh=!0)),o.camera!==void 0&&this._addNodeRef(this.cameraCache,o.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let i=n.clone(),r=(o,a)=>{let c=this.associations.get(o);c!=null&&this.associations.set(a,c);for(let[l,u]of o.children.entries())r(u,a.children[l])};return r(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let i=e(t[n]);if(i)return i}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let i=0;i<t.length;i++){let r=e(t[i]);r&&n.push(r)}return n}getDependency(e,t){let n=e+":"+t,i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":i=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e);break}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(r,o){return n.getDependency(e,o)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[dt.KHR_BINARY_GLTF].body);let i=this.options;return new Promise(function(r,o){n.load(bi.resolveURL(t.uri,i.path),r,void 0,function(){o(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){let i=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+i)})}loadAccessor(e){let t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){let o=ch[i.type],a=gr[i.componentType],c=i.normalized===!0,l=new a(i.count*o);return Promise.resolve(new Wt(l,o,c))}let r=[];return i.bufferView!==void 0?r.push(this.getDependency("bufferView",i.bufferView)):r.push(null),i.sparse!==void 0&&(r.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(r).then(function(o){let a=o[0],c=ch[i.type],l=gr[i.componentType],u=l.BYTES_PER_ELEMENT,h=u*c,d=i.byteOffset||0,f=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,p=i.normalized===!0,x,g;if(f&&f!==h){let m=Math.floor(d/f),_="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+m+":"+i.count,M=t.cache.get(_);M||(x=new l(a,m*f,i.count*f/u),M=new hs(x,f/u),t.cache.add(_,M)),g=new Fi(M,c,d%f/u,p)}else a===null?x=new l(i.count*c):x=new l(a,d,i.count*c),g=new Wt(x,c,p);if(i.sparse!==void 0){let m=ch.SCALAR,_=gr[i.sparse.indices.componentType],M=i.sparse.indices.byteOffset||0,b=i.sparse.values.byteOffset||0,A=new _(o[1],M,i.sparse.count*m),E=new l(o[2],b,i.sparse.count*c);a!==null&&(g=new Wt(g.array.slice(),g.itemSize,g.normalized)),g.normalized=!1;for(let C=0,v=A.length;C<v;C++){let w=A[C];if(g.setX(w,E[C*c]),c>=2&&g.setY(w,E[C*c+1]),c>=3&&g.setZ(w,E[C*c+2]),c>=4&&g.setW(w,E[C*c+3]),c>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}g.normalized=p}return g})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,o=t.images[r],a=this.textureLoader;if(o.uri){let c=n.manager.getHandler(o.uri);c!==null&&(a=c)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let i=this,r=this.json,o=r.textures[e],a=r.images[t],c=(a.uri||a.bufferView)+":"+o.sampler;if(this.textureCache[c])return this.textureCache[c];let l=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=o.name||a.name||"",u.name===""&&typeof a.uri=="string"&&a.uri.startsWith("data:image/")===!1&&(u.name=a.uri);let d=(r.samplers||{})[o.sampler]||{};return u.magFilter=Zd[d.magFilter]||kt,u.minFilter=Zd[d.minFilter]||Vn,u.wrapS=Kd[d.wrapS]||Ui,u.wrapT=Kd[d.wrapT]||Ui,u.generateMipmaps=!u.isCompressedTexture&&u.minFilter!==zt&&u.minFilter!==kt,i.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[c]=l,l}loadImageSource(e,t){let n=this,i=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());let o=i.images[e],a=self.URL||self.webkitURL,c=o.uri||"",l=!1;if(o.bufferView!==void 0)c=n.getDependency("bufferView",o.bufferView).then(function(h){l=!0;let d=new Blob([h],{type:o.mimeType});return c=a.createObjectURL(d),c});else if(o.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");let u=Promise.resolve(c).then(function(h){return new Promise(function(d,f){let p=d;t.isImageBitmapLoader===!0&&(p=function(x){let g=new Xt(x);g.needsUpdate=!0,d(g)}),t.load(bi.resolveURL(h,r.path),p,void 0,f)})}).then(function(h){return l===!0&&a.revokeObjectURL(c),ci(h,o),h.userData.mimeType=o.mimeType||n_(o.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",c),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,i){let r=this;return this.getDependency("texture",n.index).then(function(o){if(!o)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(o=o.clone(),o.channel=n.texCoord),r.extensions[dt.KHR_TEXTURE_TRANSFORM]){let a=n.extensions!==void 0?n.extensions[dt.KHR_TEXTURE_TRANSFORM]:void 0;if(a){let c=r.associations.get(o);o=r.extensions[dt.KHR_TEXTURE_TRANSFORM].extendTexture(o,a),r.associations.set(o,c)}}return i!==void 0&&(o.colorSpace=i),e[t]=o,o})}assignFinalMaterial(e){let t=e.geometry,n=e.material,i=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,o=t.attributes.normal===void 0;if(e.isPoints){let a="PointsMaterial:"+n.uuid,c=this.cache.get(a);c||(c=new ir,ln.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,c.sizeAttenuation=!1,this.cache.add(a,c)),n=c}else if(e.isLine){let a="LineBasicMaterial:"+n.uuid,c=this.cache.get(a);c||(c=new _i,ln.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,this.cache.add(a,c)),n=c}if(i||r||o){let a="ClonedMaterial:"+n.uuid+":";i&&(a+="derivative-tangents:"),r&&(a+="vertex-colors:"),o&&(a+="flat-shading:");let c=this.cache.get(a);c||(c=n.clone(),r&&(c.vertexColors=!0),o&&(c.flatShading=!0),i&&(c.normalScale&&(c.normalScale.y*=-1),c.clearcoatNormalScale&&(c.clearcoatNormalScale.y*=-1)),this.cache.add(a,c),this.associations.set(c,this.associations.get(n))),n=c}e.material=n}getMaterialType(){return Ot}loadMaterial(e){let t=this,n=this.json,i=this.extensions,r=n.materials[e],o,a={},c=r.extensions||{},l=[];if(c[dt.KHR_MATERIALS_UNLIT]){let h=i[dt.KHR_MATERIALS_UNLIT];o=h.getMaterialType(),l.push(h.extendParams(a,r,t))}else{let h=r.pbrMetallicRoughness||{};if(a.color=new Be(1,1,1),a.opacity=1,Array.isArray(h.baseColorFactor)){let d=h.baseColorFactor;a.color.setRGB(d[0],d[1],d[2],Qt),a.opacity=d[3]}h.baseColorTexture!==void 0&&l.push(t.assignTexture(a,"map",h.baseColorTexture,Ut)),a.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,a.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(l.push(t.assignTexture(a,"metalnessMap",h.metallicRoughnessTexture)),l.push(t.assignTexture(a,"roughnessMap",h.metallicRoughnessTexture))),o=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),l.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,a)})))}r.doubleSided===!0&&(a.side=en);let u=r.alphaMode||lh.OPAQUE;if(u===lh.BLEND?(a.transparent=!0,a.depthWrite=!1):(a.transparent=!1,u===lh.MASK&&(a.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&o!==on&&(l.push(t.assignTexture(a,"normalMap",r.normalTexture)),a.normalScale=new $e(1,1),r.normalTexture.scale!==void 0)){let h=r.normalTexture.scale;a.normalScale.set(h,h)}if(r.occlusionTexture!==void 0&&o!==on&&(l.push(t.assignTexture(a,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(a.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&o!==on){let h=r.emissiveFactor;a.emissive=new Be().setRGB(h[0],h[1],h[2],Qt)}return r.emissiveTexture!==void 0&&o!==on&&l.push(t.assignTexture(a,"emissiveMap",r.emissiveTexture,Ut)),Promise.all(l).then(function(){let h=new o(a);return r.name&&(h.name=r.name),ci(h,r),t.associations.set(h,{materials:e}),r.extensions&&Ss(i,h,r),h})}createUniqueName(e){let t=Et.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,i=this.primitiveCache;function r(a){return n[dt.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(a,t).then(function(c){return Jd(c,a,t)})}let o=[];for(let a=0,c=e.length;a<c;a++){let l=e[a],u=t_(l),h=i[u];if(h)o.push(h.promise);else{let d;l.extensions&&l.extensions[dt.KHR_DRACO_MESH_COMPRESSION]?d=r(l):d=Jd(new Dt,l,t),i[u]={primitive:l,promise:d},o.push(d)}}return Promise.all(o)}loadMesh(e){let t=this,n=this.json,i=this.extensions,r=n.meshes[e],o=r.primitives,a=[];for(let c=0,l=o.length;c<l;c++){let u=o[c].material===void 0?jx(this.cache):this.getDependency("material",o[c].material);a.push(u)}return a.push(t.loadGeometries(o)),Promise.all(a).then(function(c){let l=c.slice(0,c.length-1),u=c[c.length-1],h=[];for(let f=0,p=u.length;f<p;f++){let x=u[f],g=o[f],m,_=l[f];if(g.mode===Rn.TRIANGLES||g.mode===Rn.TRIANGLE_STRIP||g.mode===Rn.TRIANGLE_FAN||g.mode===void 0)m=r.isSkinnedMesh===!0?new zr(x,_):new mt(x,_),m.isSkinnedMesh===!0&&m.normalizeSkinWeights(),g.mode===Rn.TRIANGLE_STRIP?m.geometry=ah(m.geometry,uo):g.mode===Rn.TRIANGLE_FAN&&(m.geometry=ah(m.geometry,dr));else if(g.mode===Rn.LINES)m=new nr(x,_);else if(g.mode===Rn.LINE_STRIP)m=new yi(x,_);else if(g.mode===Rn.LINE_LOOP)m=new Vr(x,_);else if(g.mode===Rn.POINTS)m=new Gr(x,_);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+g.mode);Object.keys(m.geometry.morphAttributes).length>0&&e_(m,r),m.name=t.createUniqueName(r.name||"mesh_"+e),ci(m,r),g.extensions&&Ss(i,m,g),t.assignFinalMaterial(m),h.push(m)}for(let f=0,p=h.length;f<p;f++)t.associations.set(h[f],{meshes:e,primitives:f});if(h.length===1)return r.extensions&&Ss(i,h[0],r),h[0];let d=new Mt;r.extensions&&Ss(i,d,r),t.associations.set(d,{meshes:e});for(let f=0,p=h.length;f<p;f++)d.add(h[f]);return d})}loadCamera(e){let t,n=this.json.cameras[e],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Nt(zl.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new Gi(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),ci(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let i=0,r=t.joints.length;i<r;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){let r=i.pop(),o=i,a=[],c=[];for(let l=0,u=o.length;l<u;l++){let h=o[l];if(h){a.push(h);let d=new it;r!==null&&d.fromArray(r.array,l*16),c.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[l])}return new kr(a,c)})}loadAnimation(e){let t=this.json,n=this,i=t.animations[e],r=i.name?i.name:"animation_"+e,o=[],a=[],c=[],l=[],u=[];for(let h=0,d=i.channels.length;h<d;h++){let f=i.channels[h],p=i.samplers[f.sampler],x=f.target,g=x.node,m=i.parameters!==void 0?i.parameters[p.input]:p.input,_=i.parameters!==void 0?i.parameters[p.output]:p.output;x.node!==void 0&&(o.push(this.getDependency("node",g)),a.push(this.getDependency("accessor",m)),c.push(this.getDependency("accessor",_)),l.push(p),u.push(x))}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c),Promise.all(l),Promise.all(u)]).then(function(h){let d=h[0],f=h[1],p=h[2],x=h[3],g=h[4],m=[];for(let M=0,b=d.length;M<b;M++){let A=d[M],E=f[M],C=p[M],v=x[M],w=g[M];if(A===void 0)continue;A.updateMatrix&&A.updateMatrix();let H=n._createAnimationTracks(A,E,C,v,w);if(H)for(let P=0;P<H.length;P++)m.push(H[P])}let _=new fs(r,void 0,m);return ci(_,i),_})}createNodeMesh(e){let t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(r){let o=n._getNodeRef(n.meshCache,i.mesh,r);return i.weights!==void 0&&o.traverse(function(a){if(a.isMesh)for(let c=0,l=i.weights.length;c<l;c++)a.morphTargetInfluences[c]=i.weights[c]}),o})}loadNode(e){let t=this.json,n=this,i=t.nodes[e],r=n._loadNodeShallow(e),o=[],a=i.children||[];for(let l=0,u=a.length;l<u;l++)o.push(n.getDependency("node",a[l]));let c=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([r,Promise.all(o),c]).then(function(l){let u=l[0],h=l[1],d=l[2];d!==null&&u.traverse(function(f){f.isSkinnedMesh&&f.bind(d,i_)});for(let f=0,p=h.length;f<p;f++)u.add(h[f]);if(u.userData.pivot!==void 0&&h.length>0){let f=u.userData.pivot,p=h[0];u.pivot=new R().fromArray(f),u.position.x-=f[0],u.position.y-=f[1],u.position.z-=f[2],p.position.set(0,0,0),delete u.userData.pivot}return u})}_loadNodeShallow(e){let t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let r=t.nodes[e],o=r.name?i.createUniqueName(r.name):"",a=[],c=i._invokeOne(function(l){return l.createNodeMesh&&l.createNodeMesh(e)});return c&&a.push(c),r.camera!==void 0&&a.push(i.getDependency("camera",r.camera).then(function(l){return i._getNodeRef(i.cameraCache,r.camera,l)})),i._invokeAll(function(l){return l.createNodeAttachment&&l.createNodeAttachment(e)}).forEach(function(l){a.push(l)}),this.nodeCache[e]=Promise.all(a).then(function(l){let u;if(r.isBone===!0?u=new Qs:l.length>1?u=new Mt:l.length===1?u=l[0]:u=new It,u!==l[0])for(let h=0,d=l.length;h<d;h++)u.add(l[h]);if(r.name&&(u.userData.name=r.name,u.name=o),ci(u,r),r.extensions&&Ss(n,u,r),r.matrix!==void 0){let h=new it;h.fromArray(r.matrix),u.applyMatrix4(h)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);if(!i.associations.has(u))i.associations.set(u,{});else if(r.mesh!==void 0&&i.meshCache.refs[r.mesh]>1){let h=i.associations.get(u);i.associations.set(u,{...h})}return i.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],i=this,r=new Mt;n.name&&(r.name=i.createUniqueName(n.name)),ci(r,n),n.extensions&&Ss(t,r,n);let o=n.nodes||[],a=[];for(let c=0,l=o.length;c<l;c++)a.push(i.getDependency("node",o[c]));return Promise.all(a).then(function(c){for(let u=0,h=c.length;u<h;u++){let d=c[u];d.parent!==null?r.add(Xd(d)):r.add(d)}let l=u=>{let h=new Map;for(let[d,f]of i.associations)(d instanceof ln||d instanceof Xt)&&h.set(d,f);return u.traverse(d=>{let f=i.associations.get(d);f!=null&&h.set(d,f)}),h};return i.associations=l(r),r})}_createAnimationTracks(e,t,n,i,r){let o=[],a=e.name?e.name:e.uuid,c=[];Yi[r.path]===Yi.weights?e.traverse(function(d){d.morphTargetInfluences&&c.push(d.name?d.name:d.uuid)}):c.push(a);let l;switch(Yi[r.path]){case Yi.weights:l=jn;break;case Yi.rotation:l=Qn;break;case Yi.translation:case Yi.scale:l=ei;break;default:n.itemSize===1?l=jn:l=ei;break}let u=i.interpolation!==void 0?$x[i.interpolation]:cs,h=this._getArrayFromAccessor(n);for(let d=0,f=c.length;d<f;d++){let p=new l(c[d]+"."+Yi[r.path],t.array,h,u);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(p),o.push(p)}return o}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let n=Nh(t.constructor),i=new Float32Array(t.length);for(let r=0,o=t.length;r<o;r++)i[r]=t[r]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){let i=this instanceof Qn?Lh:Ec;return new i(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function s_(s,e,t){let n=e.attributes,i=new Vt;if(n.POSITION!==void 0){let a=t.json.accessors[n.POSITION],c=a.min,l=a.max;if(c!==void 0&&l!==void 0){if(i.set(new R(c[0],c[1],c[2]),new R(l[0],l[1],l[2])),a.normalized){let u=Nh(gr[a.componentType]);i.min.multiplyScalar(u),i.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;let r=e.targets;if(r!==void 0){let a=new R,c=new R;for(let l=0,u=r.length;l<u;l++){let h=r[l];if(h.POSITION!==void 0){let d=t.json.accessors[h.POSITION],f=d.min,p=d.max;if(f!==void 0&&p!==void 0){if(c.setX(Math.max(Math.abs(f[0]),Math.abs(p[0]))),c.setY(Math.max(Math.abs(f[1]),Math.abs(p[1]))),c.setZ(Math.max(Math.abs(f[2]),Math.abs(p[2]))),d.normalized){let x=Nh(gr[d.componentType]);c.multiplyScalar(x)}a.max(c)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(a)}s.boundingBox=i;let o=new dn;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,s.boundingSphere=o}function Jd(s,e,t){let n=e.attributes,i=[];function r(o,a){return t.getDependency("accessor",o).then(function(c){s.setAttribute(a,c)})}for(let o in n){let a=Dh[o]||o.toLowerCase();a in s.attributes||i.push(r(n[o],a))}if(e.indices!==void 0&&!s.index){let o=t.getDependency("accessor",e.indices).then(function(a){s.setIndex(a)});i.push(o)}return pt.workingColorSpace!==Qt&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${pt.workingColorSpace}" not supported.`),ci(s,e),s_(s,e,t),Promise.all(i).then(function(){return e.targets!==void 0?Qx(s,e.targets,t):s})}function Ki(s,e,t=()=>!0){let n=null,i=null,r={},o=!1,a=null,c=null,l=e.species==="cat"?"cat":e.breed||"corgi",u=window.KittyPetModels?.[l];return u&&new Zi().parse(JSON.stringify(u),"",h=>{if(!t())return;let d=h.scene;d.updateMatrixWorld(!0);let f=new Vt().setFromObject(d),p=f.getSize(new R),x=f.getCenter(new R),g=new Mt,m=(e.species==="dog"?2.15:2.35)/p.y;d.scale.setScalar(m),d.position.set(-x.x*m,-f.min.y*m,-x.z*m),g.add(d),d.traverse(M=>{M.isMesh&&(M.castShadow=!0,M.receiveShadow=!0,["shiba","husky","fox"].includes(l)&&(M.geometry.deleteAttribute("normal"),M.geometry=Wd(M.geometry),M.geometry.computeVertexNormals()))}),s.children.forEach(M=>M.visible=!1),s.add(g);let _=new mt(new Jn(.25,.055,8,32),new Ot({color:e.outfit==="rain"?"#e9bb4c":e.outfit==="princess"?"#e59fb5":"#5baca0"}));if(_.rotation.x=Math.PI/2,_.position.set(0,.95,.35),e.breed!=="walker"&&g.add(_),a=d.getObjectByName("Head"),c=a?.scale.clone(),n=new io(d),["corgi","duck"].includes(l)&&h.animations.length===1&&h.animations[0].name==="clip"){let M=h.animations[0];h.animations=[ds.subclip(M,"Idle",0,30,24),ds.subclip(M,"Walk",90,120,24),ds.subclip(M,"Run",90,120,24)]}h.animations.filter(M=>["Idle","Walk","Run","Gallop"].includes(M.name)).forEach(M=>r[M.name]=n.clipAction(M)),o=!0,s.userData.assetReady=!0,s.userData.clips=Object.keys(r)},h=>{s.userData.assetError=!0,console.warn("Pet model unavailable",h)}),{update(h,d,f=!1){if(!o)return;let p=r[d?f?"Gallop":"Walk":"Idle"]||r[d?"Run":"Idle"]||r.Idle;p&&p!==i&&(i?.fadeOut(.2),p.reset().fadeIn(.2).play(),i=p),n.update(h),a&&c&&a.scale.copy(c).multiplyScalar(l==="walker"?.72:["corgi","duck"].includes(l)?1:l==="fox"?1.08:e.species==="dog"?1.18:1.5)},get ready(){return o}}}var xo=new R;function In(s,e,t,n,i,r){let o=2*Math.PI*i/4,a=Math.max(r-2*i,0),c=Math.PI/4;xo.copy(e),xo[n]=0,xo.normalize();let l=.5*o/(o+a),u=1-xo.angleTo(s)/c;return Math.sign(xo[t])===1?u*l:a/(o+a)+l+l*(1-u)}var xr=class s extends fn{constructor(e=1,t=1,n=1,i=2,r=.1){let o=i*2+1;if(r=Math.min(e/2,t/2,n/2,r),super(1,1,1,o,o,o),this.type="RoundedBoxGeometry",this.parameters={width:e,height:t,depth:n,segments:i,radius:r},o===1)return;let a=this.toNonIndexed();this.index=null,this.attributes.position=a.attributes.position,this.attributes.normal=a.attributes.normal,this.attributes.uv=a.attributes.uv;let c=new R,l=new R,u=new R(e,t,n).divideScalar(2).subScalar(r),h=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=h.length/6,x=new R,g=.5/o;for(let m=0,_=0;m<h.length;m+=3,_+=2)switch(c.fromArray(h,m),l.copy(c),l.x-=Math.sign(l.x)*g,l.y-=Math.sign(l.y)*g,l.z-=Math.sign(l.z)*g,l.normalize(),h[m+0]=u.x*Math.sign(c.x)+l.x*r,h[m+1]=u.y*Math.sign(c.y)+l.y*r,h[m+2]=u.z*Math.sign(c.z)+l.z*r,d[m+0]=l.x,d[m+1]=l.y,d[m+2]=l.z,Math.floor(m/p)){case 0:x.set(1,0,0),f[_+0]=In(x,l,"z","y",r,n),f[_+1]=1-In(x,l,"y","z",r,t);break;case 1:x.set(-1,0,0),f[_+0]=1-In(x,l,"z","y",r,n),f[_+1]=1-In(x,l,"y","z",r,t);break;case 2:x.set(0,1,0),f[_+0]=1-In(x,l,"x","z",r,e),f[_+1]=In(x,l,"z","x",r,n);break;case 3:x.set(0,-1,0),f[_+0]=1-In(x,l,"x","z",r,e),f[_+1]=1-In(x,l,"z","x",r,n);break;case 4:x.set(0,0,1),f[_+0]=1-In(x,l,"x","y",r,e),f[_+1]=1-In(x,l,"y","x",r,t);break;case 5:x.set(0,0,-1),f[_+0]=In(x,l,"x","y",r,e),f[_+1]=1-In(x,l,"y","x",r,t);break}}static fromJSON(e){return new s(e.width,e.height,e.depth,e.segments,e.radius)}};var Fh=new Map;function _t(s,e,{width:t=1,x:n=0,y:i=0,z:r=0,rotation:o=0,alive:a=()=>!0,onReady:c=()=>{}}={}){let l=e;for(;l.parent;)l=l.parent;let u=l.isScene?l.scale.x:1,h=new Mt;h.position.set(n,i,r),h.rotation.y=o,e.add(h);let d=window.KittyWorldModels?.[s];return d&&(Fh.has(s)||Fh.set(s,new Promise((f,p)=>new Zi().parse(JSON.stringify(d),"",x=>f(x.scene),p))),Fh.get(s).then(f=>{if(!a())return;let p=f.clone(!0);p.updateMatrixWorld(!0);let x=new Vt().setFromObject(p),g=x.getSize(new R),m=x.getCenter(new R),_=t/Math.max(g.x,g.z);p.scale.set(_/u,_,_/u),p.position.set(-m.x*_/u,-x.min.y*_,-m.z*_/u),p.traverse(M=>{M.isMesh&&(M.geometry=M.geometry.clone(),M.material=Array.isArray(M.material)?M.material.map(b=>b.clone()):M.material.clone(),[].concat(M.material).forEach(b=>{b.metalness=0,b.roughness=.85}),M.castShadow=M.receiveShadow=!0)}),h.add(p),h.userData.asset=s,h.userData.dimensions=[g.x*_,g.z*_],c(h)}).catch(()=>{h.userData.assetError=!0})),h}function jd(s,e,t){let n=[],r={cafe:"#94b4a0",hotel:"#4d8279",clinic:"#a6cdd5",school:"#ecc582",library:"#8ca387",shop:"#d5a194",airport:"#9eb8ce"}[e]||"#8dae88",o=["park","forest"].includes(e);function a(f,p,x,g,m,_,M){let b=new mt(new xr(f,p,x,2,Math.min(.035,f/10,p/10,x/10)),new Ot({color:g,roughness:.9}));return b.position.set(m,_,M),b.castShadow=b.receiveShadow=!0,s.add(b),b}function c(f,p,x,g,{y:m=0,r:_=0,action:M,solid:b=!0}={}){let A=_t(f,s,{width:p,x,z:g,y:m,rotation:_,alive:t,onReady:E=>E.traverse(C=>{if(C.isMesh)for(let v of[].concat(C.material))v.name==="wood"&&v.color.set("#b9814e"),v.name==="plant"&&v.color.set("#57916c"),v.name==="carpet"&&v.color.set({clinic:"#92bccc",library:"#86a68a",hotel:"#c5a887",school:"#dbb163"}[e]||"#d08c7c")})});return M!==void 0&&(A.userData.action=M),b&&m===0&&!f.startsWith("rug")&&n.push({x,z:g,w:p*.85/qe,d:p*.65/qe}),A}function l(f,p){c("tableRound",1.5,f,p,{action:0}),c("chairCushion",.7,f-.95/qe,p,{r:Math.PI/2}),c("chairCushion",.7,f+.95/qe,p,{r:-Math.PI/2}),c("mug",.2,f-.25/qe,p,{y:.83}),c("croissant",.3,f+.25/qe,p,{y:.82}),c("plantSmall1",.27,f,p-.2/qe,{y:.83})}function u(f,p,x=1.7,g=0){c("bookcaseClosedWide",x,f,p,{r:g,action:0}),c("books",x*.66,f,p,{y:.65,r:g}),c("plantSmall2",.45,f,p,{y:1.8})}function h(){a(3,1.05,.75,r,0,.52,-2.55),a(3.12,.12,.87,"#f0dfbd",0,1.1,-2.55),n.push({x:0,z:-2.55,w:3.1,d:.9});for(let f of[-1,0,1])a(.85,.65,.035,"#e1d1ae",f,.55,-2.15);c("computerScreen",.5,.75,-2.55,{y:1.17,action:2}),c("plantSmall1",.35,-1.1,-2.55,{y:1.17})}let d=a(12,.16,10,o?"#a7c98b":"#cfaa77",0,-.1,0);if(d.userData.ground=!0,o){a(2.6,.025,9,"#e0cca0",0,0,0);for(let f of[-5,5])for(let p of[-4,-.5,3.5])c(e==="forest"?"tree_pineSmallA":"tree_oak",2.3,f,p),c("flower_yellowA",.6,f*.85,p,{solid:!1});for(let f of[-4,-2,0,2,4])c("fence-low",1.9,f,-4.6,{solid:!1});return c("bench",1.8,-3,0,{r:Math.PI/2,action:1}),c("tent_smallOpen",2.1,3,-3),c("table",1.5,3,1,{action:1}),c("apple",.25,3,1,{y:.85}),c("bear",.5,-3,2.5,{action:0}),c("planter",1.2,3,3.5,{action:2}),n}a(12,3.8,.13,"#f0e6d3",0,1.82,-5),a(.13,3.8,10,"#f0e6d3",-6,1.82,0),a(12,1.1,.07,r,0,.55,-4.9),a(.07,1.1,10,r,-5.9,.55,0),a(12,.08,.1,"#e5cfac",0,1.13,-4.85);for(let f=-4.6;f<5;f+=.5)a(11.9,.009,.015,"#b89060",0,-.006,f);for(let f of[-2,1.7]){a(.08,1.8,2.7,"#e8ce9e",-5.86,2.2,f);let p=a(.08,1.58,2.45,"#b7e0e7",-5.78,2.2,f);p.material.emissive.set("#b8dfe0"),p.material.emissiveIntensity=.15,a(.12,.07,2.5,"#fff7e5",-5.7,2.2,f),a(.12,1.6,.07,"#fff7e5",-5.7,2.2,f)}for(let f of[-3.7,3.7])a(4.4,.55,.15,r,f,.22,4.9);c("rugRectangle",1.8,0,4.1,{solid:!1});for(let f of[-5.25,5.15])c("pottedPlant",.75,f,3.9);c("coatRackStanding",.7,-5.2,-4.3);for(let f of[-3,3]){a(.04,.65,.04,"#a8814d",f,3.5,-1.7);let p=a(.42,.38,.42,"#ffe1aa",f,3,-1.7);p.material.emissive.set("#ffd89a"),p.material.emissiveIntensity=.5}if(h(),e==="cafe"){for(let f of[-2.5,0,2.5])c("kitchenCabinetDrawer",2,f,-4.35);c("kitchenCoffeeMachine",.6,-1,-4.35,{y:.95}),c("toaster",.5,1,-4.35,{y:.95}),c("kitchenFridgeLarge",1,4.8,-4.1),c("kitchenSink",1.3,-4.2,-4.25),l(-3.8,-.4),l(-3.8,2.5),l(3.8,1.7),c("kitchenCabinet",1.2,3.8,-1.3,{action:0});for(let f of[3.5,3.9,4.2])c("croissant",.28,f,-1.3,{y:1})}else if(e==="hotel"){c("rugRounded",3.6,-3.7,1.6,{solid:!1}),c("loungeSofaLong",2.4,-4.9,.9,{r:Math.PI/2}),c("loungeChairRelax",1.2,-3.2,3),c("tableCoffeeGlass",1.5,-3.4,1.35),c("plantSmall1",.35,-3.4,1.35,{y:.55}),a(2.1,3.15,.08,"#826348",3.9,1.5,-4.84),a(1.8,2.9,.06,"#bc9f70",3.9,1.4,-4.77),a(.06,2.8,.08,"#e6cd93",3.9,1.4,-4.7),a(3,1.6,.18,"#846241",-.6,2.65,-4.78);for(let f=-2.05;f<1;f+=.6)a(.05,1.6,.22,"#dfba78",f,2.65,-4.64);for(let f of[1.85,2.4,2.95,3.45])a(3,.055,.22,"#dfba78",-.6,f,-4.64);c("cabinetBedDrawer",1.1,4.7,1.5),c("lampRoundFloor",.55,4.9,3),c("lampRoundTable",.45,-.8,-2.55,{y:1.17})}else if(e==="clinic"){for(let f of[-1.8,0,1.8])c("chairModernCushion",.9,-4.8,f,{r:Math.PI/2});c("tableCoffee",1,-4.8,3.2),c("books",.5,-4.8,3.2,{y:.6}),a(.12,1.1,4.7,"#c9dfe0",1.95,.55,-.7),n.push({x:1.95,z:-.7,w:.2,d:4.7}),c("bedSingle",2.3,3.8,-.2,{r:Math.PI/2,action:0}),c("bathroomSink",1.1,4.7,-4.1),c("cabinetBedDrawer",1.2,3.2,-4.1),c("stoolBar",.6,3.8,1.9)}else if(e==="school"){for(let f of[-3.9,3.9])c("bookcaseOpenLow",2.2,f,3.8),c("bear",.4,f,3.8,{y:.7});c("tableRound",2.2,-3.6,-.1,{action:2});for(let f of[-1.35,1.2])c("chairRounded",.75,-3.6,f,{r:f<0?0:Math.PI});c("books",.5,-3.6,-.1,{y:.8}),c("rugRound",3,3.6,.2,{solid:!1}),c("bear",.9,4.5,-.8),c("pillowBlue",.7,3,.7,{solid:!1}),c("pillowLong",.8,4.3,1.2,{solid:!1}),u(3.8,-4.15,2)}else if(e==="library"){for(let f of[-3.8,-1.8,.2,2.2,4.2])u(f,-4.3,1.75);for(let f of[-.5,2])c("desk",1.4,-4.7,f,{action:2}),c("chairRounded",.7,-3.8,f,{r:-Math.PI/2}),c("books",.45,-4.7,f,{y:.85});c("rugRounded",3.1,3.5,1,{solid:!1}),c("loungeChairRelax",1.1,4.5,0,{r:-Math.PI/2}),c("loungeChairRelax",1.1,3.3,2.3,{r:Math.PI}),c("tableCoffee",1.2,3.3,.7),c("books",.5,3.3,.7,{y:.6})}else if(e==="shop"){for(let f of[-4.8,4.8])for(let p of[-3,-.6,1.8])u(f,p,1.5,f<0?Math.PI/2:-Math.PI/2);for(let f of[-2.8,2.8]){c("kitchenCabinetDrawer",1.7,f,.4,{action:0});for(let[p,x]of["apple","carrot","broccoli"].entries())c(x,.3,f-.5+p*.5,.4,{y:.9})}}else if(e==="airport"){for(let f of[-3.7,3.7])for(let p of[-.8,2])c("loungeSofaLong",2,f,p);c("computerScreen",.55,0,-2.55,{y:1.17,action:2}),c("desk",1.2,4.3,-3.7,{action:2})}return n}var Qd=[{id:"home",name:"\uC6B0\uB9AC \uC9D1",x:-25,z:23,model:"building-type-f"},{id:"school",name:"\uC720\uCE58\uC6D0",x:-25,z:-10,model:"building-type-b"},{id:"library",name:"\uB3C4\uC11C\uAD00",x:-25,z:-29,model:"building-e"},{id:"hotel",name:"\uB2EC\uBE5B \uD638\uD154",x:0,z:-32,model:"building-type-q"},{id:"airport",name:"\uACF5\uD56D",x:26,z:-31,model:"building-j"},{id:"clinic",name:"\uB3D9\uBB3C\uBCD1\uC6D0",x:26,z:-11,model:"building-type-c"},{id:"cafe",name:"\uBC1C\uBC14\uB2E5 \uCE74\uD398",x:26,z:12,model:"building-b"},{id:"shop",name:"\uC0C1\uC810",x:8,z:29,model:"building-a"},{id:"forest",name:"\uC232\uC18D \uC0B0\uCC45\uAE38",x:-12,z:-36,model:null},{id:"park",name:"\uC911\uC559 \uACF5\uC6D0",x:-8,z:5,model:null}],Oh=s=>4+Math.sin(s/12)*2;function ef(s,e){return![-16,16].some(n=>Math.abs(e-n)<1.5)&&Math.abs(s-Oh(e))<1.65&&e>-37&&e<34||(s-12)**2/49+(e+2)**2/36<1}function tf(s,{places:e,state:t,label:n,alive:i}){let r=h=>new Ot({color:h,roughness:.9}),o=(h,d,f,p,x,g,m)=>{let _=new mt(new fn(h,d,f),r(p));return _.position.set(x,g,m),_.castShadow=_.receiveShadow=!0,s.add(_),_};function a(h,d,f){let p=new Yr(h.map(([M,b])=>new R(M,.02,b))),x=[],g=p.getPoints(100);for(let M=0;M<g.length-1;M++){let b=g[M],A=g[M+1],E=new R().subVectors(A,b).normalize().cross(new R(0,1,0)).multiplyScalar(d/2);for(let C of[b.clone().add(E),A.clone().add(E),b.clone().sub(E),b.clone().sub(E),A.clone().add(E),A.clone().sub(E)])x.push(C.x,C.y,C.z)}let m=new Dt;m.setAttribute("position",new xt(x,3)),m.computeVertexNormals();let _=new mt(m,r(f));return _.material.side=en,_.receiveShadow=!0,s.add(_),_}let c=o(80,.18,84,"#a9c789",0,-.13,-3);c.userData.ground=!0,a([[-18,25],[-20,8],[-18,-16],[-10,-25],[7,-25],[20,-18],[21,8],[18,24],[0,26],[-18,25]],2.8,"#e1c99e"),a([[-21,-16],[-6,-16],[5,-16],[21,-16]],2.6,"#e1c99e"),a([[-21,16],[-8,16],[5,16],[21,16]],2.6,"#e1c99e"),a([[-8,23],[-11,9],[-8,-1],[-10,-12],[-8,-24]],1.7,"#e7d7b5");let l=a(Array.from({length:15},(h,d)=>{let f=-38+d*5.2;return[Oh(f),f]}),3.5,"#71bcc4");l.position.y=.015;let u=new mt(new qr(1,60),new Ot({color:"#75bec5",roughness:.28,metalness:.15}));u.rotation.x=-Math.PI/2,u.scale.set(7.2,6.2,1),u.position.set(12,.045,-2),s.add(u);for(let h of[-16,16]){let d=Oh(h);o(5,.18,2.6,"#b5824c",d,.08,h);for(let f=-2.4;f<=2.4;f+=.4)o(.08,.02,2.6,"#ddbc86",d+f,.18,h);for(let f of[-1,1]){o(5,.1,.08,"#d3a46c",d,.9,h+f*1.2);for(let p=-2;p<=2;p+=1)o(.1,.9,.1,"#a67545",d+p,.5,h+f*1.2)}}for(let h of e)if(h.door={x:h.x,z:h.z+(h.model?3.9:2)},h.model){let d=new Mt;d.position.set(h.x,0,h.z),d.userData.place=h.id,s.add(d);let f=h.id==="home"&&window.KittyData.houses.find(p=>p.id===t.house)?.model||h.model;_t(f,d,{width:h.id==="hotel"?8:6.7,alive:i,onReady:p=>{let x=new Vt().setFromObject(p).max.y;n(h.name,0,x+.65,0,d)}}),a([[h.x,h.door.z],[h.x*.8,h.door.z+1.2],[h.x*.7,h.door.z+2.5]],2.2,"#e1c99e");for(let p of[-4,4])_t("pottedPlant",s,{width:.8,x:h.x+p,z:h.z+3,alive:i}),_t("bench",s,{width:1.8,x:h.x+p,z:h.z,rotation:Math.PI/2,alive:i})}else{let d=new Mt;d.position.set(h.x,0,h.z),d.userData.place=h.id,s.add(d),_t(h.id==="forest"?"tent_smallOpen":"bench",d,{width:2.4,alive:i}),n(h.name,0,2.7,0,d)}for(let h=0;h<70;h++){let d=h%4,f=d<2?d===0?-34:34:-32+h%18*3.8,p=d<2?-37+h%18*4:d===2?-40:34;e.some(x=>Math.hypot(x.x-f,x.z-p)<6)||_t(h%3?"tree_oak":"tree_pineSmallA",s,{width:2.6+h%3*.35,x:f,z:p,alive:i})}for(let[h,d]of[[-14,2],[-2,-7],[-14,18],[0,21],[21,3],[-19,-23],[20,-23]]){_t("tree_oak",s,{width:3.2,x:h,z:d,alive:i}),_t("bench",s,{width:1.9,x:h+2.1,z:d+1,rotation:-Math.PI/2,alive:i});for(let f=0;f<3;f++)_t("flower_purpleA",s,{width:.55,x:h-1+f*.6,z:d+1.8,alive:i})}for(let h=0;h<18;h++){let d=h/18*Math.PI*2;_t("rock_smallB",s,{width:.7,x:12+Math.cos(d)*7.5,z:-2+Math.sin(d)*6.6,alive:i})}for(let[h,d]of[[-13,6],[-3,10],[-12,-8]])_t("rugRectangle",s,{width:2,x:h,z:d,alive:i}),_t("apple",s,{width:.35,x:h+.3,z:d,alive:i});for(let h of[-15,-12,-9])o(.12,.8,.12,"#d6ac6a",h,.4,-3),o(.12,.8,.12,"#d6ac6a",h,.4,-1),o(.12,.12,2,"#f5d48b",h,.8,-2);o(10,.02,2,"#b6b5ad",25,.01,-37),_t("fence-low",s,{width:2.5,x:20,z:-35,alive:i})}var Bh=s=>new R(s.x*qe,s.y,s.z*qe),_o=(s,e)=>s.scale.set(e/qe,e,e/qe),kh=()=>{},nf=()=>{},li=Qd,zh={shop:[["Apple basket","Find three apples.","\uC0AC\uACFC 3\uAC1C\uB97C \uCC3E\uC544\uBCF4\uC138\uC694.",["Apple","Banana","Milk"],0],["Toy shelf","Which toy can roll?","\uC5B4\uB5A4 \uC7A5\uB09C\uAC10\uC774 \uAD74\uB7EC\uAC08\uAE4C\uC694?",["A ball.","A book.","A hat."],0],["Cash register","How would you like to pay?","\uC5B4\uB5BB\uAC8C \uACC4\uC0B0\uD558\uC2DC\uACA0\uC5B4\uC694?",["With coins, please.","I am sleeping.","It is raining."],0]],library:[["Story book","May I borrow this book?","\uC774 \uCC45\uC744 \uBE4C\uB824\uB3C4 \uB420\uAE4C\uC694?",["Yes. Here you are.","At Gate Two.","Chicken, please."],0],["Book shelf","Put the blue book on the shelf.","\uD30C\uB780 \uCC45\uC744 \uCC45\uC7A5\uC5D0 \uB193\uC73C\uC138\uC694.",["The blue book.","The red ball.","The yellow bag."],0],["Reading desk","Let\u2019s match words together.","\uD568\uAED8 \uB2E8\uC5B4\uC758 \uC9DD\uC744 \uB9DE\uCDB0 \uBD10\uC694.",["Let\u2019s play!","I need a ticket.","My soup is hot."],0]],airport:[["Suitcase","What goes in your travel bag?","\uC5EC\uD589 \uAC00\uBC29\uC5D0 \uBB34\uC5C7\uC744 \uB123\uC744\uAE4C\uC694?",["My clothes.","A big tree.","A sofa."],0],["Passport desk","May I see your passport?","\uC5EC\uAD8C\uC744 \uBCF4\uC5EC\uC8FC\uC2DC\uACA0\uC5B4\uC694?",["Here is my passport.","Here is my soup.","I am a book."],0],["Departure gate","Are you ready to fly?","\uBE44\uD589\uD560 \uC900\uBE44\uAC00 \uB418\uC5C8\uB098\uC694?",["Yes, let\u2019s go!","It is a spoon.","The book is red."],0]],cafe:[["Kitchen","Add chicken to the sandwich.","\uC0CC\uB4DC\uC704\uCE58\uC5D0 \uB2ED\uACE0\uAE30\uB97C \uB123\uC73C\uC138\uC694.",["Chicken goes here.","My passport is here.","This is a bed."],0],["Water jug","Would you like some water?","\uBB3C\uC744 \uC880 \uB4DC\uB9B4\uAE4C\uC694?",["Yes, water, please.","I am a window.","At the airport."],0],["Table","Your food is ready.","\uC74C\uC2DD\uC774 \uC900\uBE44\uB418\uC5C8\uC5B4\uC694.",["Thank you!","Where is Gate Two?","Good night, book."],0]],school:[["Blocks","Which block is red?","\uC5B4\uB290 \uBE14\uB85D\uC774 \uBE68\uAC04\uC0C9\uC778\uAC00\uC694?",["This red block.","This blue book.","This yellow bag."],0],["School bag","What is your friend\u2019s name?","\uCE5C\uAD6C\uC758 \uC774\uB984\uC740 \uBB34\uC5C7\uC778\uAC00\uC694?",["My friend is {name}.","My friend is a ticket.","My friend is a spoon."],0],["Art desk","Let\u2019s play a word game.","\uB2E8\uC5B4 \uAC8C\uC784\uC744 \uD574 \uBD10\uC694.",["That sounds fun!","Here is the bill.","It is a passport."],0]],park:[["Ball","Can you catch the ball?","\uACF5\uC744 \uC7A1\uC744 \uC218 \uC788\uB098\uC694?",["Yes, I can!","I am a book.","A table for two."],0],["Picnic basket","Are you hungry?","\uBC30\uAC00 \uACE0\uD508\uAC00\uC694?",["Yes. A snack, please.","Yes. I am a tree.","At Gate Two."],0],["Flower bed","Please be gentle with the flowers.","\uAF43\uC744 \uC870\uC2EC\uD788 \uB2E4\uB904 \uC8FC\uC138\uC694.",["Okay. I will be gentle.","Give me a passport.","Two tickets, please."],0]]};function r_(s,{state:e,destination:t,save:n,onHome:i,onTalk:r,onGame:o,onShop:a,onFetch:c,speak:l,wrong:u}){li.forEach(W=>W.name=window.KittyI18n?.t(W.name)||W.name),kh();let h=!0,d=0,f=0,p=null,x=null,g=!1,m=!1,_=0,M=null,b=!1,A=null,E=null,C=!1,v=[],w=[],H=!0,P=null,O=null,z=null,G=0;s.hidden=!1,s.innerHTML='<header class="town-head"><button id="townBack">Home</button><button id="townMap">\uC9C0\uB3C4</button><b id="townTitle">A walk together</b><button id="townSports" hidden>\uC6B4\uB3D9\uC7A5</button><button id="townTalk" hidden>Talk</button></header><button class="town-mission"></button><div class="town-canvas"></div><nav class="town-stops"></nav><div class="town-activity" hidden></div><div class="town-tip" role="status">\uC9E7\uAC8C \uB204\uB974\uBA74 \uAC77\uAE30 \xB7 \uAE38\uAC8C \uB204\uB974\uBA74 \uB2EC\uB9AC\uAE30</div>';let B=window.KittyCore,F=window.KittyData,k=e.gold,ue=e.xp,se=null,me=[],Me=()=>{let W=e.gold-k,ee=e.xp-ue;k=e.gold,ue=e.xp,n(),Ce(),(W>0||ee>0)&&re(W,ee)};nf=Me;let Z=W=>s.querySelector(W),Fe=W=>Z(".town-tip").textContent=W,ut=new Kn;ut.scale.set(qe,1,qe),s.dataset.spaceScale=qe,ut.background=new Be("#c8ddcb"),ut.fog=new Ur("#c8ddcb",500,800);let We;try{We=new wi({antialias:!0})}catch{Z(".town-tip").textContent="3D is unavailable on this device.",Z("#townMap").onclick=()=>{p&&D(),H=!H},Z("#townBack").onclick=i;return}We.setPixelRatio(Math.min(devicePixelRatio,2)),We.shadowMap.enabled=!0,We.shadowMap.type=ar,We.toneMapping=si,We.toneMappingExposure=1,Z(".town-canvas").append(We.domElement);let $=new Nt(45,1,.1,500),de=new Cn("#fff0cd",3);de.position.set(-5,15,7),de.castShadow=!0,de.shadow.normalBias=.035,de.shadow.bias=-15e-5,de.shadow.mapSize.set(1024,1024),Object.assign(de.shadow.camera,{left:-18,right:18,top:18,bottom:-18}),ut.add(de,new ni("#fff9e9","#9ab28f",1.6));let fe=new Mt,Te=new Mt;ut.add(fe,Te),Te.visible=!1;let Ge=W=>new Ot({color:W,roughness:.88});function Ye(W,ee,oe,Le,I,X,Q,ne=fe){let ie=new mt(new xr(W,ee,oe,2,Math.min(.06,W/8,ee/8,oe/8)),Ge(Le));return ie.position.set(I,X,Q),ie.castShadow=ie.receiveShadow=!0,ne.add(ie),ie}function Pt(W,ee,oe,Le,I,X=fe){let Q=new mt(new Vi(W,20,12),Ge(ee));return Q.position.set(oe,Le,I),Q.castShadow=!0,X.add(Q),Q}function st(W,ee,oe,Le,I=fe){W=window.KittyI18n?.t(W)||W;let X=document.createElement("canvas");X.width=512,X.height=96;let Q=X.getContext("2d");Q.fillStyle="#fff5df",Q.beginPath(),Q.roundRect(2,2,508,92,22),Q.fill(),Q.fillStyle="#594635",Q.font="bold 37px system-ui",Q.textAlign="center",Q.fillText(W,256,61);let ne=new Wr(X);ne.colorSpace=Ut;let ie=new Br(new js({map:ne,depthTest:!1}));return ie.position.set(ee,oe,Le),ie.scale.set(3.5/qe,.66,1),I.add(ie),ie}tf(fe,{places:li,state:e,label:st,alive:()=>h}),s.dataset.worldAssets="ready";let Ee=new Mt;ut.add(Ee),Pt(.5,"#dca66d",0,.7,0,Ee).scale.set(1,1,1.3);let Ze=Ki(Ee,e,()=>h);Ee.position.set(-19,0,24),_o(Ee,.7);let gt=[],L=new R(-19,.5,24),yt=new ms,tt=new $e,nt=new Mt;_o(nt,1.25),nt.position.set(-20,0,24),ut.add(nt);let De=Ki(nt,{species:"dog",breed:"walker",outfit:"mint"},()=>h),T=new Dt().setFromPoints([new R,new R,new R]),y=new yi(T,new _i({color:"#c27f61"}));ut.add(y);function N(W,ee){return ef(W,ee)||li.filter(oe=>oe.model).some(oe=>Math.abs(W-oe.x)<(oe.id==="hotel"?4.2:3.5)&&Math.abs(ee-oe.z)<3.1)}function J(W,ee,oe=null){if(H=!1,p){let et=[Math.round(Ee.position.x*2),Math.round(Ee.position.z*2)],Ae=[Math.round(Math.max(-5.4,Math.min(5.4,W))*2),Math.round(Math.max(-4.4,Math.min(4.4,ee))*2)],je=(Tn,S)=>Tn+","+S,ft=[et],Ct=new Map([[je(...et),null]]),xn=(Tn,S)=>w.some(U=>Math.abs(Tn/2-U.x)<U.w/2+.2&&Math.abs(S/2-U.z)<U.d/2+.2),$t=!1;for(let Tn=0;Tn<ft.length;Tn++){let[S,U]=ft[Tn];if(S===Ae[0]&&U===Ae[1]){$t=!0;break}for(let[Y,q]of[[1,0],[-1,0],[0,1],[0,-1]]){let V=S+Y,xe=U+q,Re=je(V,xe);Math.abs(V)>10||Math.abs(xe)>8||xn(V,xe)||Ct.has(Re)||(Ct.set(Re,[S,U]),ft.push([V,xe]))}}if(!$t){Fe("\uAC00\uAD6C \uC0AC\uC774\uC758 \uBE48 \uBC14\uB2E5\uC744 \uB20C\uB7EC \uC8FC\uC138\uC694.");return}let un=Ae,Ti=[];for(;un;)Ti.push({x:un[0]/2,z:un[1]/2}),un=Ct.get(je(...un));gt=Ti.reverse().slice(1);return}let Le=[Math.round(Ee.position.x),Math.round(Ee.position.z)],I=[Math.round(W),Math.round(ee)],X=(et,Ae)=>et+","+Ae,Q=[Le],ne=new Map([[X(...Le),null]]),ie=!1;for(let et=0;et<Q.length;et++){let[Ae,je]=Q[et];if(Ae===I[0]&&je===I[1]){ie=!0;break}for(let[ft,Ct]of[[1,0],[-1,0],[0,1],[0,-1]]){let xn=Ae+ft,$t=je+Ct,un=X(xn,$t);Math.abs(xn)>37||$t<-40||$t>35||N(xn,$t)||ne.has(un)||(ne.set(un,[Ae,je]),Q.push([xn,$t]))}}if(!ie){Fe("Choose a spot on the path.");return}let ye=I,ge=[];for(;ye;)ge.push({x:ye[0],z:ye[1]}),ye=ne.get(X(...ye));gt=ge.reverse().slice(1),x=oe,g=!1,oe&&Fe("Walking to "+li.find(et=>et.id===oe).name+"\u2026")}function te(W){let ee="town:"+e.day+":"+W;return e.claimed.includes(ee)?"Good practice!":(e.claimed.push(ee),e.gold+=8,e.xp+=12,e.score+=5,Me(),"+8 G \xB7 +12 XP")}function j(W){W.classList.add("bubble-dialogue");let ee=document.createElement("div");ee.className="npc-bubble";let oe=document.createElement("div");oe.className="player-bubble";for(let X of[...W.children])X.matches("h3,.npc-name,.visit-context,.town-hear,.town-translate,.town-ko,.town-dismiss")?ee.append(X):oe.append(X);let Le=document.createElement("small");Le.className="reply-name",Le.textContent=e.name;let I=document.createElement("img");I.src="assets/animal-town/models/previews/profile-"+e.breed+".png",I.alt="",Le.prepend(I),oe.prepend(Le);for(let X of oe.querySelectorAll(".town-answers button")){let Q=X.textContent.toLowerCase(),ne=[[/snack|chicken|food/,"meat-cooked"],[/tree|flower/,"flower_yellowA"],[/book/,"books"],[/water|milk/,"mug"],[/ball/,"bear"],[/bed|blanket/,"pillowBlue"]].find(([ie])=>ie.test(Q));if(ne){let ie=document.createElement("img");ie.className="answer-prop",ie.src="assets/animal-town/models/previews/"+ne[1]+".png",ie.alt="",X.prepend(ie)}X.classList.add("bubble-answer")}W.append(ee,oe)}function Se(W){if(m)return;if(W===2&&["library","school","airport"].includes(p)){o(p==="airport"?"plane":"pairs");return}if(W===2&&p==="shop"){a();return}if(F.episodes.some(ge=>ge.location===p)){_e();return}let ee=++_,oe=p,Le=zh[p][W],I=Z(".town-activity");m=!0,I.hidden=!1,I.innerHTML='<button class="town-dismiss">\xD7</button><h3></h3><button class="town-hear">\uB2E4\uC2DC \uB4E3\uAE30</button><button class="town-translate">\uD574\uC11D \uBCF4\uAE30</button><p class="town-ko" hidden></p><div class="town-answers"></div><p class="town-feedback" role="status"></p>',I.querySelector("h3").textContent=Le[1],I.querySelector(".town-ko").textContent=Le[2],I.querySelector(".town-translate").onclick=()=>I.querySelector(".town-ko").hidden=!I.querySelector(".town-ko").hidden;let X=()=>h&&!I.hidden&&ee===_,Q=!1,ne=!1,ie=()=>I.querySelectorAll(".town-answers button");async function ye(ge){Q=!0,ie().forEach(Ae=>Ae.disabled=!0),I.querySelector(".town-hear").disabled=!0;let et=await l(ge);return X()&&(Q=!1,ie().forEach(Ae=>Ae.disabled=ne),I.querySelector(".town-hear").disabled=!1),et}I.querySelector(".town-dismiss").onclick=()=>{_++,I.hidden=!0,m=!1,window.KittySpeech.stop()},I.querySelector(".town-hear").onclick=()=>ye(Le[1]);for(let ge of[0,1,2].sort(()=>Math.random()-.5)){let et=document.createElement("button");et.textContent=Le[3][ge].replace("{name}",e.name),I.querySelector(".town-answers").append(et),et.onclick=async()=>{if(Q||ne||!X())return;if(et.classList.add(ge===Le[4]?"right":"wrong"),ge!==Le[4]){u(),I.querySelector(".town-feedback").textContent="\uB2E4\uC2DC \uB4E3\uACE0 \uACE8\uB77C \uBD10\uC694.",await ye(Le[3][Le[4]].replace("{name}",e.name));return}ne=!0;let Ae=async()=>{let je=await ye(et.textContent);if(X()){if(je==="error"||je==="cancelled"){I.querySelector(".town-feedback").textContent="\uC18C\uB9AC\uB97C \uB2E4\uC2DC \uB4E4\uC73C\uBA74 \uC774\uC5B4\uC9D1\uB2C8\uB2E4.",I.querySelector(".town-hear").onclick=Ae;return}if(Fe(te(oe+":"+W)),I.hidden=!0,m=!1,_++,oe==="shop"&&W===2){a();return}if(oe==="library"&&W===2||oe==="school"&&W===2){o("pairs");return}if(oe==="airport"&&W===2){o("plane");return}if(oe==="park"&&W===0){ze("park");return}if(oe==="shop"&&W===0||oe==="cafe"&&W===0||oe==="library"&&W===1){ze(oe);return}W+1<zh[oe].length&&Se(W+1)}};Ae()}}j(I),ye(Le[1])}let le=null,Ne=[];function ze(W){for(let ee of Ne)ee.parent&&(ee.removeFromParent(),ee.geometry.dispose(),ee.material.dispose());Ne=[],le={location:W,count:0},Fe(W==="park"?"\uACF5 \uC138 \uAC1C\uB97C \uCC3E\uC544 \uB20C\uB7EC \uC8FC\uC138\uC694.":W==="library"?"Tap the 3 blue books.":W==="shop"?"Tap the 3 apples for your basket.":"Tap chicken, bread, and lettuce to serve lunch.");for(let ee=0;ee<3;ee++){let oe=W==="library"?Ye(.4,.1,.6,"#689bcd",-1.5+ee*1.5,.4,1.4,Te):Pt(.24,["#d96752","#e8b46c","#8fad65"][W==="shop"?0:ee],-1.5+ee*1.5,.4,1.4,Te);oe.userData.collect=!0,Ne.push(oe)}}function ae(W){if(W==="home"){i();return}p=W,s.dataset.inside=W,b=!1,C=!1,fe.visible=!1,Te.traverse(Le=>{Le.geometry?.dispose();for(let I of[].concat(Le.material||[]))I.map?.dispose(),I.dispose()}),Te.clear(),Te.visible=!0,gt=[],Ee.position.set(0,0,2),nt.position.set(-1,0,2),Z("#townTitle").textContent=li.find(Le=>Le.id===W).name,Z("#townBack").textContent="Town",Z("#townTalk").hidden=!1,Z("#townSports").hidden=W!=="school",Z(".town-stops").hidden=!0,w=jd(Te,W,()=>h&&p===W),we(W),_o(Ee,.65);let ee=new Mt;ee.position.set(0,0,-3.6),_o(ee,1.15),ee.rotation.y=-.35,ee.userData.npc=!0,Te.add(ee),M=Ki(ee,{species:"dog",breed:"walker",outfit:"mint"},()=>h&&p===W);let oe=st((F.locations.find(Le=>Le.id===W)?.npc||"\uB9C8\uC744 \uCE5C\uAD6C")+" \xB7 \uB9D0 \uAC78\uAE30",0,2.8,-3.6,Te);if(oe.userData.npc=!0,oe.userData.talkLabel=!0,W==="school"){let Le=st("\uCCB4\uC721\uB300\uD68C \uCC38\uAC00",2.5,1.2,1.5,Te);Le.userData.sports=!0}Fe("\uC9C1\uC6D0\uC5D0\uAC8C \uB2E4\uAC00\uAC00 \uB9D0\uC744 \uAC78\uC5B4 \uBCF4\uC138\uC694."),Me()}function he(){C=!0,v=[],Te.children.forEach(W=>W.visible=!1),Ye(8,.15,7,"#b4d69b",0,-.1,0,Te);for(let W of[.1,1.4])Ye(6,.025,.06,"#fff8dd",0,.02,W,Te);for(let W of[-2.8,2.8])Ye(.08,.6,.08,"#ffae69",W,.3,.8,Te),st(W<0?"\uCD9C\uBC1C":"\uB3C4\uCC29",W,1.2,.8,Te).scale.set(1.3,.35,1);Ye(.12,.55,.12,"#edb968",0,.28,.2,Te),Ye(.12,.55,.12,"#edb968",0,.28,1.3,Te),Ye(.12,.1,1.2,"#faf3db",0,.55,.75,Te),E=Pt(.22,"#ef9867",-1.5,.5,.8,Te),_t("planter",Te,{width:1,x:2.5,z:-1.2,alive:()=>h&&C}),Ee.position.set(-2,0,.8),Fe("\uB2EC\uB9AC\uAE30 \xB7 \uC7A5\uC560\uBB3C \uB118\uAE30 \xB7 \uACF5\uB180\uC774")}function Ie(W){return W===2&&Ee.position.set(-1.5,0,.8),new Promise(ee=>{A={event:W,t:0,resolve:ee}})}function Pe(){m||p!=="school"||(J(2,1.5),b="school-sports")}function _e(){m||!p||(J(-1.4,.5),b=!0,Fe("\uC9C1\uC6D0\uC5D0\uAC8C \uB2E4\uAC00\uAC00\uB294 \uC911\u2026"))}function Ke(W){let ee=Z(".town-activity"),oe=B.current(e);if(oe&&oe.episode.location!==p){Fe("\uC9C4\uD589 \uC911\uC778 \uC774\uC57C\uAE30\uAC00 \uC788\uC5B4\uC694. "+(F.locations.find(Ae=>Ae.id===oe.episode.location)?.name||"\uADF8 \uC7A5\uC18C")+"\uC5D0\uC11C \uC774\uC5B4\uAC00 \uC8FC\uC138\uC694.");return}if(!oe){let Ae=F.episodes.filter(Ct=>Ct.location===p&&Ct.level<=B.level(e)),je=(W?Ae.find(Ct=>Ct.id===W):null)||B.chooseVisit(e,p);if(!je){if(zh[p]&&!F.episodes.some(Ct=>Ct.location===p)){Se(p==="park"?1:0);return}Fe(F.episodes.some(Ct=>Ct.location===p)?"\uC544\uC9C1 \uC900\uBE44 \uC911\uC778 \uC5EC\uD589\uC774\uC5D0\uC694. \uB808\uBCA8\uC744 \uB354 \uC62C\uB9B0 \uB4A4 \uC9C1\uC6D0\uACFC \uC774\uC57C\uAE30\uD574 \uC8FC\uC138\uC694.":"\uC8FC\uBCC0 \uBB3C\uAC74\uC744 \uB20C\uB7EC \uD568\uAED8 \uB180\uC544 \uBCF4\uC138\uC694.");return}let ft=B.begin(e,je.id);if(!ft.ok){Fe(window.KittyI18n?.t(ft.message)||ft.message);return}Me(),oe=B.current(e)}oe.episode.id==="school-sports"&&!C&&he();let Le=++_;m=!0,ee.hidden=!1,ee.classList.add("npc-conversation"),ee.innerHTML='<button class="town-dismiss" aria-label="\uB300\uD654 \uB2EB\uAE30">\xD7</button><small class="npc-name"></small><h3></h3><button class="town-hear">\uB2E4\uC2DC \uB4E3\uAE30</button><button class="town-translate">\uD574\uC11D \uBCF4\uAE30</button><p class="town-ko" hidden></p><div class="town-answers"></div><p class="town-feedback" role="status"></p><button class="npc-next primary" hidden>\uACC4\uC18D</button>';let I=()=>h&&Le===_&&!ee.hidden,X=()=>{_++,m=!1,ee.hidden=!0,window.KittySpeech.stop()};ee.querySelector(".town-dismiss").onclick=X,ee.querySelector(".npc-name").textContent=(F.locations.find(Ae=>Ae.id===p)?.npc||"\uCE5C\uAD6C")+" \xB7 "+oe.episode.title;let Q=document.createElement("p");Q.className="visit-context",Q.textContent=e.active.index===0?B.expand(e,oe.episode.story):B.expand(e,oe.node.context),ee.querySelector(".npc-name").after(Q);let ne=B.expand(e,oe.node.line);ee.querySelector("h3").textContent=ne,ee.querySelector(".town-ko").textContent=F.translations[oe.node.id]||"",ee.querySelector(".town-translate").onclick=()=>{ee.querySelector(".town-ko").hidden=!ee.querySelector(".town-ko").hidden};let ie=!1,ye=ee.querySelector(".npc-next"),ge=ee.querySelector(".town-answers");async function et(Ae){ie=!0,ye.disabled=!0,ge.querySelectorAll("button").forEach(je=>je.disabled=!0),ee.querySelector(".town-hear").disabled=!0;try{return await l(Ae)}finally{I()&&(ie=!1,ye.disabled=!1,ee.querySelector(".town-hear").disabled=!1,ge.querySelectorAll("button").forEach(je=>je.disabled=!!e.active?.accepted))}}if(ee.querySelector(".town-hear").onclick=()=>et(ne),oe.node.choices.forEach((Ae,je)=>{let ft=document.createElement("button");ft.textContent=B.expand(e,Ae.text),ge.append(ft),ft.onclick=async()=>{if(ie||!I()||e.active.accepted)return;let Ct=B.answer(e,je);if(Me(),Ct.retreat){X(),Fe("\uC7A0\uAE50 \uC26C\uC5C8\uB2E4 \uB2E4\uC2DC \uB3C4\uC804\uD574\uC694.");return}if(ft.classList.add(Ct.ok?"right":"wrong"),!Ct.ok){u(),ee.querySelector(".town-feedback").textContent="\uB2E4\uC2DC \uB4E3\uACE0 \uB530\uB77C \uD574 \uBD10\uC694.",await et(B.expand(e,oe.node.choices.find($t=>$t.ok).text));return}ee.querySelector(".town-feedback").textContent="\uC798\uD588\uC5B4\uC694!";let xn=async()=>{let[$t]=await Promise.all([et(ft.textContent),oe.episode.id==="school-sports"?Ie(e.active.index):Promise.resolve()]);if(I()){if($t==="error"||$t==="cancelled"){ee.querySelector(".town-feedback").textContent="\uC18C\uB9AC\uB97C \uB2E4\uC2DC \uB4E4\uC73C\uBA74 \uC774\uC5B4\uC9D1\uB2C8\uB2E4.",ee.querySelector(".town-hear").onclick=xn;return}ye.onclick()}};xn()}}),ye.onclick=()=>{if(ie)return;let Ae=B.next(e);if(Ae.finished&&Ae.episode==="school-sports"&&Ae.memory&&v.filter(Boolean).length===3&&(Ae.memory.photos=[...v]),Me(),!!Ae.ok){if(!Ae.finished){Ke();return}_++,ee.classList.remove("bubble-dialogue"),ee.innerHTML='<h3>\uC774\uC57C\uAE30 \uC644\uB8CC!</h3><div class="npc-reward"></div><p>\uCD94\uC5B5 \uC0AC\uC9C4 3\uC7A5\uC774 \uC568\uBC94\uC5D0 \uB2F4\uACBC\uC5B4\uC694.</p><button class="primary">\uACC4\uC18D \uB458\uB7EC\uBCF4\uAE30</button>',ee.querySelector(".npc-reward").textContent="+"+Ae.gold+" \uACE8\uB4DC \xB7 +"+Ae.xp+" \uACBD\uD5D8\uCE58",ee.querySelector("button").onclick=()=>{m=!1,ee.hidden=!0,C&&ae("school")}}},j(ee),e.active.accepted){let Ae=e.active.correct.at(-1)?.text||B.expand(e,oe.node.choices.find(je=>je.ok).text);et(Ae).then(je=>{I()&&je!=="error"&&je!=="cancelled"&&ye.onclick()})}else et(ne)}function D(){P=null,A?.resolve(),A=null,Ee.position.y=0,_++,p=null,_o(Ee,.7),s.dataset.inside="",b=!1,gt=[],Te.visible=!1,fe.visible=!0,Z(".town-activity").hidden=!0,m=!1,le=null,Z("#townTitle").textContent="A walk together",Z("#townBack").textContent="Home",Z("#townTalk").hidden=!0,Z("#townSports").hidden=!0,Z(".town-stops").hidden=!1;let W=li.find(ee=>ee.id===x);Ee.position.set(W?.door.x||0,0,(W?.door.z||7)+1),x=null,Fe("Where shall we go next?")}Z("#townBack").onclick=()=>{window.KittySpeech.stop(),p?D():i()},Z("#townTalk").onclick=_e,Z("#townSports").onclick=Pe;for(let W of li){let ee=document.createElement("button");ee.textContent=W.name,ee.dataset.destination=W.id,ee.onclick=()=>J(W.door.x,W.door.z,W.id),Z(".town-stops").append(ee)}We.domElement.onpointerdown=W=>{if(!Z(".town-activity").hidden)return;let ee=We.domElement.getBoundingClientRect();tt.set((W.clientX-ee.left)/ee.width*2-1,-(W.clientY-ee.top)/ee.height*2+1),yt.setFromCamera(tt,$);let oe=yt.intersectObjects((p?Te:fe).children,!0);for(let Le of oe){let I=Le.object;if(I.userData.collect){if(!I.visible||!le)return;I.removeFromParent(),I.geometry.dispose(),I.material.dispose(),le.count++,Fe("Collected "+le.count+" / 3"),le.count===3&&(Fe("All done! "+te(le.location+":collect")),le=null);return}for(;I&&I!==ut;){if(p&&I.userData.secret){J(-1.5,1.6),P={location:p,token:_};return}if(p&&I.userData.sports){Pe();return}if(p&&I.userData.npc){_e();return}if(p&&I.userData.action!==void 0){Se(I.userData.action);return}if(!p&&I.userData.place){let X=li.find(Q=>Q.id===I.userData.place);J(X.door.x,X.door.z,X.id);return}I=I.parent}if(Le.object.userData.ground){J(Le.point.x/qe,Le.point.z/qe);return}}};let pe=()=>{let W=s.getBoundingClientRect();We.setSize(W.width,W.height),$.aspect=W.width/W.height,$.updateProjectionMatrix()},ce=new ResizeObserver(pe);ce.observe(s),pe();function we(W){O=null,z=null;let ee=F.discoveries[W];if(!ee)return;O=_t(ee.model,Te,{width:.7,x:-1.8,z:2.8,alive:()=>h&&p===W}),O.userData.secret=W;let oe=new mt(new Jn(.5,.025,6,28),new on({color:"#ffd962"}));oe.rotation.x=Math.PI/2,oe.position.set(-1.8,.05,2.8),oe.userData.secret=W,oe.visible=!e.claimed.includes("discovery:"+e.day+":"+W),Te.add(oe),z=oe}function re(W,ee){let oe=document.createElement("div");oe.className="town-gain";for(let[Le,I]of[[W,"\uACE8\uB4DC"],[ee,"\uACBD\uD5D8\uCE58"]])if(Le>0){let X=document.createElement("b");X.textContent="+"+Le+" "+I,oe.append(X)}if(s.append(oe),me.push({el:oe,until:performance.now()+1900}),e.sound)try{let Le=window.AudioContext||window.webkitAudioContext;se=se||new Le,se.resume(),[880,1174,1568].forEach((I,X)=>{let Q=se.createOscillator(),ne=se.createGain(),ie=se.currentTime+X*.09;Q.type="sine",Q.frequency.value=I,ne.gain.setValueAtTime(0,ie),ne.gain.linearRampToValueAtTime(.09,ie+.01),ne.gain.exponentialRampToValueAtTime(.001,ie+.3),Q.connect(ne),ne.connect(se.destination),Q.start(ie),Q.stop(ie+.32),Q.onended=()=>{Q.disconnect(),ne.disconnect()}})}catch{}}function K(){let W=s.getBoundingClientRect(),ee=Bh(Ee.position).add(new R(0,2.2,0)).project($);for(let oe=me.length-1;oe>=0;oe--){let Le=me[oe];if(performance.now()>Le.until){Le.el.remove(),me.splice(oe,1);continue}Le.el.style.left=Math.max(80,Math.min(W.width-80,(ee.x+1)*W.width/2))+"px",Le.el.style.top=Math.max(100,Math.min(W.height-280,(1-ee.y)*W.height/2))+"px"}}function Ce(){let W=B.mission(e);Z(".town-mission").textContent=W.title+" \u203A",Z(".town-mission").classList.toggle("urgent",!!W.urgent)}Z(".town-mission").onclick=()=>{let W=B.mission(e);if(W.location==="home"){i();return}if(p===W.location){_e();return}p&&D();let ee=li.find(oe=>oe.id===W.location);ee&&J(ee.door.x,ee.door.z,ee.id)},Ce();function ke(){let W=Z(".town-activity"),ee=!W.hidden&&W.classList.contains("bubble-dialogue");if(Te.children.forEach(ge=>{ge.userData.talkLabel&&(ge.visible=!ee&&!C)}),Z(".town-tip").hidden=ee,Z(".town-mission").hidden=ee,!ee)return;let oe=W.querySelector(".npc-bubble"),Le=W.querySelector(".player-bubble");if(!oe||!Le)return;let I=s.getBoundingClientRect(),X=new R(0,2.8,-3.6*qe).project($),Q=Bh(Ee.position).add(new R(0,1.5,0)).project($),ne=(X.x+1)*I.width/2,ie=(Q.x+1)*I.width/2,ye=Math.max(10,Math.min(I.width-oe.offsetWidth-10,ne-oe.offsetWidth/2));oe.style.left=ye+"px",oe.style.top=Math.max(80,Math.min(I.height-Le.offsetHeight-oe.offsetHeight-52,(1-X.y)*I.height/2-oe.offsetHeight-12))+"px",oe.style.setProperty("--tail-x",Math.max(22,Math.min(oe.offsetWidth-22,ne-ye))+"px"),Le.style.top=Math.max(parseFloat(oe.style.top)+oe.offsetHeight+75,Math.min(I.height-Le.offsetHeight-15,(1-Q.y)*I.height/2+110))+"px",Le.style.bottom="auto",Le.style.setProperty("--tail-x",Math.max(25,Math.min(Le.offsetWidth-25,ie-10))+"px")}let rt=wc(We.domElement,s),Qe=Tc(We.domElement,s,()=>!m&&Z(".town-activity").hidden);function tn(W){if(!h)return;let ee=f?Math.min((W-f)/1e3,.1):0;if(f=W,document.hidden){d=requestAnimationFrame(tn);return}let oe=gt.length>0&&!m;if(oe){let ne=gt[0],ie=ne.x-Ee.position.x,ye=ne.z-Ee.position.z,ge=Math.hypot(ie,ye);if(ge<.09)gt.shift();else{let et=Math.min(ge,ee*(p?3:4.5)/qe*(Qe.running?2.2:1));Ee.position.x+=ie/ge*et,Ee.position.z+=ye/ge*et,Ee.rotation.y=Math.atan2(ie,ye)}}if(!gt.length&&x&&!p&&!g&&(g=!0,ae(x)),!gt.length&&b&&p){let ne=b;b=!1,Ke(typeof ne=="string"?ne:null)}if(M?.update(ee,!1,!1),A){let ne=A;ne.t+=ee;let ie=Math.min(1,ne.t/2);ne.event<2?(Ee.position.set(-2+4*ie,ne.event===1?Math.sin(ie*Math.PI)*1.3:0,.8),Ee.rotation.y=Math.PI/2):E.position.set(2.5-4*ie,.6+Math.sin(ie*Math.PI)*2,-1.2+2*ie),ie===1&&(We.render(ut,$),v[ne.event]=We.domElement.toDataURL("image/jpeg",.7),A=null,ne.resolve())}if(!gt.length&&P){let ne=P;if(P=null,ne.location===p&&ne.token===_){let ie=B.discover(e,p);Fe(ie.ok?ie.title+"!":ie.message),ie.ok&&(G=W+900,z.visible=!1,Me())}}O&&W<G&&(O.rotation.z=Math.sin(W*.025)*.15),z&&(z.rotation.z=W*.001),Ze.update(ee,oe||!!A,Qe.running||!!A),s.dataset.petX=Ee.position.x.toFixed(2),s.dataset.petZ=Ee.position.z.toFixed(2),s.dataset.locomotion=oe?Qe.running?"run":"walk":"idle";let Le=Ee.position.clone().add(new R(-Math.cos(Ee.rotation.y)*1.05,0,Math.sin(Ee.rotation.y)*1.05)),I=Le.distanceTo(nt.position);nt.position.lerp(Le,Math.min(1,ee*5)),nt.rotation.y=Ee.rotation.y,De.update(ee,oe||I>.15,Qe.running),s.dataset.guardian=De.ready?"ready":"loading";let X=T.attributes.position;X.setXYZ(0,nt.position.x+.28,1.4,nt.position.z+.22),X.setXYZ(1,(nt.position.x+Ee.position.x)/2,.7,(nt.position.z+Ee.position.z)/2),X.setXYZ(2,Ee.position.x,.8,Ee.position.z),X.needsUpdate=!0,T.computeBoundingSphere(),y.visible=!p,nt.visible=!0,s.dataset.guardianVisible="true",s.dataset.petAsset=Ze.ready?"ready":"loading";let Q=Bh(Ee.position);if(p){let ne=Z(".town-activity").hidden?Q.clone().add(new R(0,.6,0)):new R(0,.6,-1.8*qe);L.lerp(ne,Math.min(1,ee*4)),$.position.lerp(ne.clone().add(new R(8,10.5,16).multiplyScalar(rt.distance)),Math.min(1,ee*4))}else L.lerp(H?new R(0,0,-3*qe):Q.clone().add(new R(0,.7,0)),Math.min(1,ee*4)),$.position.lerp(H?new R(35,75,75).multiplyScalar(qe*Math.max(1,.7/$.aspect)*rt.distance):Q.clone().add(new R(11,18,20).multiplyScalar(rt.distance)),Math.min(1,ee*4));$.lookAt(L),ke(),K(),We.render(ut,$),d=requestAnimationFrame(tn)}if($.position.set(8,11,20),kh=()=>{h&&(rt.dispose(),Qe.dispose(),h=!1,se&&se.state!=="closed"&&se.close().catch(()=>{}),A?.resolve(),cancelAnimationFrame(d),ce.disconnect(),ut.traverse(W=>{W.geometry?.dispose();for(let ee of[].concat(W.material||[]))ee.map?.dispose(),ee.dispose()}),We.dispose(),We.forceContextLoss(),s.hidden=!0)},d=requestAnimationFrame(tn),t){let W=li.find(ee=>ee.id===t);W&&J(W.door.x,W.door.z,W.id)}}window.KittyTown={open:r_,close:()=>kh(),syncRewards:()=>nf()};var yo=()=>{},sf=!1;window.KittyPreview={close:()=>yo(),motion:s=>{sf=s},open(s,e,t={}){yo();let n=!0,i,r=0,o=new Kn;o.background=new Be("#edf0df");let a=new wi({antialias:!0,preserveDrawingBuffer:!0});a.setPixelRatio(Math.min(devicePixelRatio,2)),a.setSize(s.clientWidth,t.height||280),a.toneMapping=si,s.replaceChildren(a.domElement);let c=new Nt(35,s.clientWidth/(t.height||280),.1,40);c.position.set(3.2,2.5,5),c.lookAt(0,1,0),e==="fox"&&(c.position.set(4.2,3,7),c.lookAt(0,1,0)),o.add(new ni("#fffbe9","#959d85",3));let l=new Cn("#fff4de",3);l.position.set(-3,6,5),o.add(l);let u=new Mt;o.add(u);let h=Ki(u,{species:window.KittyData?.pets?.find(p=>p.id===e)?.species||(e==="cat"?"cat":"dog"),breed:e,outfit:t.outfit||"mint"},()=>n),d=new mt(new ki(1.6,1.6,.08,48),new Ot({color:"#d9c6a5"}));d.position.y=-.06,o.add(d);function f(p){let x=r?Math.min((p-r)/1e3,.04):0;r=p,h.update(x,sf),s.dataset.ready=h.ready?"yes":"no",a.render(o,c),n&&(i=requestAnimationFrame(f))}yo=()=>{n=!1,cancelAnimationFrame(i),a.dispose(),a.forceContextLoss(),o.traverse(p=>{p.geometry?.dispose(),[].concat(p.material||[]).forEach(x=>x.dispose())})},i=requestAnimationFrame(f)}};window.KittyPreview.asset=(s,e)=>{yo();let t=!0,n,i=new Kn;i.background=new Be("#f1ebdc");let r=new wi({antialias:!0,preserveDrawingBuffer:!0});r.setPixelRatio(2),r.setSize(256,256),r.toneMapping=si,s.replaceChildren(r.domElement);let o=new Nt(35,1,.1,100);i.add(new ni("#fffbe9","#d1bd9b",3));let a=new Cn("#fff3da",3);a.position.set(-3,7,5),i.add(a),_t(e,i,{width:2,alive:()=>t,onReady:c=>{let l=new Vt().setFromObject(c),u=l.getSize(new R),h=l.getCenter(new R),d=Math.max(u.x,u.y,u.z)*1.65;o.position.copy(h).add(new R(d*.9,d*.65,d)),o.lookAt(h),r.render(i,o),s.dataset.ready="yes"}}),yo=()=>{t=!1,r.dispose(),r.forceContextLoss()}};var vo={follow:{name:"\uB530\uB77C\uBCF4\uAE30",x:0,z:0},all:{name:"\uC9D1 \uC804\uCCB4",x:4.5,z:-3.8},living:{name:"\uAC70\uC2E4",x:0,z:0},kitchen:{name:"\uC8FC\uBC29\xB7\uC2DD\uD0C1",x:9,z:0,entry:[6,0]},bedroom:{name:"\uC548\uBC29",x:0,z:-7.5,entry:[0,-5]},bathroom:{name:"\uC695\uC2E4",x:9,z:-7.5,entry:[9,-5]}};function rf(s,e){let t=[];function n(r,o,a,c,l,u,h,d=!1){let f=new mt(new fn(r,o,a),new Ot({color:c,roughness:.88}));return f.position.set(l,u,h),f.castShadow=f.receiveShadow=!0,s.add(f),d&&t.push({x:l,z:h,w:r,d:a}),f}function i(r,o,a,c,{y:l=0,r:u=0,use:h,solid:d=!0}={}){let f=_t(r,s,{width:o,x:a,z:c,y:l,rotation:u,alive:e,onReady:p=>p.traverse(x=>{if(x.isMesh)for(let g of[].concat(x.material))g.name==="wood"&&g.color.set("#b9814e"),g.name==="plant"&&g.color.set("#57916c")})});h&&(f.userData.homeUse=h),l===0&&d&&!r.startsWith("rug")&&t.push({x:a,z:c,w:o*.8,d:o*.7})}for(let[r,o,a,c,l]of[[9,0,8,7,"#ceae83"],[0,-7.5,8,8,"#d3b28c"],[9,-7.5,8,8,"#c9d8d2"],[4.5,-3.7,1,15,"#d8bd99"],[4.5,-3.75,17,.5,"#d8bd99"]]){let u=n(a,.18,c,l,r,-.1,o);u.userData.walkFloor=!0}for(let[r,o,a,c]of[[9,0,8,7],[0,-7.5,8,8]])for(let l=o-c/2+.35;l<o+c/2;l+=.45){n(a,.006,.014,"#b1916f",r,.002,l);for(let u=r-a/2+1;u<r+a/2;u+=1.8)n(.012,.006,.44,"#b1916f",u+Math.round(l/.45)%2*.35,.003,l-.22)}for(let r=5;r<=13;r+=.8)n(.014,.006,8,"#eef3eb",r,.003,-7.5);for(let r=-11.5;r<=-3.5;r+=.8)n(8,.006,.014,"#eef3eb",9,.003,r);i("loungeSofa",2.1,-2.7,0,{r:Math.PI/2}),n(17,3.6,.12,"#ede2ce",4.5,1.7,-11.55,!0),n(.12,3.6,8,"#ede2ce",-4.05,1.7,-7.5,!0),n(17,.22,.15,"#7f9f8c",4.5,.15,-11.43);for(let r of[-2.55,2.55,6.45,11.55])n(2.9,1,.12,"#dfd1b6",r,.4,-3.65,!0);for(let r of[-9.6,-5.3,-2.3,2.3])n(.12,1,2.5,"#dfd1b6",4.45,.4,r,!0);for(let r of[-2,9])n(2.3,1.8,.08,"#f1ce9f",r,2.3,-11.42),n(2.1,1.6,.08,"#b7dfe6",r,2.3,-11.33),n(.09,1.6,.1,"#fff5df",r,2.3,-11.25);i("rugRectangle",3.8,0,-7.8,{solid:!1}),i("bedDouble",2.8,0,-9,{use:"bed"});for(let r of[-2,2])i("cabinetBedDrawer",.8,r,-9.4),i("lampRoundTable",.35,r,-9.4,{y:.75});i("bookcaseClosedWide",1.2,-3,-9.7),i("pottedPlant",.7,3,-10),i("pillowBlue",.65,2.7,-6.4,{solid:!1});for(let r of[6.5,8.2,9.9])i("kitchenCabinetDrawer",1.5,r,-2.85);i("kitchenSink",1.2,6.5,-2.85,{use:"fridge"}),i("kitchenCoffeeMachine",.45,8.2,-2.85,{y:.95}),i("kitchenFridgeLarge",1.1,12,-2.6,{use:"fridge"}),i("tableRound",2.1,9,1,{use:"fridge"});for(let[r,o,a]of[[7.6,1,Math.PI/2],[10.4,1,-Math.PI/2],[9,-.3,0],[9,2.3,Math.PI]])i("chairCushion",.7,r,o,{r:a});return i("plate",.38,9,1,{y:.87}),i("apple",.25,9.4,1,{y:.87}),i("plantSmall2",.7,12,2.7),i("bathtub",2.1,6.8,-9.5,{use:"bath"}),i("showerRound",1.6,11.7,-9.6,{use:"bath"}),i("bathroomSink",1,9.2,-10.6,{use:"bath"}),i("washer",1.1,11.8,-6),i("cabinetBedDrawer",1.1,6.4,-5.2),i("rugRound",1.6,9,-7,{solid:!1}),i("pottedPlant",.65,6,-10.7),t}var Cc=()=>{},of=()=>{},af=()=>{};function o_(s,{state:e,save:t,onClose:n,main:i=!1,onPlay:r=()=>{},speak:o=()=>{},onChange:a=()=>{},onShop:c=()=>{},onUse:l=()=>{}}){Cc();let u=!0,h=0,d=null,f=!1,p=0,x=3;s.hidden=!1,s.classList.toggle("main-room",i),s.classList.remove("arranging"),s.innerHTML='<div class="room-canvas"></div><header class="room-header"><div><b>My 3D Room</b><small>Tap the floor to call your pet</small></div><button class="secondary room-close">Done</button></header><div class="room-tools"><button class="secondary" id="decorateRoom">Arrange furniture</button><button class="secondary" id="turnItem" hidden>Rotate</button></div><div class="room-items" hidden></div><p class="room-message" role="status"></p>';let g=I=>s.querySelector(I),m=I=>g(".room-message").textContent=I,_;try{_=new wi({antialias:!0,alpha:!1})}catch{return s.innerHTML='<div class="sheet"><h2>3D is unavailable on this device.</h2><button class="primary">Back to my pet</button></div>',g("button").onclick=()=>{s.hidden=!0,n()},!1}_.setPixelRatio(Math.min(devicePixelRatio,2)),_.shadowMap.enabled=!0,_.shadowMap.type=ar,_.outputColorSpace=Ut,_.toneMapping=si,_.toneMappingExposure=1.15,g(".room-canvas").append(_.domElement);let M=new Kn;M.scale.set(qe,1,qe),s.dataset.spaceScale=qe,M.background=new Be("#e9d5b4");let b=new Nt(38,1,.1,400);b.position.set(8.3,10.5,12.8),b.lookAt(0,.3,0),M.add(new ni("#fffaeb","#8e7057",2.3));let A=new Cn("#fff2ce",4);A.position.set(-3,9,4),A.castShadow=!0,A.shadow.mapSize.set(2048,2048),Object.assign(A.shadow.camera,{left:-18,right:18,top:18,bottom:-18}),A.shadow.normalBias=.03,M.add(A);let E=[],C=(I,X=.85)=>{let Q=new Ot({color:I,roughness:X});return E.push(Q),Q},v=C(window.KittyData.houses.find(I=>I.id===e.house)?.wall||(e.house==="villa"?"#f4e8df":e.house==="cottage"?"#cbdac5":"#f7e7c7")),w=C("#b77d49"),H=C("#83a791"),P=C("#3b2921"),O=C("#dd9b8a"),z=C(e.species==="dog"?"#d69a53":"#a29a8b"),G=C("#fff1dc");function B(I,X,Q=0,ne=0,ie=0,ye=M){let ge=new mt(I,X);return ge.position.set(Q,ne,ie),ge.castShadow=!0,ge.receiveShadow=!0,ye.add(ge),ge}let F=(I,X,Q,ne,ie,ye,ge,et)=>B(new fn(I,X,Q),ne,ie,ye,ge,et),k=(I,X,Q,ne,ie,ye,ge,et)=>{let Ae=B(new Vi(1,24,16),ne,ie,ye,ge,et);return Ae.scale.set(I,X,Q),Ae},ue=F(8,.18,7,w,0,-.1,0);ue.name="floor";for(let I=-3.4;I<3.5;I+=.44)F(7.97,.012,.015,C("#9f693d"),0,.001,I);F(.15,3.6,7,v,-4,1.7,0),F(8,.17,.1,H,0,.14,-3.42),F(.1,.17,7,H,-3.9,.14,0);let se=B(new ki(1.55,1.55,.025,64),C("#c8b296"),.2,.025,.4);se.scale.z=.78;let me=new Mt;M.add(me),_t("sideTable",me,{width:1.15,x:-2.9,z:-2.7,alive:()=>u}),_t("pottedPlant",me,{width:.6,x:-2.9,z:-2.7,y:.95,alive:()=>u}),_t("bookcaseOpenLow",me,{width:1.5,x:2.6,z:-3,alive:()=>u}),_t("books",me,{width:.75,x:2.6,z:-3,y:.7,alive:()=>u}),_t("lampRoundTable",me,{width:.4,x:3.1,z:-3,y:.7,alive:()=>u}),_t("plantSmall3",me,{width:.7,x:-3.4,z:2.4,alive:()=>u}),_t("bear",me,{width:.55,x:3.3,z:2.7,alive:()=>u}),_t("rugRounded",me,{width:3.2,x:.2,z:.4,alive:()=>u}),se.visible=!1;let Me=M.children.filter(I=>I.isMesh||I===me),Z=new Mt;M.add(Z);let Fe=e.species==="dog"?.9:.85;Z.scale.setScalar(Fe*(.9+Math.min((e.day||1)/40,.22))),Z.scale.x/=qe,Z.scale.z/=qe,Z.position.set(.3,0,1.6);let ut=k(.48,.53,.75,z,0,.7,0,Z);k(.4,.4,.45,G,0,.65,.48,Z);let We=new Mt;We.position.set(0,1.2,.57),Z.add(We),k(.55,.52,.49,z,0,0,0,We),k(.43,.31,.29,G,0,-.15,.34,We);for(let I of[-1,1]){let X=B(new sr(.22,.65,3),z,I*.37,.54,0,We);X.rotation.z=-I*.2;let Q=B(new sr(.13,.42,3),O,I*.37,.56,.095,We);Q.rotation.z=-I*.2,k(.135,.17,.095,P,I*.215,.05,.43,We),k(.062,.075,.033,G,I*.19,.105,.52,We),k(.025,.025,.02,G,I*.265,.005,.525,We)}k(.12,.09,.09,P,0,-.15,.615,We),k(.065,.065,.035,O,0,-.28,.59,We);let $=e.outfit==="rain"?C("#eab949"):e.outfit==="princess"?O:H,de=B(new Jn(.32,.075,8,32),$,0,1,.52,Z);de.rotation.x=Math.PI/2;let fe=F(.32,.27,.035,$,0,.83,.81,Z);fe.rotation.x=-.13;let Te=[];for(let I of[-.31,.31])for(let X of[-.42,.45])Te.push(k(.16,.27,.18,G,I,.25,X,Z));let Ge=new Mt;Ge.position.set(0,.87,-.61),Z.add(Ge);let Ye=k(.16,.19,.45,z,0,.11,-.22,Ge);Ye.rotation.x=-.4;let Pt=new us(new Vi(1,5,4),z,220),st=new It;for(let I=0;I<220;I++){let X=I*2.39996,Q=1-2*(I+.5)/220,ne=Math.sqrt(1-Q*Q);st.position.set(Math.cos(X)*ne*.49,.7+Q*.5,Math.sin(X)*ne*.72),st.scale.set(.018,.027,.018),st.updateMatrix(),Pt.setMatrixAt(I,st.matrix)}Pt.castShadow=!0,Z.add(Pt);let Ee=Ki(Z,e,()=>u),bt=Math.min(2,e.homeLevel||0),Ze=bt*1.6;if(Ze){F(8,.18,Ze,w,0,-.1,3.5+Ze/2).userData.walkFloor=!0;for(let I=3.6;I<3.5+Ze;I+=.44)F(7.97,.012,.015,w,0,.002,I)}let gt=M.children.length,L=rf(M,()=>u);Me.push(...M.children.slice(gt));for(let I of L){if(I.w<.3||I.d<.3)continue;let X=I.x>4.5?9:0,Q=I.z<-3.65?-7.5:0;I.x=X+(I.x-X)/qe,I.z=Q+(I.z-Q)/qe,I.w/=qe,I.d/=qe}let yt="follow",tt=[],nt=Z.position.clone().add(new R(0,.6,0));if(window.KittyHomeGLB){let I=Uint8Array.from(atob(window.KittyHomeGLB),X=>X.charCodeAt(0));new Zi().parse(I.buffer,"",X=>{if(!u){X.scene.traverse(Q=>{Q.geometry?.dispose();for(let ne of[].concat(Q.material||[]))ne.dispose()});return}X.scene.traverse(Q=>{if(Q.isMesh){Q.castShadow=Q.receiveShadow=!0;for(let ne of[].concat(Q.material))ne.map&&(ne.map.anisotropy=Math.min(8,_.capabilities.getMaxAnisotropy()))}}),M.add(X.scene),Me.forEach(Q=>Q.visible=!1),s.dataset.homeModel="blender-v18"},()=>{s.dataset.homeModel="fallback"})}b.position.copy(Z.position).add(new R(6.2,8.3,10.2)),b.lookAt(nt);let De={bed:{x:2.45,z:-1.9,r:0},quilt:{x:-2.3,z:1.4,r:0},ball:{x:1.8,z:1.5,r:0},wand:{x:-1.8,z:-.8,r:0}};e.roomLayout=e.roomLayout||{};let T=new Map,y=window.KittyData.goods.filter(I=>I.model||["bed","quilt","ball","wand"].includes(I.id)),N=y.filter(I=>e.owned.includes(I.id)&&!e.storedItems.includes(I.id)).map(I=>I.id),J={bed:[1.65/qe,1.3/qe],quilt:[1.45/qe,1.15/qe],ball:[.5/qe,.5/qe],wand:[.9/qe,.5/qe]};for(let I of y)I.model&&(J[I.id]=[I.width/qe,I.width/qe]);for(let I of N){let X=new Mt;X.userData.item=I,M.add(X);let Q=y.find(ie=>ie.id===I),ne=e.roomLayout[I]||De[I];if(!ne){e:for(let ie=-2.6;ie<3+Ze;ie+=.65)for(let ye=-3;ye<3.1;ye+=.65)if(Ie(I,ye,ie,0)){ne={x:ye,z:ie,r:0};break e}}if(!ne){M.remove(X),e.storedItems.includes(I)||e.storedItems.push(I);continue}if(e.roomLayout[I]={...ne},X.position.set(ne.x,0,ne.z),X.rotation.y=ne.r||0,Q?.model&&(_t(Q.model,X,{width:Q.width,alive:()=>u}),I==="shelf"&&_t("books",X,{width:1.2,y:.7,alive:()=>u}),I==="tv"&&_t("televisionModern",X,{width:1.2,y:.65,alive:()=>u})),I==="bed"){F(1.65,.26,1.3,w,0,.2,0,X),F(1.48,.18,1.1,H,0,.42,0,X),F(1.65,.63,.13,w,0,.49,-.6,X);for(let ie of[-.75,.75])F(.11,.4,1.3,w,ie,.33,0,X);k(.48,.13,.25,v,0,.59,-.25,X)}if(I==="quilt"){F(1.45,.08,1.15,O,0,.08,0,X);for(let ie=0;ie<12;ie++)k(.055,.017,.065,v,(ie%4-1.5)*.29,.132,(Math.floor(ie/4)-1)*.32,X)}if(I==="ball"){k(.25,.25,.25,O,0,.25,0,X);let ie=B(new Jn(.245,.018,8,24),v,0,.25,0,X);ie.rotation.y=.7}if(I==="wand"){let ie=F(.04,.04,.8,w,0,.06,0,X);ie.rotation.y=.5,k(.14,.025,.24,H,.16,.075,.35,X)}Q?.model||(X.scale.x/=qe,X.scale.z/=qe),T.set(I,X)}if(e.owned.includes("room")){M.background.set("#c9dbca");let I=C("#94b29a");for(let X=0;X<8;X++)k(.1,.15,.06,I,-3+X*.9,3.3,-3.42)}let te=new ms,j=new $e,Se=new R(.3,0,1.6),le=0,Ne=B(new rr(.3,.36,40),new on({color:"#ffe7a1",side:en}),0,.045,0);Ne.rotation.x=-Math.PI/2,Ne.visible=!1;let ze=B(new rr(.78,.83,48),new on({color:"#ffd76d",side:en}),0,.045,0);ze.rotation.x=-Math.PI/2,ze.visible=!1;function ae(I){return/^rug/.test(y.find(X=>X.id===I)?.model||"")}function he(I,X,Q=null){if(I<-3.7||I>12.7||X<-11.2||X>3.3+Ze||I<-1.9&&I>-4&&X<-2.05&&X>-3.4||L.some(ne=>Math.abs(I-ne.x)<ne.w/2+.23&&Math.abs(X-ne.z)<ne.d/2+.23))return!0;for(let[ne,ie]of T){if(ne===Q||ae(ne))continue;let ye=J[ne],ge=Math.abs(Math.sin(ie.rotation.y))>.7,et=ge?ye[1]:ye[0],Ae=ge?ye[0]:ye[1];if(Math.abs(I-ie.position.x)<et/2+.3&&Math.abs(X-ie.position.z)<Ae/2+.3)return!0}return!1}function Ie(I,X,Q,ne){let ie=J[I],ye=Math.abs(Math.sin(ne))>.7,ge=ye?ie[1]:ie[0],et=ye?ie[0]:ie[1];if(X-ge/2<-3.8||X+ge/2>12.8||Q+et/2>3.3+Ze||Q-et/2<-11.2)return!1;for(let[Ae,je]of T){if(Ae===I||ae(I)||ae(Ae))continue;let ft=J[Ae],Ct=Math.abs(Math.sin(je.rotation.y))>.7;if(Math.abs(X-je.position.x)<(ge+(Ct?ft[1]:ft[0]))/2+.1&&Math.abs(Q-je.position.z)<(et+(Ct?ft[0]:ft[1]))/2+.1)return!1}return!(X<-2&&Q<-2&&Q>-3.4)&&!L.some(Ae=>Math.abs(X-Ae.x)<(Ae.w+ge)/2+.1&&Math.abs(Q-Ae.z)<(Ae.d+et)/2+.1)}function Pe(I){T.has(I)&&(d=I,ze.visible=!0,ze.position.set(T.get(I).position.x,.045,T.get(I).position.z),g("#turnItem").hidden=!1,g("#storeItem").hidden=!1,m("Tap a free floor spot to place your "+I+"."))}_.domElement.addEventListener("pointerdown",I=>{let X=_.domElement.getBoundingClientRect();if(j.set((I.clientX-X.left)/X.width*2-1,-(I.clientY-X.top)/X.height*2+1),te.setFromCamera(j,b),!f&&!re)for(let ye of te.intersectObjects(M.children,!0)){let ge=ye.object;for(;ge;){if(ge.userData.homeUse){l(ge.userData.homeUse);return}ge=ge.parent}if(ye.object.name==="floor"||ye.object.userData.walkFloor)break}let Q=te.intersectObjects(M.children.filter(ye=>ye.name==="floor"||ye.userData.walkFloor))[0];if(!Q)return;let ne=f?Math.round(Q.point.x/qe*4)/4:Q.point.x/qe,ie=f?Math.round(Q.point.z/qe*4)/4:Q.point.z/qe;if(re){!he(ne,ie)&&Math.abs(ne)<3.6&&ie<3.1+Ze&&ie>-3.1&&!K&&(rt.position.set(Z.position.x,.5,Z.position.z+.7),ke={from:rt.position.clone(),to:new R(ne,.22,ie),t:0},rt.visible=!0,Se.set(ne,0,ie),x=99,K=!0,o("Fetch the ball!"));return}if(f){let ye=te.intersectObjects([...T.values()],!0);if(ye.length){let ge=ye[0].object;for(;ge&&!ge.userData.item;)ge=ge.parent;if(ge&&ge.userData.item!==d){Pe(ge.userData.item);return}}}if(f&&d){let ye=T.get(d);if(!Ie(d,ne,ie,ye.rotation.y)){m("Choose an empty spot inside the room.");return}ye.position.set(ne,0,ie),e.roomLayout[d]={x:ne,z:ie,r:ye.rotation.y},ze.position.set(ne,.045,ie),t(),m("Saved! Tap another spot to move it again.");return}if(f){let ye=te.intersectObjects([...T.values()],!0);if(ye.length){let ge=ye[0].object;for(;ge&&!ge.userData.item;)ge=ge.parent;ge&&Pe(ge.userData.item)}return}if(!f){let ye=te.intersectObjects([...T.values()],!0);if(ye.length){let ge=ye[0].object;for(;ge&&!ge.userData.item;)ge=ge.parent;if(ge){l(ge.userData.item);return}}}he(ne,ie)||(yt="follow",s.dataset.homeRoom="follow",D.value="follow",Ke.querySelectorAll("button").forEach(ye=>ye.classList.toggle("active",ye.dataset.homeRoom==="follow")),_e(ne,ie),x=99,Ne.position.set(ne,.045,ie),Ne.visible=!0)});function _e(I,X){let Q=[Math.round(Z.position.x*2),Math.round(Z.position.z*2)],ne=[Math.round(I*2),Math.round(X*2)],ie=(je,ft)=>je+","+ft,ye=[Q],ge=new Map([[ie(...Q),null]]),et=!1;for(let je=0;je<ye.length;je++){let[ft,Ct]=ye[je];if(ft===ne[0]&&Ct===ne[1]){et=!0;break}for(let[xn,$t]of[[1,0],[-1,0],[0,1],[0,-1]]){let un=ft+xn,Ti=Ct+$t,Tn=ie(un,Ti);ge.has(Tn)||he(un/2,Ti/2)||(ge.set(Tn,[ft,Ct]),ye.push([un,Ti]))}}if(!et){m("\uAC00\uAD6C \uC0AC\uC774\uC758 \uBE48 \uBC14\uB2E5\uC744 \uB20C\uB7EC \uC8FC\uC138\uC694.");return}let Ae=ne;for(tt=[];Ae;)tt.push(new R(Ae[0]/2,0,Ae[1]/2)),Ae=ge.get(ie(...Ae));tt.reverse(),tt.shift(),tt.length&&Se.copy(tt.shift())}let Ke=document.createElement("nav");Ke.className="home-room-nav";for(let[I,X]of Object.entries(vo)){let Q=document.createElement("button");Q.textContent=X.name,Q.dataset.homeRoom=I,Q.onclick=()=>{yt=I,s.dataset.homeRoom=I,D.value=I,!f&&I!=="all"&&I!=="follow"&&_e(...X.entry||[X.x,X.z]),Ke.querySelectorAll("button").forEach(ne=>ne.classList.toggle("active",ne.dataset.homeRoom===I)),x=I==="follow"?3:99},Ke.append(Q)}let D=document.createElement("select");D.className="home-room-select",D.setAttribute("aria-label","\uBC29\uACFC \uC2DC\uC810 \uC120\uD0DD");for(let[I,X]of Object.entries(vo)){let Q=document.createElement("option");Q.value=I,Q.textContent=X.name,D.append(Q)}D.onchange=()=>Ke.querySelector("button[data-home-room="+D.value+"]").click(),Ke.append(D),s.append(Ke),s.dataset.homeRoom="follow",Ke.querySelector("[data-home-room=follow]").classList.add("active"),of=g("#decorateRoom").onclick=()=>{f=!f,s.classList.toggle("arranging",f),g(".room-items").hidden=!f,g("#decorateRoom").textContent=f?"Done":"Arrange furniture",f||(d=null,ze.visible=!1,g("#turnItem").hidden=!0,g("#storeItem").hidden=!0),pe.visible=f,ee(),m(f?N.length?"Select an item, then tap the floor.":"Buy a bed, quilt, or toy in the shop first.":"Tap the floor to call your pet.")};for(let I of y)I.model&&(J[I.id]=[I.width/qe,I.width/qe]);for(let I of[...T.keys()]){let X=document.createElement("button");X.className="secondary",X.textContent=y.find(Q=>Q.id===I)?.name||I,X.onclick=()=>Pe(I),g(".room-items").append(X)}let pe=new so(8,32,"#ac9b7b","#c7b596");pe.position.y=.015,pe.visible=!1,M.add(pe);let ce=document.createElement("button");ce.id="storeItem",ce.className="secondary",ce.textContent="Store",ce.hidden=!0,g(".room-tools").append(ce),ce.onclick=()=>{d&&(e.storedItems.push(d),t(),a())};let we=document.createElement("button");we.className="secondary",we.textContent="Buy furniture",we.onclick=c,g(".room-items").prepend(we);for(let I of e.storedItems.filter(X=>y.some(Q=>Q.id===X))){let X=document.createElement("button");X.className="secondary",X.textContent="Place "+y.find(Q=>Q.id===I).name,X.onclick=()=>{e.storedItems=e.storedItems.filter(Q=>Q!==I),delete e.roomLayout[I],t(),a()},g(".room-items").append(X)}g("#turnItem").onclick=()=>{if(!d)return;let I=T.get(d),X=I.rotation.y+Math.PI/2;if(!Ie(d,I.position.x,I.position.z,X)){m("Move this item to a larger space first.");return}I.rotation.y=X,e.roomLayout[d].r=X,t()};let re=!1,K=!1,Ce=0,ke=null,rt=k(.18,.18,.18,O,0,.2,0);rt.visible=!1;let Qe=document.createElement("div");Qe.className="fetch-panel",Qe.hidden=!0,Qe.innerHTML="<b>Fetch \xB7 <span>0 / 3</span></b><button>Finish</button>",s.append(Qe),Qe.querySelector("button").onclick=()=>{re=!1,K=!1,rt.visible=!1,s.classList.remove("fetching"),Qe.hidden=!0,x=2},af=()=>{yt="living",tt=[],Z.position.set(.3,0,1.6),Se.copy(Z.position),re=!0,K=!1,Ce=0,Qe.querySelector("span").textContent="0 / 3",Qe.hidden=!1,s.classList.add("fetching"),m("Tap an empty floor spot to throw the ball."),o("Let\u2019s play fetch!")};let tn=wc(_.domElement,s),W=Tc(_.domElement,s,()=>!f&&!re),ee=()=>{let I=s.getBoundingClientRect();_.setSize(I.width,I.height),b.aspect=I.width/I.height,b.zoom=f?.95:1.05,b.updateProjectionMatrix()},oe=new ResizeObserver(ee);oe.observe(s),ee();function Le(I){if(!u)return;if(s.hidden||document.hidden){p=0,h=requestAnimationFrame(Le);return}let X=p?Math.min((I-p)/1e3,.1):0;if(p=I,x-=X,x<0&&!f&&!re&&!tt.length&&yt!=="all"){for(let Ae=0;Ae<20;Ae++){let je=Z.position.x+(Math.random()-.5)*3,ft=Z.position.z+(Math.random()-.5)*3;if(!he(je,ft)){_e(je,ft);break}}x=4+Math.random()*3}let Q=Se.clone().sub(Z.position),ne=Math.hypot(Q.x,Q.z),ie=ne>.025&&!f;if(ie){let Ae=Math.min(ne,X*(K?2.7:W.running?3.6:1.65)/qe),je=Z.position.x+Q.x/ne*Ae,ft=Z.position.z+Q.z/ne*Ae;he(je,ft)&&(Se.copy(Z.position),tt=[],x=3,je=Z.position.x,ft=Z.position.z),le=Math.atan2(je-Z.position.x,ft-Z.position.z),Z.position.set(je,Math.abs(Math.sin(I*.012))*.045,ft),Z.rotation.y+=Math.atan2(Math.sin(le-Z.rotation.y),Math.cos(le-Z.rotation.y))*Math.min(1,X*9)}else Z.position.y=0,Ne.visible=!1,tt.length&&Se.copy(tt.shift());K&&(ke&&ke.t<1?(ke.t=Math.min(1,ke.t+X*1.5),rt.position.lerpVectors(ke.from,ke.to,ke.t),rt.position.y+=Math.sin(ke.t*Math.PI)*1.3):rt.position.y=.22,rt.rotation.x+=X*4,ne<.32&&(!ke||ke.t>=1)&&(K=!1,rt.visible=!1,Ce++,Qe.querySelector("span").textContent=Ce+" / 3",Ce>=3?(re=!1,s.classList.remove("fetching"),Qe.hidden=!0,r(),m("Great catch!")):m("Good catch! Throw again."))),Ee.update(X,ie,K||W.running),s.dataset.locomotion=ie?W.running?"run":"walk":"idle",s.dataset.petAsset=Ee.ready?"ready":"loading",Te.forEach((Ae,je)=>Ae.position.y=.25+(ie?Math.sin(I*.013+je%2*Math.PI)*.09:0)),Ge.rotation.y=Math.sin(I*.009)*.4,We.rotation.z=Math.sin(I*.0014)*.045;let ye=yt==="all",ge=ye?new R(4.5,.3,-3.8):f&&yt!=="follow"?new R(vo[yt].x,.6,vo[yt].z):Z.position.clone().add(new R(0,.6,0));ge.x*=qe,ge.z*=qe,nt.lerp(ge,Math.min(1,X*3));let et=(ye?new R(22,28,32).multiplyScalar(qe):new R(6.2,8.3,10.2)).multiplyScalar(Math.max(1,.7/b.aspect)*tn.distance);b.position.lerp(ge.clone().add(et),Math.min(1,X*3)),b.lookAt(nt),s.dataset.cameraX=b.position.x.toFixed(2),s.dataset.cameraZ=b.position.z.toFixed(2),s.dataset.petX=Z.position.x.toFixed(1),s.dataset.petZ=Z.position.z.toFixed(1),_.render(M,b),h=requestAnimationFrame(Le)}return Cc=()=>{tn.dispose(),W.dispose(),u=!1,cancelAnimationFrame(h),oe.disconnect(),M.traverse(I=>{if(I.geometry?.dispose(),I.material)for(let X of[].concat(I.material))X.dispose()}),_.dispose(),_.forceContextLoss(),s.hidden=!0},g(".room-close").onclick=()=>{Cc(),n()},m("Your pet can run around. Tap the floor to call them."),h=requestAnimationFrame(Le),t(),!0}window.KittyRoom={open:o_,close:()=>Cc(),decorate:()=>of(),fetchBall:()=>af()};})();
