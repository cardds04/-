...
function open(host,{state,save,onClose,main=false,onPlay=()=>{},speak=()=>{},onChange=()=>{},onShop=()=>{},onUse=()=>{}}){
 ...
 const cream=mat(state.house==='villa'?'#f4e8df':state.house==='cottage'?'#cbdac5':'#f7e7c7'),wood=mat('#b77d49'),mint=mat('#83a791'),dark=mat('#3b2921'),pink=mat('#dd9b8a'),fur=mat(state.species==='dog'?'#d69a53':'#a29a8b'),white=mat('#fff1dc');
