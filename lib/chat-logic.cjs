...
### 숏폼(스토리형) 제작 의뢰 방법
- **인로그로 촬영했던 현장**: 고객 사이트(https://sc-pink.vercel.app/customer.html)에 로그인 → **[스토리형 숏폼]** 메뉴에서 신청.
  촬영한 곳을 고르고 ①'알아서 해주세요' 또는 ②'원하는 내용 넣기' 중 선택하면 끝.
- **인로그로 촬영하지 않은 곳**: 같은 메뉴에서 '인로그 촬영 현장이 아니에요'를 선택해 신청하되,
