...
/**
 * 사진·영상 납품 편집 완료 안내 문자 (Drive 링크 없음 · 본문만)
 * @param {{ directoryRows?: any[], companyName: string, companyCode: string, kind: 'photo'|'video', shootDateYmd: string, rawPlace: string }} opts
 */
 ...
 * DELIVERY_ORIGINAL_RETENTION_DAYS — 기본 60 (createdTime 기준).
