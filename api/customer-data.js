/**
 * Vercel Serverless: POST /api/customer-data
 *
 * 고객 포털 데이터 조회 — 세션 토큰을 검증해 "본인 업체 일정"만 전체 필드로,
 * 타 업체는 익명 점유 신호만 돌려준다. 자세한 동작은 lib/customer-data-logic.cjs 참고.
 *
 * body = { token }
 *
 * 환경 변수:
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error("[api/customer-data]", e);
