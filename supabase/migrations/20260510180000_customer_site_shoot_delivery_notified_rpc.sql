-- 고객 RPC: 납품(사진·영상) 문자 처리 시각 포함 → 내등록현황 진행 표시용
...
comment on function public.customer_site_shoot_completion(text, text, text[]) is '고객 스케줄: 현장·확인 이미지 URL, 작업폴더 링크, 사진·영상 납품 문자 완료 시각';
