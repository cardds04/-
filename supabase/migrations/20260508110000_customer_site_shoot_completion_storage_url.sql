-- 고객용 RPC: 현장 확인 이미지가 Supabase Storage URL 이면 썸네일·보기 동일 공개 링크 사용
-- (20260508100000 보다 먼저 실행돼도 실패하지 않도록 컬럼 보장)
...
comment on function public.customer_site_shoot_completion(text, text, text[]) is '고객 본인 업체 스케줄 UUID 에 대해 현장 촬영 완료·확인 이미지 URL (Storage 우선, 없으면 Drive)';
