...
(function () {
  ...
  function injectStyle() {
    ...
    .ea-chip .ea-chip-nm{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:26vw}
    .ea-chip-dot{width:6px;height:6px;border-radius:50%;background:var(--accent,#ffd700);flex:none}
